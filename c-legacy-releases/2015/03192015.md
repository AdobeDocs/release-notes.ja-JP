...
<table id="table_EB3FFBA2DF904546A5185EC9A63BBA98"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>顧客関係管理（CRM）データベースで管理されている顧客データを Marketing Cloud へアップロードできます。 </p> <p>データが Marketing Cloud にアップロードされると、例えば、セグメント定義に顧客属性を含むオーディエンスセグメントを [!DNL Analytics] で作成して、そのオーディエンスセグメントを Target と共有できます。 </p> <p>Marketing Cloud ヘルプの「<a href="https://marketing.adobe.com/resources/help/en_US/mcloud/index.html?f=attributes" format="https" scope="external">顧客属性</a>」を参照してください。 </p> <p><a href="https://marketing.adobe.com/resources/help/en_US/mcloud/index.html?f=core_services" format="https" scope="external">コアサービスのソリューションの有効化</a>について詳しく知る。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_03055471A9624B40B122C0E2CD295AA9"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <span class="term">獲得</span>および<span class="term">アプリ内メッセージ</span>の管理には、[!DNL Analytics] の管理ツールで管理される<span class="wintitle">モバイルアプリ管理</span>グループ内のユーザーのみがアクセスできるようになりました。これにより、どのユーザーに対してアクセス権限を付与するかを管理できます。<a href="https://marketing.adobe.com/resources/help/en_US/mobile/index.html?f=t_admin_group" format="https" scope="external"> 詳細情報... </a></p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>Adobe ID を使用して Mobile Services にログインすると、[!DNL Analytics] のログインカンパニーが複数ある場合は Mobile Services 内で切り替えることができるようになりました。 </p> <p>会社を変更するには、ヘッダーの右上にあるユーザーアイコンをクリックします。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> 追加された eVar およびイベントを利用できるようになりました。追加で利用できる eVar およびイベントの数は、Adobe [!DNL Analytics] 製品の契約内容によって異なります。<a href="https://marketing.adobe.com/resources/help/en_US/sc/implement/evars_events.html" format="https" scope="external"> 詳細情報… </a> </td> 
  </tr> 
  <tr> 
...
>[!NOTE]
>
>バージョン 14 でログインした場合のデータウェアハウスアクセスは削除されました。[詳細](https://marketing.adobe.com/resources/help/ja_JP/reference/?f=whatsnew_segments)
...
次の製品の最近のリリース情報については、[Adobe Target リリースノート](https://marketing.adobe.com/resources/help/ja_JP/target/target/r_release_notes.html) ページを参照してください。
