...
11 月から 12 月にかけて、お客様から大量の分類ファイルが FTP やブラウザー経由でアップロードされることが予測されます。アドビではこれらのファイルアップロードを可能な限りすばやく処理しますが、処理時間が通常よりも長くなる可能性があります。処理時間を最小限に抑えるためのヒントは、「[分類処理時間](https://helpx.adobe.com/analytics/kb/saint-processing-time.html)」を参照してください。
