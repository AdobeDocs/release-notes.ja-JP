...
* 次のガイドが再編成および改善されました。
   ...
   * [Adobe Mobile Services ユーザーガイド](https://docs.adobe.com/content/help/en/mobile-services/using/home.html)
...
* 認証済み状態のサポート。訪問者 API は、Marketing Cloud の訪問者 ID とともに、同じ訪問者に対する複数の顧客 ID と、異なる顧客 ID および *`authStates`*.
