...
* 次のガイドが再編成および改善されました。
   ...
   * [Adobe Mobile Services ユーザーガイド](https://marketing.adobe.com/resources/help/ja_JP/mobile/)
   * [Marketing Cloud ソリューション向け iOS SDK 4.x 管理者ガイド](https://marketing.adobe.com/resources/help/ja_JP/mobile/ios/)
...
Analytics Premium では、[Data Workbench 6.4 リリース](https://marketing.adobe.com/resources/help/ja_JP/insight/whatsnew/)に次の新機能が追加されます。
...
<table id="table_FE8C9A73676345CDA450CE84111A2B72"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> ステップバイステップ方式のインストールウィザードを使用して Data Workbench（クライアント）をセットアップします。ワークベンチのダウンロード、オプション設定、インストール、サーバーとの同期をおこなうことができます。 </td> 
  </tr> 
  <tr> 
...
* Swagger による API ドキュメントの改善を進めています。新しいメソッドおよび改訂されたメソッドについては、「[Audience Manager API ドキュメント](https://bank.demdex.com/portal/swagger/index.html)」の節を参照してください。
* [Marketing Cloud 訪問者 ID](https://marketing.adobe.com/resources/help/ja_JP/aam/?f=c_visitor_id_versions.html) に新しいドキュメントを追加しました。データソースの作成または編集時に訪問者 ID が必要になることがあります。
...
詳しくは、[Adobe Social リリースノート](https://marketing.adobe.com/resources/help/en_US/social/c_rel_notes.html)を参照してください。
