...
* 「<span class="term">オーディエンスライブラリ</span>」メニューと「<span class="term">顧客属性</span>」メニューの選択は、<span class="term">オーディエンス</span>の下に移動されました。
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Reports &amp;Analyticsは、SiteCatalyst 15の導入以降、「トラフィックデータソース」タイプのデータソースをサポートしていません。 データソースのユーザーインターフェイスでは、引き続きトラフィックデータソースを作成できますが、この種のデータソースは、会社がSiteCatalyst 14からSiteCatalyst 15に移行した日より前の日付範囲にのみ適用できます。 来月（2015年6月）、アドビでは、オプションとしてトラフィックデータソースの削除を計画しています。 また、6月に、Reports &amp; Serverの新しい機能を紹介します。この機能により、トラフィックデータソースを使用せずに、シンプルなトラフィック指標を作成できます。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A01098A1EE3A4F1084AB13DD1A0DF1B3"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Data warehouseは、AnalyticsレポートAPI 1.4をサポートしています。 </p> <p>Developer Connection の Data Warehouse API ドキュメントの <a href="https://marketing.adobe.com/developer/documentation/data-warehouse/r-report-2" format="https" scope="external">Report.Queue</a> を参照してください。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_3CA51E873E324FD4B7CF14190F127A77"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>現在、ソーシャルネットワークから受け取る指標に、<span class="keyword">Adobe Analytics</span> でレポートできないものがあります。New reserved events let you create custom reports in  <span class="wintitle"> Analytics </span> to view social data alongside web data. </p> </td> 
  </tr> 
  <tr valign="top"> 
...
<table id="table_191B769A5A8A405C87A34245BE6B1127"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td colname="col2"> <p>2015年3月1日、Adobe SocialではツイートのGeoTargetingをサポートしなくなりました。 Twitterでの作業後、地域ターゲティングを再び使用できるようになります。 </p> 
