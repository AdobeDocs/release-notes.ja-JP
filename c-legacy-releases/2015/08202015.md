...
* [新機能 [!DNL Analytics]](../../c-legacy-releases/2015/08202015.md#features_analytics) **（2015年8月22日更新）:Data Warehouseレポートおよびデータフィードの転送に使用される非推奨のSFTPキー(2013年秋** に公開)は、完全に削除されました。
...
* 分類ルールビルダーが更新され、[レポートスイートと変数を選択](https://docs.adobe.com/content/help/en/analytics/components/classifications/classifications-rulebuilder/classification-rule-definitions.html)パネルが追加されました。 このパネルでは、既存のルールセットにレポートスイートと変数を追加できます。 以前は、ルールセットの作成時に変数とレポートスイートを指定していました。 この変更により、分類変数で発生する問題が報告されないようになりました。
...
* 新しいドキュメントで、Google Doubleclick Campaign Manager（DCM）アカウントから [!DNL  Audience Manager] にデータを移行する方法を説明しています。[Audience ManagerへのDCMファイルの読み込み](https://marketing.adobe.com/resources/help/en_US/aam/t_dcmlogs.html)を参照してください。
* 新しいドキュメントで、[!UICONTROL バルク管理ツール]の操作方法を説明しています。詳しくは、[バルク管理ツール](https://marketing.adobe.com/resources/help/en_US/aam/c_bulk.html)を参照してください。
* [マスターマーケティングプロファイルの統合](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html)を改訂し、コンテキストデータ変数を更新しました。 この変数は、アンダースコアで終わる必要があります。 以前は、ピリオドで終わっていました。

**既知の問題**

[!DNL  Analytics] お客様は、 [マスターマーケティングプロファイルを使用し、訪問者IDサービスに宣言済みIDを渡す場合、統合コード](https://marketing.adobe.com/resources/help/en_US/aam/c_mmp.html)  [!DNL  Audience Manager] を設定する必要があります。
