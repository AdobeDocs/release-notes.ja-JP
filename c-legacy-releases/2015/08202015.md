...
* [[!DNL Analytics] の新機能](../../c-legacy-releases/2015/08202015.md#features_analytics)**（2015 年 8 月 22 日更新）：** Data Warehouse と Data Feeds の SFTP 配信で利用する鍵ファイルで 2013 年秋に非推奨となったものがサーバーから削除されました。
...
* ユーザーがログインページで「このアカウントを記憶する」をオンにした後、ログインして、リンクを使用して送信したレポートを変更しようとする際にアクセス拒否エラーが発生していた問題を修正しました。This resulted in an “Access Denied” error. （AN-89504 + AN-107008）
...
* ファイル名の一部である場合に [!DNL  .csv] ファイル拡張子が追加されないというTableau *` .csv`* ファイルの問題を修正。（AN-106466）
