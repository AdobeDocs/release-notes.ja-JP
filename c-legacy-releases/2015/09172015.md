---
description: Analytics分析ワークスペースの強化およびタイムスタンプオプションの新機能。Dynamic Tag Management のグループ管理。Analytics セグメント、獲得方法およびポストバックシグナルに対するモバイルプッシュメッセージ。Marketing Cloud ソリューションの一般的な修正および機能強化。
keywords: リリースノート
seo-description: Analytics分析ワークスペースの強化およびタイムスタンプオプションの新機能。Dynamic Tag Management のグループ管理。Analytics セグメント、獲得方法およびポストバックシグナルに対するモバイルプッシュメッセージ。Marketing Cloud ソリューションの一般的な修正および機能強化。
...
<table id="table_D01BAD87E351453EA70A66B3B56F11F6"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Sending push messages to  <span class="wintitle"> Analytics </span> segments from the <span class="keyword"> Mobile Services </span> UI allows you to leverage your robust [!DNL Analytics] data while engaging with users. </p> <p>以下を参照してください。 </p> 
