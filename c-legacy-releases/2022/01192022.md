...
### チュートリアル (Experience Managerガイド ) {#tutorials-xml-doc}

新しく公開されたビデオ、チュートリアル、コース (Experience Managerガイド )。

| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2022 年 1 月 | [XML ドキュメントのリリース](https://experienceleague.adobe.com/docs/experience-manager-xml-documentation-learn/tutorials/release-info/latest-release-info.html?lang=ja) | ビデオ | 強力でエンタープライズクラスのコンポーネントコンテンツ管理ソリューション (CCMS) であるExperience Managerガイドについて説明します。 これにより、Adobe Experience Manager でのネイティブ DITA サポートが可能になり、AEM が DITA ベースのコンテンツの作成と配信を処理できるようになります。 |
