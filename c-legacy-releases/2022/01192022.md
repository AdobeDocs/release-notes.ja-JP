...
* Adobe Target のプレリリース情報については、[Adobe Target プレリリース](https://experienceleague.adobe.com/docs/target/using/release-notes/target-release-notes.html)リリースノートを参照してください。
* 現在の情報については、[Target リリースノート](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html)を参照してください。
