...
最終更新日：**2022年10月14日（PT）**、10月15日リリース用
...
| キャンペーン、バルクシート、レポート | （[!DNL Microsoft Advertising] アカウントのベータ版機能）[!DNL Microsoft Audience Network] のキャンペーンで次のサポートが利用できるようになりました。<ul><li>[!UICONTROL Campaigns] ビューから、およびバルクシートを使用してオーディエンスキャンペーンのステータス（キャンペーンタイプ「[!UICONTROL オーディエンス（画像）]」もしくは「[!UICONTROL オーディエンス（フィード）]」）、広告グループ（広告グループタイプ「[!UICONTROL オーディエンス]」）、および広告（クリエイティブタイプ「[!UICONTROL レスポンシブ広告]」）を作成、編集、変更できるようになりました。</li><li>[!UICONTROL Campaigns] ビューでは、既存のオーディエンスキャンペーンのパフォーマンスデータを表形式およびトレンドグラフ形式で表示できます。また、広告レベルのパフォーマンスデータは、レポートや Adobe Analytics でも利用できます（[!DNL Analytics] 統合を利用する広告主向け）。</li></ul>最適化のサポートは、今後のリリースで利用できるようになります。 |
|  | （[!DNL Microsoft Advertising] アカウントのベータ版機能）[!UICONTROL Campaigns] ビューとバルクシートの使用により、検索キャンペーンで、マルチメディア広告を作成および管理できるようになりました。広告にはクリエイティブタイプ「[!UICONTROL マルチメディア広告]」があります。<br><br>マルチメディア広告のあるキャンペーンは、[!UICONTROL ターゲットインプレッション共有]（ハイブリッドポートフォリオではまだサポートされていません）以外の支出戦略を使用する、標準ポートフォリオまたはハイブリッドポートフォリオに含めることができます。<br><br>また、[!UICONTROL Campaigns] ビューで、既存のオーディエンスキャンペーンのパフォーマンスデータを表形式およびトレンドグラフ形式で表示できます。また、広告レベルのパフォーマンスデータは、レポートや [!DNL Analytics] でも利用できます（[!DNL Analytics] 統合を利用する広告主向け）。 |
| [!UICONTROL キャンペーン]、[!UICONTROL レポート] | （[!DNL Google Ads] および [!DNL Microsoft Advertising] アカウントのベータ版機能）投稿者のインプレッション共有指標は、次のキャンペーン管理ビューおよびレポートで列として使用できるようになりました。<ul><li>キャンペーン管理ビュー：[!UICONTROL 広告]を除くすべてのキャンペーンエンティティビュー。<b>メモ：</b> 広告レベルのデータは、広告ネットワークからは利用できません。</li><li>基本レポート：[!UICONTROL 広告バリエーション]、[!UICONTROL 時間別キャンペーン]、および[!UICONTROL ネットワーク制約]レポートを除くすべてのレポート。<b>メモ：</b> 広告レベルのデータは、広告ネットワークからは利用できません。</li><li>専門レポート：[!UICONTROL AdWords と Bing Audience Target]、[!UICONTROL キャンペーン日別インプレッション共有]、および[!UICONTROL キーワード日別インプレッション共有]レポート。</li></ul><b>メモ：</b>[!UICONTROL キャンペーン日別インプレッション共有]および[!UICONTROL キーワード日別インプレッション共有]レポートは現在冗長化され、将来のリリースで削除されます。これらのレポートタイプを予定レポート、テンプレートまたはスプレッドシートフィードで使用する場合は、[!UICONTROL キャンペーン]および[!UICONTROL キーワード]レポートを使用します。それまでの間、これらのレポートタイプでは、既存の指標の一部が重複します。 |
| [!UICONTROL コンバージョン値ルール] | （[!DNL Google Ads accounts]）[!UICONTROL コンバージョン値のルール]ビューはベータ版ではなくなり、一般公開されています。既存の [!DNL Google Ads] コンバージョン値のルールの表示に使用します。個々のアカウントレベル以下で [!DNL Google Ads] のコンバージョントラッキングを使用している広告主は、ルールを作成し管理することもできます。 |
| [!UICONTROL 広告インサイト] | [!UICONTROL インプレッション共有が失われました]および[!UICONTROL クエリのクロスマッチング]分析は現在ベータ版ではなくなり、一般公開されています。 |
| [!UICONTROL Recommendations] | （[!DNL Google Ads] アカウントのみ）[!UICONTROL Recommendations] 機能はベータ版から廃止され、通常は利用可能です。<ul><li>アカウントで実行されていないすべての [!DNL Google Ads] Recommendations を一目で確認できます。</li><li>アカウントのレコメンデーションを適用および却下します。</li><li>アカウントに適用された各レコメンデーションのログを表示します。</li></ul> |
| [!UICONTROL キャンペーンのインポート] | （ベータ版機能）[!DNL Google Ads] パフォーマンス最大キャンペーン（ローカルの在庫広告を含む）を、[!UICONTROL ツール]／[!UICONTROL キャンペーンの読み込み]から [!DNL Microsoft Advertising] スマートショッピングキャンペーンに読み込むことができます。キャンペーンをインポートすると、インポートジョブのステータスの確認、エラーログの確認、インポートスケジュールの編集、一時停止、削除ができます。 |
