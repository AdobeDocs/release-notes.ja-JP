...
2022.7.0（2022年7月）リリースで追加された機能の概要については、[2022年7月リリースの概要ビデオ](https://video.tv.adobe.com/v/3454197/?quality=12&captions=jpn)をご覧ください。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
| 2022年8月 | [カスタムカレンダーの作成](https://experienceleague.adobe.com/?lang=ja&recommended=Workfront-U-1-2022.4.reporting&amp;lang=ja) | コース | カスタムカレンダーでは、プロジェクト、タスクおよび問題から日付や情報を直接カレンダー形式で表示できます。 |
