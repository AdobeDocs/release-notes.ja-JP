...
>[!NOTE]
>
>[!DNL Adobe Search&Promote] のサービス終了は **2022年9月1日**&#x200B;にスケジュールされています。製品およびコマース検索の場合、[ライブサーチ](https://experienceleague.adobe.com/docs/commerce-merchant-services/live-search/overview.html)がアドビの検索アプリケーションです。詳しくは、[提供終了のお知らせ](https://experienceleague.adobe.com/docs/search-promote/using/sp-eol.html)を参照してください。
...
| 2022年9月 | [レポートグラフの作成](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/create-a-report.html) | ビデオ（更新） | 新しいレポートエクスペリエンスで、独自のカスタムレポートやデータエクスポートをパーソナライズされたビューで作成、保存、管理する方法について説明します。 | Acrobat Sign |
