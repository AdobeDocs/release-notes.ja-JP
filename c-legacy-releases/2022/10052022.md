...
アドビは、Workfront for Experience Manager 拡張コネクタの[最新バージョン 1.9.3 にアップグレード](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html)することを推奨します。 
