...
| 2022年4月 | [一般的な用語による Adobe Analytics 専門用語の翻訳](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/administration/key-admin-skills/translating-adobe-analytics-technical-language.html?lang=ja#) | ビデオ | 組織のAdobe Analyticsエキスパートは、関係者が技術的な詳細を理解し、Adobe Analyticsへの投資を最大限に活用するのを支援するうえで重要です。 |
...
| 2022年4月 | [CJA での接続の詳細](https://experienceleague.adobe.com/docs/customer-journey-analytics-learn/tutorials/connections-details-experience-in-cja.html?lang=ja) | ビデオ | 接続のデータセットのステータスと取り込みプロセスを確認する方法について説明します。 |
...
| 2022年4月 | [リポジトリブラウザーを使用した AEM as a Cloud Service のデバッグ](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/debugging/debugging-aem-as-a-cloud-service/repository-browser.html?lang=ja) | ビデオ | AEMのas a Cloud Service環境を簡単にデバッグできる、AEMの基になるデータストアを表示する強力なツールである、リポジトリブラウザーについて説明します。 | AEM CS |
...
| 2022年4月 | [送信後のドキュメントの変更](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/modify-in-flight.html?lang=ja) | ビデオ | 既に署名用に送信されているドキュメントを変更する方法を説明します。例えば、誤ったドキュメントが誤って送信された場合などです。 | Adobe Sign |
