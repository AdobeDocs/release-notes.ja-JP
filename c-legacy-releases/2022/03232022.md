...
* **Experience Manager 6.5 サービスパック 12（6.5.12.0）**
  ...
  詳しくは、[リリースノート](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/release-notes.html)を参照してください。

### Adobe Experience Manager 製品リリース

* **Adobe Experience Manager as a Cloud Service**

  2022.3.0 （2022 年 3 月）リリースで追加された機能の概要については、[2022 年 3 月リリースの概要ビデオ ](https://video.tv.adobe.com/v/341465) をご覧ください。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
