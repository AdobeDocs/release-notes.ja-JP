...
## ![アイコン](/assets/ec_appicon_24.png) Experience Managerガイド {#xml-doc}

Experience Managerガイドは、AEMにデプロイされるアプリケーションです。 Adobe Experience Manager でのネイティブ DITA サポートを可能にし、AEM が DITA ベースのコンテンツの作成と配信を処理できる、強力なエンタープライズグレードのコンポーネントコンテンツ管理ソリューション（CCMS）です。
