...
| [!DNL Inventory Inspector] | （6月29日（PT）リリース）プレースメント[!UICONTROL インスペクター]の「[!UICONTROL 在庫]」タブには、[!UICONTROL ビューアビリティ率]、[!UICONTROL クリック数]、[!UICONTROL 昨日の CPM]など、カスタマイズ可能なデータビジュアライゼーショングラフおよび拡張されたパフォーマンス指標が含まれています。 |
