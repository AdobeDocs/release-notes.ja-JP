...
| ----------- | ---------- | ------- |
| [!UICONTROL クロスデバイス分析]：EMEA および APAC での可用性 | 2020 年 9 月 1 日 | [クロスデバイス分析](https://experienceleague.adobe.com/content/help/en/analytics/components/cda/overview.html)およびプライベートグラフは、ヨーロッパ、中東、アフリカおよび APAC のお客様が利用できます。 |
...
| Workspace：単一のディメンションに対して 50,000 個の項目をダウンロード | 2020 年 9 月 18 日 | セグメントとフィルターが適用されたフリーフォームテーブルで、単一のディメンションに対して 50,000 個の項目をダウンロードできます。これにより、Analysis Workspace 外の 400 行を超えるデータにアクセスできます。[詳細情報...](https://experienceleague.adobe.com/content/help/en/analytics/analyze/analysis-workspace/curate-share/download-send.html) |
...
| 機能 | [一般公開](https://experienceleague.adobe.com/content/help/en/analytics/landing/an-releases.html) - ターゲット日 | 説明 |
| ----------- | ---------- | ---------- |
| Workspace のメディア同時閲覧者パネル | 2020 年 9 月 18 日 | メディア同時閲覧者パネルを使用すると、同時閲覧のピークが発生した場所やドロップオフが発生した場所を把握できます。  コンテンツの質と閲覧者の関与に関する貴重な情報を提供し、ボリュームやスケールのトラブルシューティングや計画に役立ちます。[詳細情報...](https://experienceleague.adobe.com/content/help/en/analytics/analyze/analysis-workspace/panels/media-concurrent-viewers.html) |
...
| 公開日 | 名前 | タイプ | 説明 |
| ----------- | ----------- | ---------- | ---------- |
| 2020 年 7 月 31 日 | [Admin Console でのレポートスイートへのアクセス制限](https://experienceleague.adobe.com/content/help/en/analytics-learn/tutorials/administration/user-management/limit-report-suite-access-in-the-admin-console.html) | チュートリアル | [!UICONTROL Admin Console] を使用して、ユーザーがそれぞれの役割に必要なレポートスイートにのみアクセスできるようにする方法を説明します 。 |
...
| 2020 年 8 月 8 日 | [適切なプロファイル結合ルールの選択](https://experienceleague.adobe.com/content/help/en/audience-manager-learn/tutorials/build-and-manage-audiences/profile-merge/choosing-the-right-profile-merge-rule.html) | チュートリアル | このビデオでは、[!UICONTROL プロファイルの結合ルール]の最も一般的な使用例を 3 つ見つけ、それらの使用例がマーケティング活動に役立つかどうかを確認します。 |
| 2020 年 8 月 6 日 | [セグメント分類の作成](https://experienceleague.adobe.com/content/help/en/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/creating-a-segment-taxonomy.html) | チュートリアル | Audience Manager でセグメントを作成する場合は、フォルダーベースの構造、または&#x200B;_分類_&#x200B;に保存します。セグメント分類の作成と管理に関するヒントをいくつか説明します。 |
| 2020 年 8 月 5 日 | [Adobe I/O での API 証明書の取得](https://experienceleague.adobe.com/content/help/en/audience-manager-learn/tutorials/api/retrieve-api-credentials-in-adobe-io.html) | チュートリアル | REST API を使用するための資格情報については、Adobe コンサルティングまたはカスタマーケアに問い合わせる代わりに、ブラウザーで `Adobe.io` にアクセスし、独自の資格情報を取得または登録するだけで済みます。 |
...
| 2020 年 7 月 23 日 | [セグメント作成の基本事項](https://experienceleague.adobe.com/content/help/en/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/the-basics-of-creating-segments.html) | チュートリアル | UI のフィールドに従って、Audience Manager 内にセグメントを作成します。 |
| 2020 年 7 月 23 日 | [実用的なセグメント定義と作成](https://experienceleague.adobe.com/content/help/en/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/practical-segment-definition-and-creation.html) | チュートリアル | このビデオでは、セグメントを定義し、特性別に分類して、セグメントを作成する必要があることを示すプロセスについて説明します。 |
| 2020 年 7 月 18 日 | [広告をコンバーターに対して抑制する](https://video.tv.adobe.com/v/36658) | チュートリアル | 広告をコンバーターに変換するのを抑制し、コストを節約し、顧客体験を最適化します。 |
| 2020 年 7 月 16 日 | [顧客抑制の使用事例での ROI の測定](https://experienceleague.adobe.com/content/help/en/audience-manager-learn/tutorials/intro-to-audience-manager/value-realization/measuring-roi-in-a-customer-suppression-use-case.html) | チュートリアル | 既存の顧客に広告を表示しないことによるキャンペーンコストの節約額を判断する数式をいくつか使用する方法を説明します。 |
| 2020 年 7 月 11 日 | [顧客への広告を抑制するセグメントの構築](https://experienceleague.adobe.com/content/help/en/audience-manager-learn/tutorials/build-and-manage-audiences/traits-and-segments/building-a-segment-to-suppress-ads-to-customers.html) | チュートリアル | このビデオでは、セグメントを作成して、顧客ステータスに変換済みのセグメントを除外するオプションについて説明します。 |
...
* **AEM as a Cloud Service**
   ...
   * AEM Commerce が Cloud Service で利用できるようになりました。詳しくは、「[AEM Commerce as a Cloud Service を使用する前に](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/commerce/getting-started.html)」を参照してください。
   * Adobe Target と Adobe Analytics のコネクタの機能強化には、ユーザーインターフェイスの強化、クラシック UI の置き換え、Adobe Launch の統合が含まれます。「[Adobe Analytics の統合](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/sites/integrations/integrating-adobe-analytics.html)」および「[Adobe Target の統合](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/sites/integrations/integrating-adobe-target.html)」を参照してください。
   * Asset Compute Service は、アセットを処理するための拡張可能なサービスです。管理者は、Asset Compute Service を使用して作成されたカスタムワーカーを呼び出すように Experience Manager を設定できます。開発者はこのサービスを使用して、複雑な使用例に対応する特殊なカスタムワーカーを作成できます。この Web サービスでは、様々なファイルタイプのサムネールを生成したり、Adobe ファイル形式から高品質な画像レンダリングを生成したり、ビデオのエンコード（将来）、メタデータの抽出、インデックス作成の前駆としてのフルテキストの抽出を行ったりできます。詳しくは、「[アセットマイクロサービスと処理プロファイルの使用](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-service/assets/manage/asset-microservices-configure-and-use.html)」を参照してください。
   ...
   * [AEM コアコンポーネント](https://experienceleague.adobe.com/content/help/en/experience-manager-core-components/using/introduction.html)のリリース 2.11.0 は、AEM Sites の一部として使用できるようになり、以下が含まれます。
      * 新しい [PDF ビューアーコンポーネント](https://aemcomponents.dev/content/core-components-examples/library/page-authoring/pdf-viewer.html)の紹介。
      * コアコンポーネントの Accelerated Mobile Pages（AMP）サポート。Google のモバイル検索結果からサイトに入る際のページトランジションが瞬時なので、より迅速な顧客体験を作成でき、ユーザーエンゲージメントと SEO が向上します。「[コアコンポーネントの AMP サポート](https://experienceleague.adobe.com/content/help/en/experience-manager-core-components/using/developing/data-layer/overview.html)」を参照してください。
      * [Adobe クライアントデータレイヤー](https://experienceleague.adobe.com/content/help/en/experience-manager-core-components/using/developing/data-layer/overview.html)バージョン 1.0.2 との互換性 。
...
| 2020 年 7 月 20 日 | [コンテンツ転送ツールの使用](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/cloud-service/migration/content-transfer-tool.html) | チュートリアル | オンプレミスまたは AMS でホストされている Experience Manager から [!UICONTROL AEM as a Cloud Service] 環境としてコンテンツを移行する場合は、[!UICONTROL コンテンツ転送ツール]を使用することをお勧めします。 |
| 2020 年 7 月 22 日 | [ライブコピーの作成](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/create-live-copy.html) | チュートリアル | [!UICONTROL ライブコピー作成]ウィザードを使用して、[!UICONTROL ブループリント]からサイトの[!UICONTROL ライブコピー]を作成する方法を説明します。 |
| 2020 年 7 月 22 日 | [ライブコピーコンソール](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/live-copy-overview-console.html) | チュートリアル | サイト全体での継承の表示や管理、またはライブコピーの概要コンソールを使用したロールアウト操作の実行方法を学習します。 |
| 2020 年 7 月 22 日 | [翻訳プロジェクト](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html) | チュートリアル | [!UICONTROL 言語コピー]用の翻訳プロジェクトを作成、編集、管理する方法を説明します。 |
| 2020 年 7 月 22 日 | [翻訳ジョブ](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/manage-translation-projects.html) | チュートリアル | 既存の翻訳プロジェクトに翻訳ジョブを追加する方法を説明します。 |
| 2020 年 7 月 22 日 | [言語コピーを起動時に更新する](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/updating-language-copy.html) | チュートリアル | [!UICONTROL 言語コピー]の変更を更新、確認、承認する方法について説明します。変更は Launches の支援を得て行います。 |
| 2020 年 7 月 22 日 | [マルチサイト管理の概要](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/language-copy-overview.html) | チュートリアル | [!UICONTROL AEM Sites ]の[!UICONTROL 言語コピー]を使用して、多言語サイトを作成する方法の概要を説明します。 |
| 2020 年 7 月 22 日 | [ライブコピーとブループリント](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/live-copy-and-blueprint.html) | チュートリアル | [!UICONTROL AEM Sites] での[!UICONTROL ライブコピー]とその[!UICONTROL ブループリント]間の関係を理解します。 |
| 2020 年 7 月 22 日 | [ページでライブコピーの継承を管理](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/manage-page-inheritance-live-copy.html) | チュートリアル | ページレベルで[!UICONTROL ライブコピー]とその[!UICONTROL ブループリント]間の継承を管理する方法を説明します。 |
| 2020 年 7 月 22 日 | [コンポーネントでライブコピーの継承を管理](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/manage-component-inheritance-live-copy.html) | チュートリアル | コンポーネントレベルで[!UICONTROL ライブコピー]とその[!UICONTROL ブループリント]間の継承を管理する方法を理解します。 |
| 2020 年 7 月 22 日 | [言語コピーの作成](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/manage-component-inheritance-live-copy.html) | チュートリアル | 説明 |
| 2020 年 7 月 22 日 | [言語コピーの作成](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/create-launguage-copy.html) | チュートリアル | [!UICONTROL 言語コピーの作成]ウィザードを使用して、AEM サイト用の[!UICONTROL 言語コピー]を作成する方法を学びます。 |
| 2020 年 7 月 22 日 | [多言語翻訳プロジェクトの作成](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/create-multinational-translational-project.html) | チュートリアル | AEM プロジェクトコンソールから[!UICONTROL 言語コピー]用の多言語翻訳プロジェクトを作成、編集、管理する方法について説明します。 |
| 2020 年 7 月 22 日 | [国サイトの作成](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/create-new-site.html) | チュートリアル | [!UICONTROL サイトの作成]ウィザードを使用して、既存の[!UICONTROL 言語コピー]から国のサイトを作成する方法を説明します。 |
| 2020 年 7 月 22 日 | [言語コピーの作成ページ](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/create-new-page-language-copy.html) | チュートリアル | 既存の[!UICONTROL 言語コピー]でページを作成し、そのコンテンツを別の[!UICONTROL 言語コピー]に翻訳する方法を説明します。 |
| 2020 年 7 月 22 日 | [翻訳ジョブのステータス](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/sites/multi-site-management/translation-job-status.html) | チュートリアル | 翻訳ジョブまたはジョブ内の項目に関連付けられた様々なステータスを理解します。 |
...
| 2020 年 7 月 22 日 | [AEM 受信トレイ](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/forms/inbox-customization/introduction.html) | チュートリアル | [!UICONTROL AEM 受信トレイ]フォームワークフローを含む様々な AEM コンポーネントからの通知とタスクを統合します。 |
...
| 2020 年 7 月 22 日 | [基本権限](https://experienceleague.adobe.com/content/help/en/experience-manager-learn/assets/configuring/baseline-permissions.html) | チュートリアル | ベースラインアセットフォルダーでのユーザーアクセスの管理は、ガバナンスの重要な側面であり、プロセスを適切にサポートできるようにします。 |
