...
| 機能 | [一般公開](https://docs.adobe.com/content/help/ja-JP/analytics/landing/an-releases.html) - ターゲット日 | 説明 |
| ----------- | ---------- | ---------- |
| Workspaceのメディアコンカレントビューアパネル | 2020 年 9 月 18 日 | メディアの同時ビューアパネルを使用すると、ピーク同時実行が発生した場所や下降が発生した場所を把握できます。  コンテンツの質とViewerの関与に関する貴重な情報を提供し、ボリューム/規模のトラブルシューティングや計画に役立ちます。 [詳細情報...](https://docs.adobe.com/content/help/ja-JP/analytics/analyze/analysis-workspace/panels/media-concurrent-viewers.html) |
