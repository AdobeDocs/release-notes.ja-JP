...
* [アドビシステムステータス](#status)
* [Experience Cloud界面](#ecloud) ( 更新済み **2020 年 8 月 20 日**)
...
詳しくは、 [以前のリリースノート — 2020 年 5 月 22 日](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/previous/2020/05212020.html#status) 」を参照してください。
...
* **AEM as a Cloud Service**
   ...
   * AEM Commerce が Cloud Service で利用できるようになりました。詳しくは、「[AEM Commerce as a Cloud Service を使用する前に](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/commerce/getting-started.html?lang=ja)」を参照してください。
