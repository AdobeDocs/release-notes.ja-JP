...
| 2020年9月28日（PT） | [AEM Asset Compute マイクロサービスの概要](https://experienceleague.adobe.com/?lang=ja&recommended=ExperienceManager-D-1-2020.1.asset.compute&lang=ja) | コース | このコースでは、AEM as a Cloud Service Asset Compute マイクロサービスの拡張方法を説明します。AEM as a Cloud Service Author サービスで使用するためのカスタム Asset Compute ワーカーをセットアップ、開発、テスト、デバッグ、デプロイする機能を使用できます。 |
