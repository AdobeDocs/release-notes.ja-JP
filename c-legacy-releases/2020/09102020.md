...
* **[!UICONTROL ダイナミックメディア]**&#x200B;での CDN の無効化 
   ...
   詳しくは、「[[!UICONTROL ダイナミックメディア]を使用した CDN キャッシュの無効化](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/assets/dynamicmedia/invalidate-cdn-cache-dynamic-media.html)」を参照してください。
...
* [AEM 6.4 Cumulative Fix Pack リリースノート](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/cfp-release-notes.html)
...
* [AEM Brand Portal リリースノート](https://docs.adobe.com/content/help/en/experience-manager-brand-portal/using/introduction/brand-portal-release-notes.html)
* [AEM デスクトップアプリケーションリリースノート](https://docs.adobe.com/content/help/en/experience-manager-desktop-app/using/release-notes.html)
