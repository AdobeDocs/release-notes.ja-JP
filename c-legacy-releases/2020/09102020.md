...
Experience Cloud インターフェイスの最新のリリース情報については、 [累積リリースノート](https://experienceleague.corp.adobe.com/docs/core-services/interface/release-notes/release-notes.html)（顧客属性、オーディエンス、ユーザーおよび製品の管理）を参照してください。
...
* [宛先](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#destinations)
* [ソース](https://experienceleague.corp.adobe.com/docs/experience-platform/release-notes/latest.html#sources)
...
| 2020 年 8 月 18 日 | [Launch クラウドサービス設定の作成](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-launch/create-launch-cloud-service.html) | ビデオ | 新しい Launch クラウドサービスの設定を作成する方法を説明します。その後、Launch クラウドサービスの設定を既存のサイトに適用でき、起動ライブラリの読み込みを作成者ライブラリと発行環境の両方で監視できます。 |
...
| 2020 年 8 月 18 日 | [Google カスタマーマッチ](https://experienceleague.corp.adobe.com/docs/platform-learn/tutorials/rtcdp/integrate-with-google-customer-match.html) | ビデオ | このビデオでは、Adobe の Real-Time CDP 機能と Google カスタマーマッチ機能が、Google の所有および運用するプロパティをビジネス目標と共に使用して、顧客との関わりを高める方法を示します。 |
...
* **[!UICONTROL フォーム]**
   ...
   * （JEE 上の [!UICONTROL AEM Forms] のみ）[Rights Management サービス用の外部ユーザー招待ハンドラー作成](https://experienceleague.corp.adobe.com/docs/experience-manager-65/forms/developer-reference/programming-aem-forms-jee/developing-spis-aem-forms/creating-invite-external-users-handler.html)のドキュメントを使用できます。
...
| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2020 年 9 月 1 日 | [AEM Forms と Adobe Sign の統合を利用するための XDP テンプレートの設定](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/forms/forms-and-sign/using-xdp-templates-with-adobe-sign.html) | ビデオ | 既存の XDP テンプレートを [!UICONTROL AEM Forms] と Sign の統合で活用できます。 |
| 2020 年 8 月 26 日 | [2 名の署名者に対するアダプティブフォームの設定](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/forms/forms-and-sign/configure-adaptive-form-for-two-signers.html) | ビデオ | 複数の署名者を設定し、アダプティブフォームインターフェイスを使用して順番（順次または並行）を指定します。 |
...
| 2020 年 8 月 13 日 | [AEM as a Cloud Service SDK を使用したローカル開発](https://experienceleague.corp.adobe.com/docs/experience-manager-cloud-service/commerce/develop.html) | ビデオ | [!UICONTROL AEM コマース]および [!UICONTROL AEM as a Cloud Service] SDK 用にローカル開発環境を設定する方法について説明します。 |
...
| 2020 年 8 月 18 日 | [Adobe IMS 製品プロファイル](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/cloud-service/accessing/adobe-ims-product-profiles.html) | ビデオ | Adobe IMS 製品プロファイルは、AEM 作成者サービスにログインする権利をユーザーに付与し、追加する製品プロファイルに応じて、アクセスのベースラインを提供します。 |
| 2020 年 8 月 18 日 | [Adobe IMS ユーザーグループ](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/cloud-service/accessing/adobe-ims-user-groups.html) | ビデオ | Adobe IMS ユーザーグループは、AEM に公開されるユーザーの論理セットを確立し、AEM ユーザーに対する権限を微調整するために利用できます。 |
| 2020 年 8 月 18 日 | [Adobe IMS ユーザー](https://experienceleague.corp.adobe.com/docs/experience-manager-learn/cloud-service/accessing/adobe-ims-users.html) | ビデオ | Adobe IMS ユーザーの概要、Admin Console でのアクセス方法、管理方法、およびユーザーを AEM as a Cloud Service にログインするために使用する方法について説明します。 |
