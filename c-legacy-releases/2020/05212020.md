...
>[!NOTE]
>
>を購読 [[!DNL Adobe Priority Product Update]](https://www.adobe.com/subscription/priority-product-update.html) 今後のリリース予定を電子メールで通知する場合。
...
* [[!DNL Target]](https://experienceleague.adobe.com/docs/target/using/release-notes/release-notes.html?lang=en)（Target のヘルプページへのリンク）
* [[!DNL Magento]](#magento)
* [[!DNL Marketo]](#marketo)
* [[!DNL Primetime]](https://experienceleague.adobe.com/docs/primetime/release-notes/home.html?lang=ja)（Primetime のヘルプページへのリンク）

サポートが必要な場合訪問 [[!DNL Adobe Experience League]](https://experienceleague.adobe.com/?lang=ja#home) Adobeが運営するコース、技術ドキュメント、すばやい回答、コミュニティインサイト、講師によるトレーニングを見つける。
...
| 通知 | 追加日または更新日 | 説明 |
| -----------| ---------- | ---------- |
| 統合製品ドメインへの移行 | 発効日：2020 年 5 月 29 日 | Adobe Analytics の統合製品ドメインへの移行は 2020 年 1 月に開始され、2020 年 5 月 29 日に完了しました。Adobe Analyticsは `omniture.com` アーキテクチャからのドメイン参照は、 `omniture.com` をサードパーティ Cookie として設定することもできます。 アーキテクチャの完全な移行が（間もなく）完了したら、リリースノートからお知らせいたします。すると、この許可リストの手順は不要になります。[ここ](https://helpx.adobe.com/jp/analytics/kb/adobe-ip-addresses.html) は、許可する必要がある推奨 IP アドレスとドメインの完全なリストです。<br>組織がサードパーティ Cookie をブロックしている場合は、カスタマーケアに連絡して、Adobe Analytics へのアクセスを再取得してください。 |
