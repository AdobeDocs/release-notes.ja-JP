...
サポートが必要な場合訪問 [[!DNL Experience League]](https://experienceleague.adobe.com/?lang=ja#home) Adobeが運営するコース、技術ドキュメント、すばやい回答、コミュニティインサイト、講師によるトレーニングを見つける。
...
* **AEM Experience League コミュニティ**
   ...
   [AEM Experience League コミュニティ](https://experienceleaguecommunities.adobe.com/t5/adobe-experience-manager/ct-p/adobe-experience-manager-community?lang=it&amp;profile.language=ja)とつながりを持つ：学習仲間や AEM エキスパートに質問したり、スレッドを参照したり、ヒントや専門知識を共有したりします。
...
* [Dynamic Media リリースノート](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/release-notes/s7rn2017.html?lang=ja-JP)
