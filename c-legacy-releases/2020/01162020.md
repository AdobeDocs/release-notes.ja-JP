...
* **AEM6.5.3.0**
AEM 6.5 サービスパック 3.0 （2019 年 12 月 12 日（PT） 6.5.3.0 リリース）は、2019 年 4 月のAEM 6.5 の一般リリース以降にリリースされた主要なお客様向け修正を含む重要なアップデートです。
...
* **AEM6.4.7.0**
  ...
  AEM 6.4 サービスパック 7.0 （2019 年 12 月 12 日（PT） 6.4.7.0 リリース）は、2018 年 4 月のAEM 6.4 の一般リリース以降にリリースされた主要なお客様向け修正を含む重要なアップデートです。
   * [リリースノート](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/sp-release-notes.html)
   * [AEM Forms CFP リリース](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=ja)

* **AEM6.3.3.7**

  AEM 6.3 サービスパック 3 累積修正パック 7 （2019 年 12 月 12 日（PT） 6.3.3.7 リリース）は、2017 年 4 月のAEM 6.3 の一般リリース以降にリリースされた主なお客様向けの修正を含む重要なアップデートです。
...
* **AEM デスクトップアプリ2.0.1.1**
  ...
  AEM デスクトップアプリケーション 2.0.1.1 では、Okta を使用したシングルサインオンのアップデートと、環境設定で一時ファイルの場所を指定する機能が提供されています。 このリリースでは、Desktop App 2.x に対する AEM 6.3.x のサポートが廃止されました。
...
* **新登場：AEM as a Cloud Service**
   ...
   * [はじめに](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/overview/introduction.html)
...
* **自動フォーム変換サービス**
   ...
   * [PDF フォームからアダプティブフォームへの変換](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)

### セルフサービス

* **3D アセットのプレビュー**

  AEM 6.5 は、オーサリングプロセスの一環として、3D アセットのアップロード、配信、およびインタラクティブプレビューをサポートします。インタラクティブ 3D ビューアは、AEM のアセットの詳細ページから利用できます。このビューアには、3D アセットをオービット、ズームおよびパンできるインタラクティブなカメラコントロールのコレクションが含まれます。詳しくは、[3D アセットのプレビュー](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html)を参照してください。
