...
| **[!UICONTROL アーカイブを表示]** オプションのサポート終了 | 2019 年 10 月 31 日 | 2020 年 1 月に、 **[!UICONTROL アーカイブを表示]** 」オプション (**[!UICONTROL コンポーネント/ダッシュボード]**) をクリックします。 |
| **[!UICONTROL IP ログイン制限の適用]** オプションのサポート終了 | 2019 年 10 月 31 日 | IP許可リスト(**[!UICONTROL IP ログイン制限の実施]**) 機能を **[!UICONTROL 管理者/カンパニー設定/セキュリティ]** メニュー |
...
詳しくは、 [JavaScript 版 AppMeasurement リリースノート](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ja). バージョン 2.19.0 は 2020 年 2 月 22 日にリリースされました。
...
* **TutorialsExperience Manageras a Cloud Service**
   ...
   をすぐに使い始める [Experience Manageras a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/overview.html?lang=ja).
