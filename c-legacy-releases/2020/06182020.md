...
| [Real-time Customer Data Platform のデモ](https://experienceleague.adobe.com/docs/platform-learn/tutorials/rtcdp/demo.html?lang=ja) | ビデオチュートリアル | Real-time CDP を使用して複数のソースからデータを収集する方法について説明します。このデータを 1 つのリアルタイム顧客プロファイルに統合し、そのデータをアクティブ化して、パーソナライズされた顧客エクスペリエンスを作成できます。 |
...
| [Adobe Analytics を使い始める（リーダー向け）](https://experienceleague.adobe.com/?recommended=Analytics-L-1-2020.1&lang=ja) | コース | このコースでは、Analytics の基本と、Analysis Workspace によってビジネスを変える方法について説明します。Summit 2019 でAdobe AI を使用してインサイトを引き出す方法、お客様の声を聞く方法、業界の専門家のハイライトを視聴する方法を説明します。 |
