...
* **AEM 6.5.5 Forms ドキュメントの更新**
   ...
   * 以下は、6.5.5 リリースの新機能と改善点です。
      ...
      * [インタラクティブなコミュニケーションを下書きとして保存](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html?lang=ja#save-as-draft)
   ...
   * 6.4.8.1 のリリースの新機能と機能強化は次のとおりです。
