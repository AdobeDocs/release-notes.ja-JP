...
* [Customer Journey Analyticsの新機能 &#x200B;](#cust-journey) （更新日：2020 年 12 月 8 日（PT））
...
6.5.6.0 リリースに含まれる次の機能のドキュメントが利用できます。 次ができるようになりました。
...
| 2020年10月28日（PT） | [ビデオスマートタグ](https://experienceleague.adobe.com/docs/experience-manager-learn/assets/metadata/video-smart-tags.html?lang=ja) | ビデオ | Experience Manager AssetsはAdobe AIを活用して、ビデオの主要な要素を説明するキーワードでインテリジェントにビデオアセットにタグを付け、AEM ユーザーによるキーワード検索で簡単に見つけられるようにします。 |
