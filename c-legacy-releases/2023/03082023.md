...
| -----------| ---------- |---------- |---------- |
| 2023年3月 | [Adobe Analytics ソースコネクタを使用したデータの取り込み](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-adobe-analytics.html?lang=ja) | 更新されたビデオ | Adobe AnalyticsからAdobe Experience Platformのリアルタイム顧客プロファイルとエクスペリエンスデータレイクにデータをストリーミング、マッピングおよびフィルタリングできます。 データ取り込み |
