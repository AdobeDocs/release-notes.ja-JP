...
>[!IMPORTANT]
>
>アドビでは、[!DNL Workfront] for Experience Manager 拡張コネクタの[最新バージョン 1.9.6 にアップグレード](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html)することをお勧めします。
