...
* [Microsoft® SharePoint と Microsoft® OneDrive へのアダプティブフォームの送信](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/configuring-submit-actions.html?lang=jp) - アダプティブフォームデータを Microsoft® SharePoint と Microsoft® OneDrive の両方に直接送信できるので、データ送信を効率化できます。 スキーマベースのデータとスキーマレスのデータを両方送信できます。 これらの送信アクションは、既に使用可能な送信アクションに追加されます。
