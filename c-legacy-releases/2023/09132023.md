...
| 2023年9月 | AEM Forms | [AEM ワークフローでの変数値をログ記録](https://experienceleague.adobe.com/docs/experience-manager-learn/forms/variables-aem-workflow/part6.html) | 記事 | AEM ワークフロー変数の値のログを作成します。これは、開発者が AEM ワークフローの実行方法をトラックして理解し、問題を診断し、AEM ワークフロー内のデータフローを監視するのに役立ちます。 |
