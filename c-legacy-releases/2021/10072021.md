...
| 2021年10月 | [イベントの作成](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/journey-configuration/create-events.html) | チュートリアル | イベントの設定、ストリーミングエンドポイントとイベントのペイロードの指定を行う方法について説明します。 |
