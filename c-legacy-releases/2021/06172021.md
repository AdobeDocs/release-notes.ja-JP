...
* [主要なインターフェイスコンポーネント](https://experienceleague.adobe.com/?lang=jadocs/core-services/interface/experience-cloud.html)およびユーザー管理の管理ヘルプ
...
| [!UICONTROL 広告インサイト] | ベータモードでは、次のインサイトを利用できます。<ul><li>[!UICONTROL 正規化された SIM（結合）ベータ版]</li><li>[!UICONTROL Portfolio Launch ベータ版]</li> |
