...
| 2021 年 2 月 3 日（PT） | [アドビ以外のアプリケーションへのデータのアクティブ化](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/activate-data-to-non-adobe-applications.html?lang=ja) | ビデオ | アドビの Real-time CDP が、お客様のオーディエンスとの真のパーソナライゼーション戦略の構築にどのように役立つかを説明します。また、既存のエコシステムや Microsoft®、Google および Facebook 提供のアドビ以外のアプリケーションにどのように折り込まれているかについても説明します。 |
