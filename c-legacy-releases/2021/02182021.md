...
* **ログインの更新：** Experience Cloud を更新すると、Experience Cloud ログインの初期画面が削除されます。2 月 4 日以降、`https://experience.adobe.com/login` からアドビのログイン画面に直接リダイレクトされるようになります。
...
最終更新日：**2021 年 2 月 23 日（PT）、2 月 20 日リリース**
