...
| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2021年9月 | [Experience Manager のバックエンド開発者向けの基本事項](https://experienceleague.adobe.com/?lang=ja&recommended=ExperienceManager-D-1-2019.1.backend&amp;lang=ja) | コース | Adobe Experience Manager のバックエンド開発について詳しく説明します。Java™ API、Sling モデルおよび単体テストを使用する際のベストプラクティスについて説明します。 |
