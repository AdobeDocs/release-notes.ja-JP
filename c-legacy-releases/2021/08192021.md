...
| 2021年8月 | [ファイルベースのクラウドストレージまたは電子メールマーケティングの宛先の設定](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html) | ビデオ | アドビの Real-time Customer Data Platform（CDP）におけるファイルベース宛先の設定に関するチュートリアルを通じてヒントが得られます。 |
...
* [Customer Journey Analytics の新機能](#cust-journey)（更新日：**2021年8月17日**）
...
| 2021年8月 | [Analysis Workspace でのブレットグラフのビジュアライゼーション](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/visualizations/bullet-graph-visualization.html) | ビデオ | [!UICONTROL ブレット]グラフは、分析の目標に対する進捗状況（または超過状況）を示すのに便利な方法です。組織の成功を異なる方法で視覚化することができます。 |
