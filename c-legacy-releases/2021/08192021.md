...
| 2021年8月 | [ファイルベースのクラウドストレージまたは電子メールマーケティングの宛先の設定](https://experienceleague.adobe.com/docs/platform-learn/tutorials/destinations/configuring-file-based-cloud-storage-or-email-marketing-destinations.html?lang=ja) | ビデオ | AdobeのReal-time Customer Data Platform(CDP) におけるファイルベースの宛先の設定に関するチュートリアルで、ヒントを紹介します。 |
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Adobe Experience Manager as a Cloud Service の基盤**
      ...
      * レプリケーションエージェントの下のツリーレプリケーション UI [!UICONTROL 分布] タブは非推奨と見なす必要があります。2021 年 9 月 30 日以降に削除される予定です。 [代替レプリケーション戦略について説明します](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/operations/replication.html?lang=ja#tree-activation)。
...
| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2021年8月 | [ユースケースのレシピ](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/expand/recipes/recipes.html?lang=ja) | ビデオ | 政府および商用の E 署名の例を使用して、組織のデジタルワークフローを迅速に処理できます。 |
...
| 公開日 | 名前 | タイプ | 説明 |
| ----------| --------- | --------- | --------- |
| 2021年8月 | [Adobe Stock ライセンス履歴の検索](https://experienceleague.adobe.com/docs/creative-cloud-enterprise-learn/cce-learning-hub/stockoverview/stocktutorials/searchstock.html?lang=ja) | ビデオ | Enterprise のCreative Cloudで、組織のAdobe Stockライセンス履歴をすばやく検索する方法を説明します。 |
