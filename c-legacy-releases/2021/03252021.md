...
| 2021 年 3 月 5 日（PT） | [Adobe開発者コンソール書き出しPostmanの詳細](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html?lang=ja) | ビデオ | Experience Platform API を認証しアクセスする方法を説明します。 |
