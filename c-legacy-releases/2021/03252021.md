...
| [顧客のアクティビティハブブループリント](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/audience-activation/customer-activity.html?lang=ja) | 外部アプリケーションが Adobe Experience Platform の[!UICONTROL リアルタイム顧客プロファイル]にアクセスする方法を説明します。 |
...
| 2021 年 3 月 5 日（PT） | [Amazon S3 からのデータ取得](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-cloud-storage.html?lang=ja) | ビデオ | このビデオでは、クラウドストレージサービスから Adobe Experience Platform のリアルタイム顧客プロファイルとデータレイクにデータをシームレスかつスケーラブルに簡単にバッチ取得する方法を説明します。 |
| 2021 年 3 月 5 日（PT） | [Salesforce CRM からのデータ取得](https://experienceleague.adobe.com/docs/platform-learn/tutorials/sources/ingest-data-from-crm.html?lang=ja) | ビデオ | このビデオでは、CRM ソースから Adobe Experience Platform のリアルタイム顧客プロファイルとデータレイクにデータをシームレスかつスケーラブルに簡単にバッチ取得する方法を示します。 |
...
| 2021 年 3 月 5 日（PT） |   [Adobe IO コンソールの Postman 詳細エクスポート](https://experienceleague.adobe.com/docs/platform-learn/tutorials/platform-api-authentication.html?lang=ja) | ビデオ | Experience Platform API を認証しアクセスする方法を説明します。 |
...
* [Analytics 管理者向けの重要な注意事項](#aa-notices) **（2021 年 4 月 7 日更新）**
* [AppMeasurement](#appm)
...
| 2021 年 3 月 | [AEM パブリッシュ環境を使用した実稼働デプロイメント](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/graphql/multi-step/production-deployment.html?lang=ja) | チュートリアル | オーサーインスタンスからパブリッシュインスタンスに配布されるコンテンツをシミュレートするローカル環境を設定します。 GraphQL API を使用して AEM パブリッシュ環境のコンテンツを使用するように設定された React アプリの実稼働版ビルドを生成します。 この過程で、環境変数を効果的に使用する方法と、AEM CORS 設定を更新する方法について学びます。 |
...
* [Cloud Manager ユーザガイド](https://experienceleague.adobe.com/content/help/en/experience-manager-cloud-manager/using/introduction-to-cloud-manager.html)
* [Experience Manager ドキュメントの以前のバージョン](https://experienceleague.adobe.com/content/help/en/experience-manager-release-information/aem-release-updates/previous-updates/aem-previous-versions.html)
...
| キャンペーン | （10 月 28 日リリース）以前の Campaign ベータ版のビューがデフォルトの Campaign ビューになり、より迅速なインサイト、簡素化されたワークフロー、カスタマイズされたビューを実現しました。 |
