...
[!UICONTROL アドビシステムのステータス]は、アドビクラウド製品とサービスの停止、中断、メンテナンスイベントに関する詳細情報、ステータス更新、電子メール通知を提供します。[status.adobe.com/ja](https://status.adobe.com/) でご確認ください。
...
| 2021 年 3 月 5 日（PT） | [API を使用したデータ取得の監視](https://experienceleague.adobe.com/docs/platform-learn/tutorials/data-ingestion/data-monitoring.html#data-ingestion) | ビデオ | Platform の UI と API を使用して Adobe Experience Platform に取り込まれるデータを監視および追跡する方法について説明します。 |
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Cloud Manager**
      ...
      * Cloud Manager 実稼動パイプラインに、[カスタム UI テスト](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/using-cloud-manager/test-results/functional-testing.html#custom-ui-testing)機能が追加されました。
...
| 2021年3月 | [ローンチ - 特集ビデオ](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/page-authoring/launches.html?lang=ja) | ビデオ | AEM Sites のローンチは、将来のリリースの Web サイトコンテンツを作成、オーサリング、レビューする手段を提供します。 ローンチの作成時に、実稼動 Web サイトが通常どおり進化し、日々変化する可能性があります。 |
