...
| 2025年5月 | [AEP Offer Decisioning のプレースメント間におけるキャップロジックの不一致](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26682) | 新しい記事 | Adobe Experience Platformの :1Offer Decisioning **[!UICONTROL 機能において、]** 1 メッセージとメールのプレースメントの間でキャッピングロジックが一貫して動作しない問題の解決策について説明します。 |
