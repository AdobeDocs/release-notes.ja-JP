...
| 2025年5月 | [AEP：リクエストペイロードが許可された最大サイズを超えているため、データ取り込みエラーが発生しました](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26712) | 新しい記事 | ストリーミング取得中にリクエストが 1MB の制限を超えると、Adobe Experience Platform（AEP）がペイロードサイズのエラーを返す問題の解決方法について説明します。 |
