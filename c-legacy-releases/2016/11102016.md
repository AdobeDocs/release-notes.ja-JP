...
>* Marketing Cloud IDサービスライブラリ2.0.0以上を使用すると、デフォルトでAdobe Advertising CloudのID同期が開始されます。[ID 同期と一致率について](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html)を参照してください。
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Facebook では、2016 年 11 月 1 日に Facebook Exchange（FBX）が廃止され、既存の FBX 広告は配信されなくなります。以前作成したFBXクリエイティブおよび広告戦略は、レポート用にAdvertising Cloudで一時停止されたままになります。これらを削除することはできますが、これらの有効化や編集、新しい FBX クリエイティブまたは広告戦略の作成はできません。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Cloudコミュニティフォーラムにアクセスできるようになりました。／コミュニティに移動して、アクセスできるようになりました。 </p> </td> 
  </tr> 
 </tbody> 
</table>
