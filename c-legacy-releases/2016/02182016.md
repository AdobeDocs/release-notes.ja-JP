...
* 管理者権限を持たないユーザーがプロファイル結合ルールを作成できていたバグを修正しました。（AAM-22433）
...
* [DCS エラーコード、メッセージ、例](https://marketing.adobe.com/resources/help/ja_JP/aam/dcs_error_codes.html)
* [ID 同期ファイルの名前およびコンテンツの要件](https://marketing.adobe.com/resources/help/ja_JP/aam/c_file_based_id_sync.html)
* [受信データファイルの Amazon S3 名とファイルサイズの要件](https://marketing.adobe.com/resources/help/ja_JP/aam/inbound-s3-filenames.html)
* [受信データファイルの FTP 名とファイルサイズの要件](https://marketing.adobe.com/resources/help/ja_JP/aam/?f=inbound-ftp-filenames.html)
