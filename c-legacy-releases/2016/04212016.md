...
>[!IMPORTANT]
>
>[!DNL  Recommendations Classic] および [!DNL  Search&Promote] ユーザー向けログイン通知。更新されたMarketing Cloudインターフェイスで、**[!UICONTROL Analytics]**/**[!UICONTROL ツール]**&#x200B;メニューからこれらのリンクにアクセスできます。
...
詳しくは、[Marketing Cloudの新機能 — Spring 2016](https://marketing.adobe.com/resources/help/ja_JP/mcloud/marketing-cloud-interface.html)を参照してください。
...
[!DNL  Target] の手順に関する新しいコンテンツが含まれています。[AnalyticsでのMarketing CloudIDサービスの実装](https://docs.adobe.com/content/help/ja-JP/id-service/using/home.html)を参照してください。

[Marketing Cloud ID サービス](https://docs.adobe.com/content/help/en/id-service/using/home.html)製品ドキュメントを参照してください。
...
[Analyticsの新機能](../../c-legacy-releases/2016/04212016.md#features_analytics)に記載されている機能に加えて、Analytics Premiumには、次の新機能が追加されます。
...
<table id="table_37DB222470C84C3184D8E98E5D9B146D"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> プレゼンテーションレイヤーで、円と長方形の透明度と境界線の太さを設定できるようになりました。 オブジェクトを右クリックし、「<b>塗りなし</b>」を選択して透明にします。 境界線の太さには、<b>アウトライン</b> - <b>細い</b>、<b>中</b>、<b>最も太い</b>の4つのオプションがあります。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> ワークスペース内のビジュアライゼーション</a>をハイライトし、注釈を付けるために、円と長方形の透明度と境界線のサイズを<a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_present_layer.html" format="https" scope="external">に設定できるようになりました。 円と長方形の新しいオプションには、<b>薄い</b>、<b>中間</b>、または<b>最も太い</b>の透明度と境界線の太さの設定に、「塗りなし</b>」オプションが含まれます。<b> </a></b></p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_chord_visualization.html" format="https" scope="external">弦</a>および<a href="https://marketing.adobe.com/resources/help/en_US/insight/client/c_pie_chart.html" format="https" scope="external">円グラフ</a>のビジュアライゼーションに拡大縮小機能を実装しました。 Ctrlキーを押しながらマウスのホイールを動かすか、ウィンドウの枠を右クリックして「スケール」を選択し、値を入力すると、スケールを調整できます。 </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 詳細なステータスへのアクセス </td> 
   <td colname="col2"> <p> <b>詳細なステータス</b>へのアクセスは、パワーユーザーと管理者に対してデフォルトで制限されるようになりました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>システムの更新 </p> </td> 
   <td colname="col2"> <p>これらの機能は、このリリースで名前が変更されたか、削除されたか、インストールファイルやフォルダーが再構成されました。 </p> <p> 
    ...
    <ul id="ul_7B6DDED9E1FE47328FDB5422A547AE52"> 
     ...
     <li id="li_5F0C233BD3CA4BA5A688A96059B640C0"> <p>設定ツリー(Insight.cfg)の変更： </p> 
      <ul id="ul_E7711DB0E1354CC48022459B8829F47D"> 
       <li id="li_6E3E8A99C66548608DCF62DC040B4B5D"> <p>Insight.cfg <b>Max Trace Log Size</b>フィールドに対する警告メッセージ </p> </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_294227DF6E1346F18F5FA38805A5C2C3">1月に転送者インスタンスが更新され、現在の訪問でページシーケンス番号(<span class="varname"> visit_page_num </span>)ではなく、訪問の最初のヒットがレポートに使用されるようになりました。 <span class="varname"> visit_page_num</span> が望ましい理由は、新しい月が統合されるときに月の境界を越えて変化しないからです。また、この更新には、履歴内部転送者の一部が転送者インスタンスとしてカウントされる原因となった変更も含まれていました。 4月に、過去の内部転送者が転送者インスタンスとして確実にカウントされるように、後者の変更を元に戻しました。 （AN-119405） </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    ...
    <ul id="ul_E7C4261164754D5E8B6A497F0036D970"> 
     ...
     <li id="li_74E5C0055720494D87FD61F94ACC3D54"> AppMeasurementでクエリ文字列変数の順序が変化し、<span class="varname"> pageURLRest </span>が最後になるように切り捨て問題を修正しました。 （AN-114647） </li> 
    ...
    <codeblock> 
     ...
                              // （デフォルトの「無効」動作にする場合）
    </codeblock> <p>影響を受けるバージョンは、すべてのプラットフォームで、<span class="term"> AppMeasurement forFlash</span>バージョン4.0以前です。 </p> <p>注意： セキュリティ上の理由から、<i>AppMeasurement forFlash</i>のAS2バージョンは配布されなくなります。 既存の AS2 ベースのプロジェクトからのデータ収集は、引き続きサポートされます。ただし、実装をAS3にアップグレードし、<i>AppMeasurement forFlash</i>の最新のセキュリティ機能を組み込むことを強くお勧めします。 </p> <p> <span class="term"> この問題の影響を受けるAppMeasurement forFlash </span> のお客様は、Analyticsコンソールからダウンロードできる更新済みライブラリを使用してプロジェクトを再構築する必要があります。 <a href="https://help.adobe.com/ja_JP/Flex/4.0/UsingFlashBuilder/WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7feb.html#WS6f97d7caa66ef6eb1e63e3d11b6c4d0d21-7f88" format="http" scope="external"> 詳細… </a> (AN-121780) </p> <p> <b><span class="keyword"></span>その他のプラットフォームにおける AppMeasurement</b> </p> <p>次に示すプラットフォームにおける <span class="keyword">AppMeasurement</span> のリリース履歴については、<a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/index.html" scope="external" format="https">AppMeasurement のリリース履歴</a>を参照してください。 </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     ...
     <ul id="ul_8405C43A9E2842EF8DF875C8BCDBA86B"> 
      <li id="li_B52F124D6E714FFF815785885FDDD0B2">傾向スコアモデルのエラーの問題。 <b>完了スコア</b>を表示中に傾向スコアのビジュアライゼーションにターゲットを設定すると、「ScoreDim x No Score Modelのコンパイル中にエラーが発生しました」が返されます。 傾向スコアでは、ビルドモデルで「移動」を選択できます。 ターゲットを設定し、フィルターを適用した場合(ターゲット/名前)、「OK」をクリックすると、エラーが発生します。 解決策は、<b>リセット</b>/<b>モデルをリセット</b>をクリックし、<b>移動</b>を押して問題なくビルドすることです。 </li> 
...
>[!IMPORTANT]
>
>更新されたMarketing Cloudインターフェイスで、**[!UICONTROL Analytics]**/**[!UICONTROL ツール]**&#x200B;メニューからSearch&amp;Promoteにアクセスできます。 または、[https://center.atomz.com/center/](https://center.atomz.com/center/) を使用して直接ログインします。
