...
詳しくは、[Marketing Cloud の新機能 - 2016 年春](https://marketing.adobe.com/resources/help/ja_JP/mcloud/marketing-cloud-interface.html)を参照してください。
...
[!DNL  Target] の手順に関する新しいコンテンツが含まれています。「[Analytics を使用した Marketing Cloud ID サービスの実装](https://marketing.adobe.com/resources/help/ja_JP/mcvid/?f=mcvid-setup-target.html)」を参照してください。
...
>[!IMPORTANT]
>
>更新された Marketing Cloud インターフェイスでは、**[!UICONTROL Analytics]**／**[!UICONTROL ツール]**メニューで Search&amp;Promote にアクセスできます。または、次を使用して直接ログインします。[https://center.atomz.com/center/](https://center.atomz.com/center/).
