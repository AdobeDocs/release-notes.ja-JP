...
[Marketing CloudIDサービス](https://docs.adobe.com/content/help/ja-JP/id-service/using/home.html)製品ドキュメントを参照してください。
...
* [!DNL  Social]の特定のプロパティで、削除されたユーザーが&#x200B;*`authorizers`*&#x200B;として表示され続ける問題を修正しました。 （AS-37219）
