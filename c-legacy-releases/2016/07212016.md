...
* ` loadTimeout` のデフォルト値が 500 ミリ秒から 30,000 ミリ秒（30 秒）に変更されました。「[ID サービス getInstance 関数で使用される変数](https://marketing.adobe.com/resources/help/ja_JP/mcvid/mcvid_getinstance.html)」を参照してください。（MCID-96）
...
* 新規：[Experience Cloud ID サービスの Analytics および Audience Manager への実装](https://marketing.adobe.com/resources/help/ja_JP/mcvid/mcvid-setup-aam-analytics.html)
* 改訂：[Test and Verify the Marketing Cloud ID サービスのテストと検証](https://marketing.adobe.com/resources/help/ja_JP/mcvid/?f=mcvid-test-analytics.html)

[Marketing Cloud ID サービス](https://marketing.adobe.com/resources/help/ja_JP/mcvid/)製品ドキュメントも参照してください。
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="uicontrol">プロジェクト</span>／<span class="uicontrol">プロジェクト情報</span>に情報モーダルを追加しました。このパネルには、以下のプロジェクト情報が表示されます。<!--(https://jira.corp.adobe.com/browse/AN-125284)--></p> <p> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> <b>Developer Connection コンテンツの更新</b>（2016 年 7 月 25 日追加） </p> <p><a href="https://marketing.adobe.com/developer/documentation/classifications-1-4-saint/r-createexport" format="https" scope="external">Classifications.CreateExport</a> の更新。 </p> 
    ...
    </ul> <p> <b>サポート終了のお知らせ</b> </p> <p> Web Services API のバージョン 1.2 のサポートは、2014 年 2 月 20 日に正式に終了しています。2016 年 9 月 15 日には提供終了となります。この時点で、バージョン 1.2 の API リクエストに応答する機能は API サーバーから削除されます。<span class="filepath">https://api.omniture.com/admin/1.2</span> のエンドポイントに API リクエストが送信されると、404 エラーが返されるようになります。 
     </p> </td> 
  </tr> 
  <tr> 
...
<!-- <draft-comment> 
    ...
    </draft-comment> --> <p> <b><span class="keyword"></span>JavaScript 版 AppMeasurement</b> </p> <p> <b>2016 年 8 月 4 日：</b>バージョン <b>1.6.3</b></p> <p> リクエストの接続が AppMeasurement によって途中で切断される問題を修正しました。（AN-126448） </p> <p> <p class="important">注意：<span class="keyword">Marketing Cloud</span> ID サービスのバージョン 1.6.0 には、JavaScript 版 AppMeasurement のバージョン 1.6.3 以降が<i>必要</i>です。Marketing Cloud ID サービスのバージョン 1.6.0 にアップグレードする場合は、バージョン 1.6.3 以降の AppMeasurement コードを使用してください。 </p> </p> <p> <b><span class="keyword"></span>JavaScript 版 AppMeasurement</b> </p> <p>バージョン <b>1.6.2</b></p> <p> 
...
* [最適な頻度レポート](https://marketing.adobe.com/resources/help/ja_JP/aam/index.html?f=optimal-frequency)
* [クロスチャネルコンバージョン](https://marketing.adobe.com/resources/help/ja_JP/aam/cross-channel-conversion-reporting.html)
* [プラットフォームレベルのキーによるデバイスターゲティング](https://marketing.adobe.com/resources/help/ja_JP/aam/c_tb_device_targeting.htmll)


改訂済み：

* [一括管理使用の手引き](https://marketing.adobe.com/resources/help/ja_JP/aam/c_bulk_start.html)。新しい一括管理スプレッドシートが含まれる。
* [プラットフォームレベルのキーによる GeoTargeting](https://marketing.adobe.com/resources/help/ja_JP/aam/c_tb_platform_vars.html)。最新の値を含む更新されたキーリストが含まれる。
...
>[!IMPORTANT]
>
>2016 年 9 月 15 日以降、Publisher は Publish Anywhere に置き換えられます。
...
最新の Primetime ヘルプについては、[Primetime ヘルプのホーム](https://help.adobe.com/ja_JP/primetime/)を参照してください。
