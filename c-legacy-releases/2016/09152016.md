...
<table id="table_4E4B34EEE3D94D78BA1A1FBC62950559"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> トリガーによってAnalyticsとキャンペーンが統合され、マーケティング担当者は主な消費者行動を定義、監視し、リアルタイムでの意思決定とパーソナライゼーションに役立つクロスソリューションのコミュニケーションを実現できます。 例えば、次のトリガーを作成できます。 </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_9DD79A9FD0014CA285E372FAD2BF9FE2"> 
     <li id="li_BE8C3497AA9A4FCA855130A0C7157F12">「<span class="term">今すぐファイルを送信</span>」機能が正しく動作しない問題を修正しました。 （AN-128055、AN-128057） </li> 
     <li id="li_6B38119EF3714058B75ADE1B0CF436E5">ユーザーの削除時に、管理者が「<span class="term">削除</span>」を複数回クリックしても、Analysis Workspaceプロジェクトが表示されなくなる問題を修正しました。 （AN-127911） </li> 
...
* [!DNL  Adobe Social] 内からリツイートされた投稿が、Twitter 内でネイティブにリツイートされた場合と同じように表示されるようになりました。詳しくは、[個々のツイートのモデレート](https://marketing.adobe.com/resources/help/en_US/social/t_mod_individual_tweet.html)および[引用ツイートの投稿](https://marketing.adobe.com/resources/help/en_US/social/t_post-quoted-retweet.html)を参照してください。
* 10 月 2 日以降、Adobe Analytics で Social タグを使用できるようになります（正確な日付は未定）。
   * 10月1日以降、[!DNL  Adobe Social]ユーザーは、[social tags](https://marketing.adobe.com/resources/help/en_US/social/c_settings_tag_manr.html)を使用して、アウトバウンドコンテンツを分類し、[!DNL  Adobe Analytics]内でこのコンテンツに関するレポートを作成できます。 この新機能へのアクセス権を得るには、[!DNL  Adobe Social] アカウントマネージャーか Social Support にお問い合わせください。アクセス権を取得するための手続きや利用開始サポートについての最新情報をご案内します。
...
<table id="table_5AB641198DF34491AE6D411A9BA32B51"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1" morerows="1"> <p> <b>セルフヘルプ</b> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>前回のGEMウェビナー「Setup and Configure AEMDynamic Media」の録画を以下で視聴できます。 </p> 
