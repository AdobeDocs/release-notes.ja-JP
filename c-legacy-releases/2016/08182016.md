...
[!DNL  Audience Manager] DILコードとvisitorAPI. jsコードを使用するお客様は、DIL変数を設定する必要 ` secureDataCollection= false`があります。[secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html) を参照してください。

**メンテナンスリリース：2016 年 8 月 19 日**
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col02"> 2016 年 8 月 20 日 </td> 
...
<!-- <draft-comment> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>2 月と 3 月のメンテナンスリリースの間のタイミングで、次の Analytics データ処理の方法が変更されました。 </p> <p>これまでは、イベントを設定せずに製品変数をセットすると、処理の初期段階で（Processing Rule の評価と実行が行われる前のタイミングで）「ProdView」のイベントが自動でセットされていました。モバイルデータの処理方法との不一致を避けるために、イベントは、Processing Rule の後にセットされるようになりました。この変更は、次の効果をもたらします。 </p> 
...
<!-- <draft-comment> 
    ...
    </ul> <p> <p>注意：JavaScript バージョン 1.6.3 について、<a href="https://marketing.adobe.com/resources/help/en_US/sc/appmeasurement/release/c_release_notes_mjs.html" format="html" scope="external">8 月 5 日</a>のリリースノートも参照してください。Marketing Cloud ID サービスの更新された要件が記載されています。 </p> </p> 
...
* DIL は、デフォルトで安全な HTTPS 呼び出しをおこなうようになりました。[!DNL  Audience Manager] DILコードとvisitorAPI. jsコードを使用するお客様は、DIL変数を設定する必要 ` secureDataCollection= false`があります。[secureDataCollection](https://marketing.adobe.com/resources/help/en_US/aam/?f=dil-secure-data-collection.html) を参照してください。
