...
### Marketing Cloud ID サービス（10 月 29 日更新） {#mcvid}

このリリースの ID サービスのバージョンは 1.9.0 となります。以下の機能、問題修正、その他の修正点が含まれています。

>[!IMPORTANT]
>
>Marketing Cloud ID サービスライブラリ 1.9.0 以上を使用している場合は、Adobe Media Manager の ID 同期はデフォルトで開始されます。[ID 同期と一致率について](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html)を参照してください。

* 一意のユーザーID（AAMUUID）を [!DNL  Audience Manager] IDサービスにIDと [!DNL  Marketing Cloud] して渡すバグを修正しました。（MCID-203）
...
* **（10/28、11/4更新）** IDサービスは、ID（MID）を [!DNL  Marketing Cloud] 自動的にページ上 [!DNL  Adobe Media Optimizer] で他の内部 [!DNL  Adobe] ドメインと同期します。自動同期は、すべての既存アカウントおよび新規アカウントで有効です。これにより、一致率の向上に役立ち [!DNL  Media Optimizer]ます。VisitorAPI.js バージョン 1.9 またはそれ以降で適用されます。[ID 同期と一致率について](https://marketing.adobe.com/resources/help/en_US/mcvid/mcvid-match-rates.html)も参照してください。（MCID-152、MCID-184）
...
<table id="table_1207853963C64C5E95E85E9B34B6FCFE"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col02"> <p>2016 年 10 月 16 日 </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> セグメントビルダーの更新（<b>2016 年 11 月 4 日更新</b>） </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>トレンドデータにおける変化が有意な場合に、その旨とその原因を通知します。 </p> <p>異常値検出と貢献度分析の双方が、<span class="wintitle">Analysis Workspace</span> の主要ワークフローになりました。データ内の統計上有意なデータ異常値を自動的に検知し、日ごとの異常に対して貢献度分析を実行し、<span class="wintitle">Analysis Workspace</span> プロジェクトに埋め込むことができます。 </p> <p> <b> 利用可能な機能 - 10 月 22 日更新</b> </p> 
    <ul id="ul_66A3F13AD76D41BAB27BD41C57DC9723"> 
     ...
     <li id="li_27ECEE9BF2004AEF948D0BA35D0D56A9">Analytics Standard のお客様： 
      <ul id="ul_3570FAADDD4349D2AB776E2FCAF1B622"> 
       ...
       <li id="li_3AED376A4CBD483D8682C661C644CB44"> Reports &amp; Analyticsでの貢献度分析（基本機能） </li> 
      </ul></li> 
    ...
    <ul id="ul_05ED67AA88094BB7B87CD7E648CF61CF"> 
     ...
     <li id="li_63188564A41B44E28970F204553E60FC"> <span class="uicontrol"> ディメンション: </span> 
      <ul id="ul_3DC61B9C1EA54CDCA7C8895EED163E9A"> 
       ...
       <li id="li_DC9E47E50F0541FF8894D2693B06230E">ビデオおよびモバイルレポートおよびその他の Analytics ソリューリョンレポート（Experience Manager、Media Manager、Social など）はディメンションです。 </li> 
...
* DIL は直接ページ上で ID を Adobe Media Manager と他の内部 Adobe ドメインに同期します。この機能を有効にするために、DIL は新しい cookie ` AAM_ *`partner name here`*_ *` containerNSID here`*` を設定します。` *`partner name`*` 変数および ` *`containerNSID`*` 変数について詳しくは、[DIL 作成](https://marketing.adobe.com/resources/help/en_US/aam/r_dil_create.html)を参照してください。この種の同期は、Media Manager の一致率の改善に役立ちます。（MCID-138）
...
リリース予定日：**2016 年 10 月 26 日**

**機能強化**

* Facebook ブランドコンテンツがサポートされます。自社の Facebook ページのブランドではない第三者のブランドコンテンツを公開するときに、「[!DNL Publish Anywhere]」からの投稿中で、メインにする第三者をタグ付けすることができます。詳しくは、[Facebook ブランドコンテンツポリシー](https://www.facebook.com/policies/brandedcontent/)を参照してください。[!DNL  Publish Anywhere]詳しくは、[Facebook ブランドコンテンツポリシー](https://www.facebook.com/policies/brandedcontent/)を参照してください。
...
[Adobe Media Manager](https://forums.adobe.com/community/experience-cloud/advertising-cloud) 用のコミュニティが開設されます。このコミュニティでは、質問や相談、ベストプラクティスの共有をしたり、製品情報を入手したりできます。このコミュニティは、アドビチームや世界中の製品ユーザーとつながり、情報共有やコラボレーションをするための場であり、相互に助け合うことができます。
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"></td> 
   <td colname="col2"> <p>最適化キャンペーン内の広告戦略の最新ルールは、ベース入札ではなく、Media Manager が生成する最適化入札に適用されるようになりました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>柔軟なターゲットを使用して Facebook エディターで作成した広告ターゲットは、Media Manager で読み取り専用として表示できます。 </p> </td> 
  </tr> 
  <tr> 
