...
>[!NOTE]
>
>2016 年 7 月のメンテナンスリリース以降、Ad Hoc Analysis は Java 6 をサポートしなくなります。[詳細...](https://marketing.adobe.com/resources/help/ja_JP/dsc/c_sys_reqs.html)
...
これらの機能の詳細については、「[Analysis Workspace の新機能 - 2016 年 1 月](https://marketing.adobe.com/resources/help/ja_JP/analytics/analysis-workspace/?f=new-features-in-analysis-workspace)」を参照してください。
...
|---|---|
| シングルサインオン | Marketing Cloud シングルサインオンのサポートが追加されました。[詳細情報...](https://marketing.adobe.com/resources/help/ja_JP/arb/login.html) |
...
* [データプロバイダーの請求レポートについて](https://marketing.adobe.com/resources/help/ja_JP/aam/marketplace-billing-report.html)
* [Audience Marketplace のプランの詳細ページについて](https://marketing.adobe.com/resources/help/ja_JP/aam/marketplace-buyer-details.html)

改訂済み：

* [セグメントビルダーの特徴とセグメントサイズデータ](https://marketing.adobe.com/resources/help/ja_JP/aam/segment-builder-data.html)
* [アウトバウンドテンプレートマクロ](https://marketing.adobe.com/resources/help/ja_JP/aam/?f=outbound-template-macros.html)
* [アウトバウンドマクロの例](https://marketing.adobe.com/resources/help/ja_JP/aam/outbound-macro-examples.html)
