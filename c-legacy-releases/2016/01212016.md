  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      <li id="li_3E59DBFECA4A4662AB039194F4BF1E9D">リファラーインスタンスが変更され、<span class="varname">visit_page_num</span> ではなく訪問の最初のヒットが使用されるようになりました。<span class="varname"> visit_page_num</span> は、新しい月が統合されるときに月の境界を越えて変化しません。（AN-89779） 
