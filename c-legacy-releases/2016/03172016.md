...
[!DNL  Analytics] のお客様向けに、ID サービスの導入手順を修正しました。「[Analytics を使用した Marketing Cloud ID サービスのセットアップ](https://marketing.adobe.com/resources/help/ja_JP/mcvid/mcvid-setup-analytics.html)」を参照してください。
...
* [Adobe Campaign v6 リリースノート](https://marketing-stage.adobe.com/resources/help/ja_JP/whatsnew/)
