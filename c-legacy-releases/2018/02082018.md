...
* プロビジョニングされたユーザーの Activation の UI に Auditor カードを追加しました。（CORE-3667）製品のヘルプについては、[Experience Cloud 製品ドキュメント](https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html)を参照してください。
