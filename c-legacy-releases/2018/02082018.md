...
* オーディエンスライブラリインターフェイスによって作成されたセグメントにデータが入力されない [!DNL Audience Manager] 特性の問題を修正 [!DNL Audience Manager]しました。（CORE-9891）
...
<table id="table_519893D8565A4D489CB13D5EAF1E9325"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>[!UICONTROL Mobile Services] での [!DNL Target] ワークフローのデコミッション </p> </td> 
     <td colname="col2"> <p> 2018 年 3 月より、Adobe [!UICONTROL Mobile] Services での Adobe [!DNL Target] ワークフローを無効化する準備の一環として、本リリースでは、[!DNL Target]／アクティビティ、[!DNL Target]／オーディエンス、および [!DNL Target]／コンテンツを新規作成する機能が無効になりました。 </p> <p> 既存のアクティビティ、オーディエンス、コンテンツは、2018 年 3 月まで引き続き表示、変更、削除できます。 </p> <p>詳しくは、<a href="https://marketing.adobe.com/resources/help/en_US/mobile/c_mob_remove-target-faqs.html" format="html" scope="external">Mobile Services での [!DNL Target] ワークフローの廃止</a>を参照してください。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
リリース日：**2018 年 2 月 9 日**

* [Analytics 管理者向けの重要な注意事項](../../c-legacy-releases/2018/02082018.md#analytics_notices)（更新日：**2018 年 2 月 9 日**）
* [Analytics - 新機能](../../c-legacy-releases/2018/02082018.md#features_analytics)
* [Analytics - 修正および更新](../../c-legacy-releases/2018/02082018.md#analytics-interface)（更新日：**2018 年 2 月 13 日**）
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（バックエンドの）参照メカニズムに対する変更は、いくつかの点でレポートに影響します。これらの変更は <b>2018 年 2 月末</b>頃に実施されることに注意してください。 </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_C699A0328CFD4AC4839C481710FE29AA"> 2007 年 1 月頃（場合によっては 2006 年）以前のページ／Prop のデータはサポートされなくなります。これは、ページ名、Prop、ページイベント（カスタムリンク、離脱リンク、ダウンロードリンクなど）のみに影響します。 <p>注意：この変更は、[!UICONTROL Analysis Workspace] および Data Warehouse のレポートには影響しません。 </p><p>これらの日付より前のデータがある場合、次の影響が考えられます。 </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_2F22339DDE4C475F89B53D0E6FF33183"> 
      ...
      <li id="li_2C28D135394C4B3599E0262BDE761ED5">原因となる問題を修正しました。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      <li id="li_2083954883CF43FFB3F622AA31CC4CAC"> <b>タイムスタンプ付きのヒット</b>：（更新日：<b>2018 年 2 月 13 日</b>）タイムスタンプのないヒットがリアルタイムではなく数時間後に表示される問題を修正しました。（AN-150688、AN-156202） </li> 
...
<table id="table_A6749BA62D5B40479B949EA1C64E4B7F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>[!DNL Audience Manager] のお客様は、Cookie のオーディエンスに設定したものと同じ Adobe AdCloud リンク先でデバイス ID ベースのオーディエンスを有効にできます。この機能強化により、AdCloud リンク先の追加のセットに別途モバイルオーディエンスを手動でマップする必要がないので、エンドユーザーエクスペリエンスが向上します。 </p> <p>Addressable Audiences には Cookie ID とリンク先の重複のみが表示されるので、一致率が低く見える場合があることに注意してください。詳しくは、<a href="https://marketing.adobe.com/resources/help/en_US/aam/addressable-audiences-match-rates.html" format="https" scope="external">Addressable Audiences の一致率が低くなる理由</a>を参照してください。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* トレートの数が数千に及ぶ企業においてトレートを参照するときの UI のロード時間が短縮されました。（AAM-34254）
...
詳しい情報は、製品内の**[!UICONTROL ヘルプアイコン]** / **[!UICONTROL ヘルプコンテンツ]** 。
