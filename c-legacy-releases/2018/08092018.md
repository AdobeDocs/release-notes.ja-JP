...
* [Experience Cloud およびコアサービス](#coreservices)（**2018 年 8 月 28 日**）
* [Analytics](#analytics)（**2018 年 8 月 22 日**）
...
* ビデオ広告追跡精度の改善：広告トラッキングが 1 秒間隔で行われるようになりました。
...
更新日 **2018 年 8 月 22 日**（JavaScript 2.10 の更新が削除されました。2018 年 9 月に更新されます）。
...
| レガシーラベル | レガシーラベルは、9 月 2 日（当初は 8 月 2 日に予定されていました）に読み取り専用になります。ラベルのパフォーマンスデータは、今後も引き続きレポートで使用できます。 |

Help for the Advertising Cloud is available in the product by clicking the Help icon ( **[!UICONTROL ?]**）をクリックすることで、製品内で利用できます。
