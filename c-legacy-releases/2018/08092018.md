...
See upcoming sessions or watch past sessions [here](https://helpx.adobe.com/jp/experience-manager/kt/eseminars/gems/aem-index.html).

**AEM Community の専門家への質問ウェビナー**

 この月刊ウェビナーシリーズは、エクスペリエンスリーグで最近取り上げられたトピックのインサイトを [提供します。](https://landing.adobe.com/experience-league/) | [AEM HelpXフォーラム](https://forums.adobe.com/community/experience-cloud/marketing-cloud/experience-manager)。
...
 Find local user group meet-ups [here](https://www.meetup.com/pro/aem/). ローカルグループが見つからない場合、新しいグループを作成するには、[aemusers@adobe.com](mailto:aemusers@adobe.com) までお問い合わせください。
