...
<table id="table_5405964A0900476282E85E3BF9116C8B"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><b>重要： </b>2018年5月25日にGDPRが有効になると、Adobeは、Data Connector(旧Genesis)パートナーが管理するFTPアカウントに残されたファイルの <b>自動削除を実装します。</b> （これは、Analytics のお客様に属するすべての FTP アカウントに適用されるわけではありません）。現在、FTP フォルダーのデータは無期限に保持されます。これにより、会社は、GDPR に対応していないというリスクにさらされます。2018 年 5 月 25 日以降、アドビは、Data Connector パートナーが管理する FTP サーバー上で 30 日を経過したすべてのファイルを削除します。
   </p> </td> 
  </tr> 
  <tr> 
...
2018 年 5 月 8 日の週に、アドビは、[一般データ保護規則](https://www.eugdpr.org)（GDPR）をサポートするための製品アップデートをリリースしました。以下の情報は、これらの拡張機能を理解し、実装し、必要なポリシーと手順を更新する際に役立ちます。
...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="uicontrol"> モバイル </span> SDK -  <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/c_mob_privacy-gdpr-android.html" format="html" scope="external"> Android </a> と <a href="https://marketing.adobe.com/resources/help/en_US/mobile/ios/c_mob_privacy-gdpr-ios.html" format="html" scope="external"> iOS  </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.adobe.com/content/help/ja-JP/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html" format="html" scope="external">  <span class="wintitle"> Audience Manager </span> とGDPR  </a> </p> </td> 
   <td colname="col2"> <p><span class="wintitle">Audience Manager</span>にGDPR要求を送信する方法と、Audience ManagerがGDPR要件にどのように対処するかに関する一般的な質問に対する回答。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="wintitle">ターゲット</span>訪問者プロファイルのデータを削除できるようにする方法。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://helpx.adobe.com/jp/campaign/kb/campaign-privacy.html" format="html" scope="external"> Campaign </a> </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising Analyticsでは、検索エンジンのデータをGoogle AdWords, Yahoo！からAdobe Analyticsに渡すことができます。 とBing。 </p> <p>以下の指標を使用して、残りのAnalyticsデータと並べてレポートできます。 </p> 
    <ul id="ul_12C905738789481BA6C0C5CCF2151EC6"> 
     ...
     <li id="li_68A012A841FF4A0E96FC7682B1A4A044">平均掲載順位 </li> 
    </ul> <p>さらに、Analyticsでは次のディメンションを使用できます。 </p> 
    <ul id="ul_D92898E28FEB4ADAB68869B3276182A9"> 
     <li id="li_B75433D55E0246C1AF2C86FDC830193A">キーワードの一致タイプ(AMO ID) </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Ad Hoc Analysisプロジェクトコンバーターは、ボタンをクリックすると、アドホックプロジェクトを<span class="uicontrol">Analysis Workspace</span>に変換します。 </p> <p>コピーしたプロジェクトは、必要に応じて<span class="uicontrol">Analysis Workspace</span>で使用、変更、スケジュールできます。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analyticsコネクタは、Power BIデスクトップでネイティブのデータコネクタとして使用できます。 起動時に、既存のAdobe IDを使用して認証できます。 その後、使いやすいナビゲーターにアクセスして、レポートスイートのデータ要素やデータリクエストを作成できます。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>コンテキストに応じたセッションを使用すると、モバイルアナリストや製品マネージャーは、モバイルアプリの訪問を過去に遡ってどのように扱うかを定義できます。 訪問以外でのバックグラウンドヒットの処理機能や、アプリの起動時の開始訪問の処理機能が追加されます。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p>レポート:訪問者の郵便番号ディメンションに変更します。 </p> </td> 
   <td colname="col2"> <p>訪問者の郵便番号ディメンションを更新し、他の地域変数と一致させて、ヒットの最初の値がそのヒットのクレジットを受け取るようにしました。 </p> <p>例えば、市区町村レポートを実行して訪問者の郵便番号による内訳表示をおこなった場合、各ヒットの最初の値のみが表示されます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>分類の変更 </p> </td> 
   <td colname="col2"> <p>分類UIが更新され、数値およびデータが有効な分類タイプのサポートが終了しました。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Analytics のデータガバナンスのラベル付け UI に対して以下の変更がおこなわれました。 </p> 
    <ul id="ul_67929C32C8064D428216173D06C449BA"> 
     ...
     <li id="li_B6663A0FACA644A3AF11606892186CDC"><span class="uicontrol">DEL-DEVICE</span> というラベルが付けられたフィールドの値は、指定された <span class="uicontrol">ID-DEVICE</span> がイベントに存在する場合にのみ匿名化されます。削除されていないイベントで発生する、これらの値の他のインスタンスは変更されません。 その結果、フィールドの実数を計算するレポートが変更される場合があります。 共有デバイスでは、データの件名以外の他の個人の識別子が削除される場合があります。 </li> 
     <li id="li_3E30CF2F973B46229D3726FC2320868B"><span class="uicontrol">Do Not Delete</span> ラベルが削除されました。 </li> 
     <li id="li_BCB7DF19FA81459E9BE598B19C956460">変数のデータガバナンスラベルを.csvファイルにエクスポートする機能を追加しました。 これにより、ラベルを法務チームと共有できます。 </li> 
     <li id="li_CF202A81A675463BA3BC6783D9C9E0A1">ディメンションのサンプル値を追加し、各変数に含まれるデータのタイプとラベルの付け方を簡単に確認できるようにしました。 </li> 
    </ul> <p>また、 </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><b>2018 年 5 月 15 日リリース予定</b> </p> <p> <span class="term">mc_audiences</span> 列が追加されました。<span class="term"> mc_オーディエンス </span> は、Adobe  <span class="wintitle"> Audience ManagerのAudience AnalyticsセグメントIDリスト </span>です。 </p> <p>注意：ID の分類であるため、表示上の名前は記述されていません。 </p> 
    <!--<p>https://jira.corp.adobe.com/browse/AN-154807</p>--> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>Ad Hoc Analysisの国レポート </p> </td> 
   <td colname="col2"> <p>Ad Hoc Analysisの「国」レポートは「国/地域」に名前が変更されました。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>ビデオ分析 </p> </td> 
   <td colname="col2"> <p> <b>メディアコレクション API </b> </p> <p> VA SDKの制限またはVideo Analytics(VA)SDKのサポートが欠如しているため、ビデオ表示を完全に測定できなかったメディア発行者は、これらのデバイスにMedia Collection APIを適用できます。 これにより、VRヘッドセットやゲームコンソールなどのデバイスを含め、ユーザーがビデオを表示するすべてのデバイスに対して、クライアントが透明性を持つことができます。 メディアコレクションAPIは、ハートビートVA SDKコレクションを通じて、詳細で標準化された指標を提供します。 これらの指標を組み合わせて、完全な顧客ジャーニーを確認できます。 </p> 
    <ul id="ul_FD2036F9D160400AAB654CEE30657AAB"> 
     <li id="li_5F4D87F536F6436DAD99F6CDB878BD52">任意のデバイスでビデオを測定：ゲームコンソールやVRデバイスなど、現在SDKをサポートしていないデバイスに対してメディア収集APIを適用します。 </li> 
     <li id="li_2DEE2FE8ED26476CA4C25163D4803345">RESTful API（VA SDKを補完）:メディア収集APIは、SDKを介して提供されるのと同じ詳細な結果や指標を達成するために、合理化された効率的な測定メカニズムを提供するように設計されています。 </li> 
     <li id="li_F4D509A6904C484AA1F0BDFAEA678F8A">全体的なオーディエンスの測定：Media Collection APIでは、顧客のすべてのエンゲージメントをビデオと共に全体的に表示し、顧客の全リーチに関するより正確な視点を得ることができます。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_A50A05631E574C83AD7075579B14ACF1"> 
      <li id="li_227327CC9233438688BF7F593027C1DE">[!UICONTROL Analysis Workspace] から計算指標ビルダーを開くときに発生していた問題を修正しました。この問題により、関数ドロップダウンリストにオプションが表示されませんでした。 （AN-160698） </li> 
      <li id="li_C24CD6D3CDF748A0B959D44A4DF41C6A">フリーフォームテーブルの検索機能に関する複数の問題を修正しました。 その結果、基本フィルターとアドバンスフィルターのクエリでの編集操作が改善されました。 （AN-159843） </li> 
      <li id="li_727C26115CF946CDA62982DBEA4EAC6B">テキストが既存のタグと一致する場合にタグを作成できない問題を修正しました。 （AN-159363） </li> 
      <li id="li_DCFFC6CB25054530B5B8B0418DB5CC36">テキストのビジュアライゼーションがデフォルトでページの先頭に表示され、目的の場所に配置できない問題を修正しました。 （AN-159148） </li> 
      <li id="li_ABD6A21F42664A3EAEE0036388831B8B">フリーフォームテーブルの「検索」フィールドで、日本語と韓国語の文字入力の問題を修正しました。 （AN-158778） </li> 
      <li id="li_A4F55515A9CA4845A4662DEA5712EE77">非管理者がプロジェクトのお気に入り、タグの適用、承認を行った場合に、プロジェクトの変更日に変更が生じる問題を修正しました。 （AN-157398） </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_666BB742E5BE4CC9BE95E697DA5DBB67"> 
      <li id="li_6B5F531B822D4392AD7760752C29B371">セグメントビルダーで、「シーケンスの前のみ」および「シーケンスの後のみ」オプションのラベルが切り替えられ、復元される問題を修正しました。 （AN-160747） </li> 
      ...
      <li id="li_7AF0C1DF79844130B488EDAF27A35B91">「会社設定」の「パスワードの有効期限」機能の問題を修正しました。 （AN-154927） </li> 
      <li id="li_07E8FF50269B4B7B82EBE67BBF0335A3">アセットを転送するユーザーがアラートの所有者としてリストされている場合に、アセットの転送機能が動作しない問題を修正しました。 （AN-160747） </li> 
      <li id="li_E2A3A073962847FE98D3866E97B6EF04">Experience Cloudを使用してAnalyticsにログインする際に発生していた問題を修正しました。複数のログイン会社がユーザー名に関連付けられている場合、正しくないログイン会社が選択されることがありました。 （AN-160880） </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_EB8261E817054C2F8B17C09D16DB3412"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>WebサービスレポートAPI </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>DIL バージョン 7.0 をリリースしました。これには以下のアップグレードおよび修正点が含まれています。 </p> <p> 
     <ul id="ul_D127326A5EA14C028D43A62CAA8CD758"> 
      <li id="li_FDBFB52DA5214B50B3D77482925B8FA4">Launch における <a href="https://marketing.adobe.com/resources/help/ja_JP/aam/r_dil_sc_init.html" format="html" scope="external">DIL SiteCatalyst モジュール</a>との競合条件を修正しました。（CORE-10266） </li> 
      <li id="li_53DBDB6DAB354DF1AD8545A9F14D36F5">DIL起動拡張のUXレビューを実装。 （CORE-8143） </li> 
     </ul> </p> <p>最新バージョンについては、アドビコンサルタントまたはカスタマーケアにお問い合わせいただくか、あるいは <a href="https://marketing.adobe.com/resources/help/ja_JP/dtm/c_overview.html" format="https" scope="external">Dynamic Tag Management（DTM）</a>または <a href="https://marketing.adobe.com/resources/help/en_US/experience-cloud/launch/t_quick-start.html" format="https" scope="external">Adobe Launch</a> から入手してください。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>GDPR 対応 </p> </td> 
   <td colname="col2"> <p>2018年5月25日にGDPR(European General Data Protection Regulation)が発効した日に近づくにつれ、GDPRの義務を満たすために<span class="wintitle">Audience Manager</span>で消費者データを管理するのを支援する文書を作成しました。 次のドキュメントをお読みください。 </p> <p> 
     <ul id="ul_542C0E9F27804307AED8FCE933135A43"> 
      <li id="li_853306663308434CAF8F63EFC7895817"> <p> <a href="https://marketing.adobe.com/resources/help/en_US/aam/aam-gdpr-details.html" format="https" scope="external"> Audience Manager の GDPR 対応 </a> </p> </li> 
...
* API呼び出しを使用してすべての特性のリストを取得できなかったバグを修正しました。 （AAM-36824）
* [セグメントビルダー](https://marketing.adobe.com/resources/help/ja_JP/aam/c_segment_builder.html) コードビューで、セグメントをもう一度編集すると括弧を含む式から括弧が消える問題を修正しました。（AAM-36393）
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>最新の拡張スマートタグリリースでは、次のような主な機能強化が行われています。 </p> <p> 
     <ul id="ul_1F32257EF31548F986B7D547056BDB3C"> 
      <li id="li_4EDD96DF180B436CB817B8E1B150F1DF">アルゴリズムの最適化により、モデルの精度や再現率の値をさらに改善。 </li> 
      <li id="li_86039BFA4E2E4B16A24F44A2FF710431"> テナントレベルのすべてのタグに対するモデルトレーニングのリセットをサポート。 </li> 
      <li id="li_7363B9318FB1492A9F067B7F534C5355">競合を回避するための拡張スマートタグ名前空間のサポート。 </li> 
      <li id="li_9A675C8D29B549ADAE15BBC1B81311A7">再トレーニングによる劣化を回避する新しいモデル置き換えポリシー。 </li> 
      <li id="li_956259E154DC43DDAFE59836511AF87E">テナントごとのサービス使用の監視。 </li> 
      <li id="li_352CE4CD51AC4F798B11F6C2C0E9090C">クラスタリング。接続に固有の問題が解決され、サービスの堅牢性が向上しました。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>AEMおよびGDPR </p> </td> 
   <td colname="col3"> <p>欧州和集合のGDPR(General Data Protection Regulation)は、データのプライバシーに関する権利を2018年5月に発効します。 AEM および <a href="https://helpx.adobe.com/experience-manager/6-4/managing/using/gdpr-compliance.html" format="https" scope="external">GDPR への準拠</a>に関する詳細情報を参照してください。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>この年次バーチャルグローバル会議では、エンタープライズ開発者、アーキテクト、データサイエンティストに対して、あらゆるエクスペリエンスレベルで詳細なセッションを行います。 インド標準、英国夏、太平洋のタイムゾーンでライブセッションが開催されます。 チケットをお持ちのお客様はさらに、すべての録音されたセッションに 1 年間無制限にアクセスできます。 </p> <p>AdobeIMMERSEは、Adobe Experience Managerでソリューションを構築する開発者を対象にした、毎年恒例のバーチャルグローバル会議です。 また、今年は、Adobe Cloud Platform、Adobe I/O、Adobe Sensei、ColdFusion、FrameMakerに関するセッションも開催します。 </p> <p>Adobeや開発者コミュニティの専門家から、製品の紹介、レシピ、ベストプラクティス、コード例を詳しく紹介します。 ライブセッションは 3 つのタイムゾーンにわたって配信されます。 </p> <p> 
     <ul id="ul_BDA2A6B569EF422B9327FBF7474D7D98"> 
      <li id="li_69F4FDE29DE14B1A969F428CB3A1A5A6">アメリカ（太平洋標準時） </li> 
      <li id="li_E3EA932CAA4F4122ACC7982CA1856CD1">ヨーロッパ（英国夏時間） </li> 
      <li id="li_673F096F6C7541FB8F3FAA21914852F7">APAC（インド標準時） </li> 
     </ul> </p> <p>アジェンダをご確認のうえ、25.00 ドル（USD）の割引が適用される割引コード <b>MR765z</b> を使用して、<a href="https://adobe.ly/immerse18" format="https" scope="external">https://adobe.ly/immerse18</a> にて登録してください。Adobeが主催する最大の開発者会議を見逃さないでください。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col2"> <p>AEM技術者会議グループ </p> </td> 
   <td colname="col3"> <p>このバーチャルグループは、AEM GEMの通知を提供します。予定が決まったらすぐに、AEMコミュニティエキスパートのウェビナーに問い合わせてください。 対面イベントや各地域でのユーザーグループミーティングの通知もお届けします。 </p> <p> <a href="https://adobe.ly/2sVoSwy" format="https" scope="external">https://adobe.ly/2sVoSwy からご参加ください。</a> </p> </td> 
  </tr> 
  <tr> 
...
## [!DNL Advertising Cloud] (旧Advertising Cloud)
