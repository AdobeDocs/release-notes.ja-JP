...
<table id="table_09C086041AB5447093588F9B197214A6"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="uicontrol"> モバイル </span> SDK - <a href="https://marketing.adobe.com/resources/help/en_US/mobile/android/c_mob_privacy-gdpr-android.html" format="html" scope="external"> Android </a><a href="https://marketing.adobe.com/resources/help/en_US/mobile/ios/c_mob_privacy-gdpr-ios.html" format="html" scope="external"> とiOS </a> </p> </td> 
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="https://marketing.adobe.com/resources/help/ja_JP/analytics/gdpr/index.html" format="html" scope="external">Analytics の GDPR 対応に関連する更新 </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <b>メディアコレクション API </b> </p> <p> VA SDKの制限またはVideo Analytics(VA)SDKのサポートが欠如しているため、ビデオ表示を完全に測定できなかったメディア発行者は、これらのデバイスにMedia Collection APIを適用できます。 これにより、VRヘッドセットやゲームコンソールなどのデバイスを含め、ユーザーがビデオを表示するすべてのデバイスに対して、クライアントが透明性を持つことができます。 メディアコレクションAPIは、ハートビートVA SDKコレクションを通じて、詳細で標準化された指標を提供します。 これらの指標を組み合わせて、完全な顧客の遍歴を見ることができます。 </p> 
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>この年次バーチャルグローバル会議では、エンタープライズ開発者、アーキテクト、データサイエンティストに対して、あらゆるエクスペリエンスレベルで詳細なセッションを行います。 インド標準、英国夏、太平洋のタイムゾーンでライブセッションが開催されます。 チケットをお持ちのお客様はさらに、すべての録音されたセッションに 1 年間無制限にアクセスできます。 </p> <p>AdobeIMMERSEは、Adobe Experience Managerでソリューションを構築する開発者を対象にした、毎年恒例のバーチャルグローバル会議です。 また、今年は、Adobe Cloud Platform、AdobeI/O、Adobe Sensei、ColdFusion、FrameMakerに関するセッションも開催します。 </p> <p>Adobeや開発者コミュニティの専門家から、製品の紹介、レシピ、ベストプラクティス、コード例を詳しく紹介します。 ライブセッションは 3 つのタイムゾーンにわたって配信されます。 </p> <p> 
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> </p> </td> 
   <td colname="col2"> <p>テキスト広告およびショッピング広告テンプレートのフィードフィルターに <i>、not</i>、 <i>less than</i>、 <i>greater thanの演算子が含まれるようになりました</i>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> </p> </td> 
