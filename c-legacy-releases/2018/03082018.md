...
[こちら](https://marketing.adobe.com/resources/help/ja_JP/mcloud/solutions-core-services.html)へ移動して、Experience Cloud のソリューションやコアサービスの最新のブランディングアップデートの詳細をご覧ください。
...
* [!DNL  visitor.cookieDomain] の冒頭にドットがある場合に Experience Cloud ID サービスが誤ってそのドットなしでドメインに AMCV cookie を設定する問題を修正しました。例えば、[!DNL  .sampledomain.com] に加え、[!DNL  sampledomain.com]で [AMCV cookie](https://marketing.adobe.com/resources/help/ja_JP/whitepapers/cookies/cookies_mc.html) を設定します。（CORE-10634）
