...
* [!DNL  visitor.cookieDomain] の冒頭にドットがある場合に Experience Cloud ID サービスが誤ってそのドットなしでドメインに AMCV cookie を設定する問題を修正しました。例えば、に加えて [AMCV cookie](https://marketing.adobe.com/resources/help/en_US/whitepapers/cookies/cookies_mc.html) を設定 [!DNL  sampledomain.com][!DNL  .sampledomain.com]します。（CORE-10634）
