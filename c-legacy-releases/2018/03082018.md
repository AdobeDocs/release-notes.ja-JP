...
[!UICONTROL Mobile Servicesの新機能、更新および修正点です]。
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（バックエンドの）参照メカニズムに対する変更は、いくつかの点でレポートに影響します。これらの変更は <b>2018 年 2 月末</b>頃に実施されたことに注意してください。 </p> 
    <ul id="ul_7515E2E79FD94B8F8DFF4C2DBB9E6A84"> 
     ...
     <li id="li_E46207F194134AEA86F5CB2C8F26C76C"> Category reports for rollups and current data in <span class="uicontrol">Reports &amp; Analytics</span> are no longer provided. ただし、Web Services API におけるカテゴリロールアップレポートの廃止は、4 月のメンテナンスリリースまで延期されています。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_B3810CF9DA584DDDB811F1D0F91B78F2"> 
      ...
      <li id="li_F15E1A5F9EBB4A1AA5A7233D94051187"> <b><span class="uicontrol">Reports &amp; Analytics</span></b>：ターゲットレポートで四半期合計のレポートが不正確になる問題を修正しました。（AN-153933） </li> 
