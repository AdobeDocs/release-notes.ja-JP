...
異なるカラーパレットを選択するか、独自のパレットを指定することで、Workspace で使用されるカラースキームを変更できるようになりました。この機能は、ほとんどのビジュアライゼーションを含む Workspace の多くの機能に影響します。**変更の概要、フリーフォームテーブルの条件付き書式、およびマップのビジュアライゼーションには影響しません。**
...
* 「_テンプレートとして保存_」という権限を追加し、ユーザーがプロジェクトをWorkspaceのテンプレートとして保存できるようにしました。 これは以前、作成/キュレーション権限にバンドルされていたので、この権限を持つユーザーはだれでも、新しい&#x200B;_テンプレートとして保存_&#x200B;権限を受け取ります。

**Advertising Analytics の機能強化**

Adobe Analyticsの導入による検索エンジンデータの自動トラッキングのために、[自動トラッキングモード](https://marketing.adobe.com/resources/help/en_US/analytics/advertising/aa_manual_vs_automatic_tracking.html)が導入されました。
...
* 顧客ジャーニーフロー — 車を含むすべてのリスニングデバイスにわたるユーザーを測定し、デバイス間のリスニングエクスペリエンス、分単位の同時リスナー、次にアクセスするコンテンツを把握します。
...
[Livefyre](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/livefyre.html)との統合の更新（[Livefyre Feature Pack 2.0.6リリース](https://helpx.adobe.com/experience-manager/6-4/release-notes/livefyre-feature-pack-206.html)および[機能パック](https://helpx.adobe.com/experience-manager/6-4/release-notes/feature-packs-release-notes.html)ページ用の新しいワークフロー）
...
AEM SPAエディタ用の[シングルページアプリケーション(SPA)](https://helpx.adobe.com/experience-manager/6-4/sites/developing/user-guide.html?topic=/experience-manager/6-4/sites/developing/morehelp/spa.ug.js)の開発に関するドキュメントが更新され、展開されます。

**リッチテキストエディター**

改訂された[リッチテキストエディター](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/rich-text-editor.html)の設定のトピックを構成し、不足している情報の追加、ワークフローの図の追加、長い形式の記事の分割を行いました。
...
詳しくは、「[Marketing CloudとCreative CloudのAEM Assets統合を設定](https://helpx.adobe.com/experience-manager/6-4/sites/administering/using/configure-assets-cc-integration.html)」および「[ブランドポータルとのAEM Assets統合を設定](https://helpx.adobe.com/jp/experience-manager/6-4/assets/using/brand-portal-configuring-integration.html)」のトピックを参照してください。
...
今後のセッションを見るか、以前に記録したセッションを[ここ](https://helpx.adobe.com/jp/experience-manager/kt/eseminars/gems/aem-index.html)で見る。
...
今後のセッションを見るか、以前に記録したセッションを[ここ](https://helpx.adobe.com/experience-manager/kt/eseminars/ask-the-expert/atace-index.html)で見る。
...
仲間と一緒に！ 地元のユーザーグループのミーティングアップは増え続けています。 [ここ](https://www.meetup.com/pro/aem/)に1つあるかどうかを確認します。 ローカルグループは見えないが、グループの開始に関心があるか。 [aemusers@adobe.com 宛てに電子メールを送信してください。](mailto:aemusers@adobe.com)
