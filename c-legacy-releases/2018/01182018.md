...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>パネルやプロジェクトをまたがった ビジュアライゼーション／パネルのコピー＆ペースト </p> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>新しい<span class="uicontrol">モバイル</span>テンプレート（メッセージングと場所） </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Workspace で左端の列のサイズを変更するときに、残りの列の幅の割合が維持されるようになりました（右隣の列幅が調整されるだけではありません）。この変更により、分析と共有の両方でテーブルの作成が高速になります。 </p> <p> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>PDF での マップビジュアライゼーションのサポート </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>以前は、プロジェクトをコピーした場合や、<i></i>として保存を使用した場合、プロジェクトに保存されたすべてのイントラリンクは、コピーされたプロジェクトではなく、元のプロジェクトを指していました。 </p> <p>現在は、コピーまたは名前を付けて保存した後、イントラリンクは、そのリンクが存在するプロジェクトに対する相対リンクになります。 </p> <p> <a href="https://marketing.adobe.com/resources/help/ja_JP/analytics/analysis-workspace/t_freeform_project.html" format="html" scope="external"> 詳細情報... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
   <td colname="col1"> <p>貢献度分析：トークン通知 </p> </td> 
   <td colname="col2"> <p>会社に貢献度分析トークンの数が限られている場合、<span class="uicontrol">Analysis Workspace</span> UIは、トークンを使用したときに通知を表示するようになりました。 これにより、残りのトークン数を把握できます。&amp;nbspa; </p> <p>（管理者ユーザーは、グループ権限を編集することにより、トークンの使用者を制限できます）。&amp;nbspa; </p> <p> <a href="https://marketing.adobe.com/resources/help/ja_JP/analytics/contribution/ca_main.html" format="html" scope="external"> 詳細情報... </a> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="uicontrol">Analysis Workspace</span>での「なし」/「未指定」の動作方法を変更し、<span class="uicontrol"> Reports &amp; Analytics</span>、セグメントビルダー、および<span class="uicontrol">Analysis Workspace</span>のディメンション値メニューと一致するようにしました。 </p> <p>これは、<span class="uicontrol">Analysis Workspace</span>のほとんどのプロジェクトでは、値が「なし」ではなく「未指定」と表示されることを意味します。 （AN-146879） </p> </td> 
  </tr> 
  <tr> 
   <td> <p>その他の解析 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>キュレーションされたコンポーネント（セグメント、計算指標、日付範囲）を<b>共有</b>する必要はなくなりました。 共有されていなくても、仮想レポートスイート用にキュレートされている場合は、 Workspace で常に表示されます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><a href="https://marketing.adobe.com/resources/help/ja_JP/analytics/segment/seg_build.html" format="html" scope="external">セグメントビルダー</a>に、<span class="uicontrol">Analysis Workspace</span>製品互換性タイプを追加しました。 </p> <p>日付範囲が埋め込まれたセグメントは、引き続き<span class="uicontrol">Analysis Workspace</span>と<span class="uicontrol"> Reports &amp; Analytics</span>で異なる動作をします。Workspaceで、日付範囲が埋め込まれたセグメントは、パネルの日付範囲より優先されます。 これに対して、<span class="uicontrol">Reports &amp; Analytics</span> では、レポートの日付範囲とセグメントの埋め込みの日付範囲が重なる期間のみが対象期間になります。 </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_049F6A23A21F4EF583A62D7C64759295"> 
      ...
      <li id="li_A38AEC6152294BA282964357D95C6CA7">日付範囲を変更した場合や、<i>位置</i>で分類を使用した場合に、分類が正しく更新されない問題を修正しました。 （AN-152275） </li> 
      ...
      <li id="li_274DB6E81EF141AAA25B8E90D373390C">コホートテーブルに、特定のインスタンスで<i>NaN</i> （数値ではない）と表示されていた問題を修正しました。 コホートテーブルには、代わりに<i>無効な</i>が表示されるようになりました。 （AN-146403） </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D8C419C29A7B4184802AC44AFF26F271"> 
      <li id="li_421869B6AD854ABFBA09B554B2A042D6"><i><i>ユーザーが</i>を使用してログインした場合に、「レポートへのリンク</i>」オプションで生成されたリンクが機能しない問題を修正しました。 （AN-153261、AN-153038） </li> 
      ...
      <li id="li_DD523B3B36454E1A84E38792EF967F54"> <b>Admin Console</b>：「複数」をクリックしたときの、成功イベントに関する列の命名の問題を修正しました。<i></i><i>Type</i>列に<i>Name</i>の値が代わりに表示されていました。 （AN-148763） </li> 
...
* 使用可能な派生シグナルの数に 50,000 件の制限を追加しました。[使用制限](https://marketing.adobe.com/resources/help/ja_JP/aam/usage-limits.html)の詳細を読みます。
...
* Internet Explorerブラウザーのバグを修正しました。 表示ページからリンク先を編集しようとすると、「編集」ボタンがイベントをトリガーしませんでした。 （AAM-33625）
...
<table id="table_885F194180FE42EFA04220C9299969E4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> ワークフロー用のシグナルアクティビティを<span class="wintitle">Adobe Campaign</span>標準APIから直接トリガーできるようになりました。 </p> <p>詳しくは、<a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html#triggering-a-signal-activity" format="html" scope="external">詳細ドキュメント</a>を参照してください。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F4E7F10923004BF1AD49BACE86D4982E"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>AEM 6.3Dynamic Media機能パック </p> </td> 
   <td colname="col3"> <p>AEM 6.3Dynamic Media機能パックは、AEM 6.3.1.0と互換性があります。 </p> <p> 
