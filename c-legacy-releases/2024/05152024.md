...
* [[!DNL Adobe Analytics]](#analytics) 日（リリース日 **5 月 15 日**）
* [[!DNL Adobe Customer Journey Analytics]](#cja) 日（リリース日 **5 月 15 日**）
...
* **皆さんの体験** | ビデオ | _Experience by You_ では、AdobeDX ソリューションで高度な専門知識と影響力を獲得した日常的なユーザーが作成したコンテンツを特集します。 製品の専門知識をレベルアップさせるために必要なインスピレーションを見つけます。 | [ オンデマンドで利用可能 ](https://experienceleague.adobe.com/en/docs/experiences-by-you/experiences-by-you/overview)

Experience Leagueで [ 今後のイベント ](https://experienceleague.adobe.com/events/) または [ 過去のイベント録画 ](https://experienceleague.adobe.com/ja/docs/events/experience-league-recorded-events/overview) を参照してください。
