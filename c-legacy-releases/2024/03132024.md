...
# Experience Cloudリリースノート - 2023 年 3 月
...
* **WORKFRONT** |カスタマーワークショップ | _学習：Adobe Workfront のテキストモードに関する 10 のヒント_ | テキストモードでレポートに関する知識を深めませんか？さあこちらへこのワークショップでは、テキストモードの基本と API エクスプローラーの概要を説明し、続いて、Adobe Workfront のテキストモードに関する 10 のヒントをご紹介します。| **4月18日午前 9:00（PT）** | [登録](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,--xUIfX6gEqCcuYNDuE5IA,S8LJKpyI4kywiEO88_bvdg,Z6HaWjLNV0CaMzwT0JeWQg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **Workfront** | コミュニティイベント | _つながり：Workfront Collective_ | 仲間の Workfront システム管理者と共に、この毎月開催される共同ブレーンストーミングおよび共有セッションで、最新の更新情報やベストプラクティスについて話し合いましょう。| **4月22日午前 6:00（PT）** | [登録](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,PLjes69h2kitBUQrGr_tSQ,9hwaemfUG0uEqL-RwJW9fQ,OzGfEfueq0yp19zAhpjfwA?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **Workfront** | Q＆A チャット | _質問：Adobe Business Platform への移行_ | テクニカルサポートエンジニアとの Q＆A に参加して、Adobe Business Platform への移行に向けて想定される事柄と最適に準備する方法を学びましょう。| **4月23日午前 8:00（PT）** | [登録](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,wXdzewqwQEO_SiY5SC4i2Q,r3bZVp0PVkObL30IXUw5iA,1p0c3CZ2qEGQBAZpsDvvEw?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

Experience League でその他の[今後のイベント](https://experienceleague.adobe.com/events/)を確認するか、[イベントの録画](https://experienceleague.adobe.com/docs/events/experience-league-recorded-events/overview.html?lang=ja)を参照してください。
