...
* ID サービスが使用するアドビドメインへのホワイトリスト呼び出しの方法について説明した新しいドキュメント、[コンテンツセキュリティポリシーと Marketing Cloud ID サービス](https://marketing.adobe.com/resources/help/ja_JP/mcvid/?f=mcvid-csp.html) を追加しました。
...
* [Audience Lab](https://marketing.adobe.com/resources/help/ja_JP/aam/?f=audience-lab.html) のタイムリーな読み込みが妨げられるバグを修正しました。（AAM-32249）
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bing Ads は、9 月 25 日に Media Manager で管理されたアカウントから新しいサイトリンクモデル（共有サイトリンク）への移行を開始する予定です。この操作には 4 日間かかる見込みです。9 月 22 日以降、アカウント移行が完了するまでは Media Manager でサイトリンクにアクセスできなくなり、サイトリンクが削除されたかのように不適切な表示になります。移行が完了する前にサイトリンクを変更する必要がある場合は、Bing Ads エディターで直接操作してください。変更は移行が完了した後で新しいモデルに移行され、Media Manager によって同期されます。共有サイトリンクをサポートする機能は、10 月のリリースで利用可能になる予定です。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>キャンペーン検索ベータ版 </p> </td> 
