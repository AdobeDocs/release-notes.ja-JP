...
* Added new documentation, [Content Security Policies and the Marketing Cloud ID Service](https://docs.adobe.com/content/help/ja-JP/id-service/using/reference/csp.html) that explains how to allow calls to Adobe domains used by the ID service.
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col3"> <p>このリリースは、Dynamic Mediaのお客様に新しい自動化機能と配信機能を提供します。Dynamic Mediaの既存のDynamic Media Classic(S7)AEMのお客様が、Dynamic Mediaにトランジションできる最初のリリースです。 </p> <p> 
