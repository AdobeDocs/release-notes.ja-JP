...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Advertising cloudからAnalyticsにリバースデータフィードを新しいバージョンで導入すると、データの正確性が大幅に向上します。 Analytics との統合を利用している広告主の皆様は、今後数週間のうちに新しいリバースフィードにアップグレードされます。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>既存の Adobe Experience Cloud オーディエンスの電子メールリストやセグメントを使用して、Google オーディエンス（検索広告のリマーケティングリスト）を作成できるようになりました。 </p> <p> 
     <ul id="ul_9F69C50A39CE45928E98F7AC1015C807"> 
      ...
      <li id="li_FA9DE45045324D5781BAF8FB113E274B">Adobe Audience Managerのセグメント：（ホワイトリストに登録された広告主用のベータ版のみ）キャンペーンベータ版(&amp;amp);gt;オーディエンス(&amp;A);gt;オーディエンスを使用すると、Advertising cloudを宛先とする任意のAudience Managerセグメントから、Google webサイトのタグベースのオーディエンスを作成できます。 これには、Adobe Experience Cloud に発行されている Adobe Analytics セグメントや、People コアサービスを使って Adobe Experience Cloud に作成されたセグメントが含まれる可能性があります。Advertising cloudは、Googleの追跡URLを自動的にAudience Managerのセグメントにプッシュして、Googleがオーディエンスを追跡できるようにします。 </li> 
     </ul> </p> <p>Advertising cloudには、Googleオーディエンスの作成または編集に使用する電子メールリストやAudience Managerセグメントの顧客データは一切保存されません。 </p> </td> 
  </tr> 
  <tr> 
