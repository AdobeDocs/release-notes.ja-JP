...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>「自動最適化入札調整」オプションを使用すると、ポートフォリオが最適化されたときにポートフォリオの広告グループの入札調整設定を自動的に変更し、パフォーマンスを最適化できます。広告クラウドは、Google、BingおよびYahoo!の入札調整を最適化できます。日本のモバイルデバイスターゲット、Google と Bing のタブレットおよびコンピューターターゲット、Google の RLSA ターゲット、Google のロケーションターゲット向けに入札調整を最適化できます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（最後の URL の Bing Merchant Center アカウント）Bing Shopping のテンプレートおよびバルクシート内の製品グループで、「トラッキングテンプレート」フィールドを使用できます。 </p> <p>広告クラウドのコンバージョントラッキングの場合、アカウント、キャンペーンまたは広告グループレベルでトラッキングテンプレートがある場合、値を入力する必要はありません。 </p> </td> 
  </tr> 
  <tr> 
