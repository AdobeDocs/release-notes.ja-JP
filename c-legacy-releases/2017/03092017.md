...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>「入札調整の自動最適化」オプションを使用すると、Advertising cloudは、ポートフォリオが最適化されたときに、ポートフォリオ内の広告グループの入札調整設定を自動的に変更し、パフォーマンスを最適化できます。 Advertising cloudは、Google、BingおよびYahoo！の入札調整を最適化できます。 日本のモバイルデバイスターゲット、Google と Bing のタブレットおよびコンピューターターゲット、Google の RLSA ターゲット、Google のロケーションターゲット向けに入札調整を最適化できます。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"></td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（最後の URL の Bing Merchant Center アカウント）Bing Shopping のテンプレートおよびバルクシート内の製品グループで、「トラッキングテンプレート」フィールドを使用できます。 </p> <p>Advertising cloudコンバージョントラッキングの場合、アカウント、キャンペーンまたは広告グループレベルでトラッキングテンプレートがある場合は、値を入力する必要はありません。 </p> </td> 
  </tr> 
  <tr> 
