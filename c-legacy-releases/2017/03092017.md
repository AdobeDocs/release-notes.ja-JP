...
<!-- <draft-comment> 
    ...
    <ul id="ul_09DF64207E7D4D02AEC7155165C0CF55"> 
     ...
     <li id="li_C40D9B53ADDF48469F508AD6DE961BBD">mboxMCSDIDの処理を、トラッキング呼び出しがおこなわれる正しいセクションの場所に移動しました。 （AN-138483） </li> 
...
* 特性およびフォルダーAPIメソッドをSwaggerに移行しました。 「[Audience ManagerAPIコードの移行](https://marketing.adobe.com/resources/help/en_US/aam/c_api_swagger.html)」を参照してください。 （AAM-28221 および AAM-27133）
...
<table id="table_B8FB3E741CFF4C3AA561C191182484ED"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>新しい<b>シグナル</b>アクティビティを使用して、別のワークフローからワークフローをトリガーします。 </p> <p>あるワークフローを別のワークフローから開始できる機能により、より複雑な顧客ジャーニーをサポートできるようになりました。 お客様のジャーニーをより良く監視し、問題が発生した場合に対応できます。 </p> <p>次のように、いくつかのワークフローアクティビティが更新されています。 </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>目標地点データは、MobileのAdobe AnalyticsとのAdobe Campaignを統合します。 ブランドは、ユーザーがブランドのアプリを開いたときに、ユーザーのモバイルの場所（<b>目標地点</b>）からデータを収集できます。 これにより、ブランドはAdobe Campaignのワークフローを活用して、ユーザーの場所に基づいてパーソナライズされたメッセージを送信できます。 このチャネルは、MobileコアサービスのSDKを利用します。 </p> <p> <a href="https://docs.campaign.adobe.com/doc/standard/en/ITG_Points_of_Interest_data_Introduction.html" format="html" scope="external"> 詳細情報... </a> </p> </td> 
  </tr> 
  <tr> 
