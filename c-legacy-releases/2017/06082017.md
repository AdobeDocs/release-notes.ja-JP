...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>これらの設定は、タンデムで使用されます。 iFrameと親ページに実装されたIDサービスコードの異なるインスタンス間で通信を行うことができます。 これらの設定は、自社が管理しているドメインの iFrame に ID サービスコードを読み込む場合の つの具体的な使用例（親ページまたはドメインを制御できる場合とできない場合）に関わる問題の解決に役立つように設計されています。これらは、VisitorAPI.jsコードバージョン2.2以降で使用できます。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>アドビのAnalyticsでは、次の3つの新しい製品SKUを導入しました。 </p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>レポートとAnalyticsのカレンダーに合わせたカレンダーの変更： </p> 
...
<table id="table_A51B298EEEB5482383505B8C5A79E1B9"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p>アドビAnalytics — 一般 </p> </td> 
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     <li id="li_CD2EE3675FD045A2B1A2BD960C0F7F2A">Targetのアクティビティに対して、おAd hoc analysisよびAnalysis Workspaceのレポートが正しくないデータを含む問題を修正しました。 （AN-141435） </li> 
     ...
     <li id="li_74750379709445DC97F22CC212C80E21">Admin Consoleで、レポートスイートのAd hoc analysisアクティブ化または非アクティブ化ができない問題を修正しました。 （AN-142529） </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> 指標の表示が設定されたが、指標の両極性が設定されていなかった問題を修正しました。 結果のAnalysis Workspaceの変更概要の色が期待どおりではありませんでした（負の場合は赤、正の場合は緑）。 （AN-143496、AN-143413） </li> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p> 2017 年 6 月 7 日にリリースされる AEM 6.2 SP1-CFP4 は重要なアップデートであり、2016 年 12 月の AEM 6.2 SP1 の一般リリース以降にリリースされた主なお客様向けの修正が含まれています。 </p> <p> 
     <ul id="ul_3968AE5D0CE04EC98CC5E212727F23DE"> 
      ...
      <li id="li_255BB17A0507445B890E52DC04DD0150"> <p> <a href="https://helpx.adobe.com/jp/aem-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM 6.2 Forms リリース </a> </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>（ベータ版の広告主のみ）新機能は次のとおりです。 </p> <p> 
     <ul id="ul_A658564B515E4D93A85629F44EC1CBEA"> 
      ...
      <li id="li_A583A0544E2C4146AF314BB3EC3C19FF">自動Target表示 </li> 
