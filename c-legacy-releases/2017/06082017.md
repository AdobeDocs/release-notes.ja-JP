...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>これらの設定は、タンデムで使用されます。 iFrameと親ページに実装されたIDサービスコードの異なるインスタンス間で通信を行うことができます。 これらの設定は、自社が管理しているドメインの iFrame に ID サービスコードを読み込む場合の つの具体的な使用例（親ページまたはドメインを制御できる場合とできない場合）に関わる問題の解決に役立つように設計されています。これらは、VisitorAPI.jsコードバージョン2.2以降で使用できます。 allowParentDomainおよびallowIframeDomainsを参照して <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?=mcvid-whitelistdomain.html" format="https" scope="external">くだ </a>さい。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_91D1FD20C4C1411292252364328677AF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Adobe Analyticsでは、3つの新しい製品SKUが導入されました。 </p> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>ディメンション項目の検索の改善 </p> </td> 
   <td colname="col2"> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p> <a href="https://marketing.adobe.com/resources/help/ja_JP/analytics/analysis-workspace/alert-manager.html" format="html" scope="external"> アラートマネージャー</a>機能の強化 </p> </td> 
   <td colname="col2"> 
    <ul id="ul_72464DC499744290BA37DB3B1E143F74"> 
     ...
     <li id="li_61B3A60A2AFB4BD0AA4D83803AB95B1E">有効/無効なアラートのフィルタを追加。 </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td colname="col01"></td> 
  ...
  <tr> 
   <td colname="col01"></td> 
   <td colname="col1"> <p>Microsoft Power BIとの統合 </p> </td> 
   <td colname="col2"> <p>Microsoft Power BIは、データを分析し、インサイトを共有するビジネス分析ダッシュボードのスイートです。 Power BIとAdobe Analyticsの統合により、Microsoft Power BI内でReport Builder Analyticsのデータを視覚化できます。 </p> <p>Power BIを使用すると、Adobe Analyticsを追加のデータソース（販売時点、CRMなど）と統合して、一意の顧客インサイト、関連性、オポチュニティを見つけ、組織全体で簡単に共有できます。 Report Builderのレポート生成機能とPower BIの機能を組み合わせると、組織内の誰もがWeb情報にアクセスしやすくなります。 </p> <p>Adobe Report Builderとの統合により、次のことが可能になります。 </p> 
    <ul id="ul_48CC72D3E88B4CCAB6762A32E68E5764"> 
     <li id="li_AC7B3FF2796442A8B7269BEB0824831C"> 予定されたReport BuilderワークブックをPower BIに公開します。 </li> 
     <li id="li_5F609B1158D849F7886EB789CA78488D">ワークブック内の書式化されたすべてのテーブルをPower BIデータセットテーブルとして発行します。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> 
    <ul id="ul_DAB0360A2EB74CE7B7D9D20D19C3F6AE"> 
     <li id="li_CD2EE3675FD045A2B1A2BD960C0F7F2A">Ad Hoc AnalysisとAnalysis Workspaceのレポートで、ターゲットアクティビティに対して誤ったデータが含まれる問題を修正しました。 （AN-141435） </li> 
     ...
     <li id="li_B64C547F580041AFBF081AFF40C58BCF">「Marketing Cloudオーディエンスにする」をオンにした場合に、セグメント作成エラーが発生する問題を修正しました。 （AN-142218、AN-143300） </li> 
     ...
     <li id="li_C06F93EF77314A8D9F04BF4077A996D1">管理コンソールで、ユーザーグループ名がアルファベット順にならない問題を修正しました。 （AN-142769、AN-142274） </li> 
     <li id="li_74750379709445DC97F22CC212C80E21">管理コンソールで、Ad Hoc Analysisがレポートスイート用にアクティブ化または非アクティブ化されない問題を修正しました。 （AN-142529） </li> 
     <li id="li_30836B5D43674E9095878F06BB779CC3">セグメントや計算指標などの大きなリスト（10,000以上）が表示されない問題を修正しました。 （AN-142562） </li> 
     <li id="li_A35A03057FAF418596A1977B629B52A1">影響を受ける11か国の2017年のISO地理特性の更新に関連するレポート参照データを更新しました。 bhr、civ、cze、fra、gbr、lux、mkd、mrt、omn、tjk、toです。 （AN-143396） </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_3CA7C4AA4AE843719A755ECE64EE91B6"> 
      ...
      <li id="li_1A05EC9B86AD4D9BA09340BB64729864"> 指標の表示が設定されたが、指標の両極性が設定されていなかった問題を修正しました。 Analysis Workspaceで生成される変更概要の色が期待どおりに色付けされませんでした（負の場合は赤、正の場合は緑）。 （AN-143496、AN-143413） </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7CC12EBCEBD943B1B329594D13DCF66C"> 
      ...
      <li id="li_A672990027F54771A41AFEABCFC8E243">ユーザーがMarketing Cloud経由でログインした場合に、「このレポートへのリンク」オプションが使用できない問題を修正しました。 （AN-118492） </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_7C375006CB8A4723B3FC07A8FF7FF6E6"> 
      ...
      <li id="li_BC279F05086144CE8BE0A9A60C5FE865">Marketing Cloud SSOログインを使用してReport Builderにログインできない問題を修正しました。 （AN-138557） </li> 
      <li id="li_310B2FCF1091411BA9983E8FC1BF8714">Report Builderインターフェイスに複数の言語が表示される問題を修正しました。 （AN-137183） </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_336B914674184FF9AC9602E0448FEFC0"> 
      <li id="li_6BB458583BE249189EDF2DC6480F75BA">ログイン後、Activity Mapが正しく読み込まれない問題を修正しました。 （AN-139709） </li> 
...
<table id="table_536113431FD540D18F1CD8FDBD06FDAC"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col2"> <p>AEM 6.3上の3D Assets 2.0 </p> </td> 
   <td colname="col3"> <p>2017 年 5 月 26 日にリリースされた、3D Assets on AEM 6.3 向けの機能パックです。 </p> <p>3Dファイル取り込み、DAM管理、2DレンダリングのAEM 3D機能を改善。 </p> <p> <a href="https://docs.adobe.com/content/docs/en/aem/6-3/release-notes/aem3d-release-notes.html" format="https" scope="external"> リリースノート </a>。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p> 2017 年 6 月 5 日にリリースされる AEM 6.1 SP2-CFP9 は重要なアップデートであり、2016 年 8 月の AEM 6.1 SP2 の一般リリース以降にリリースされた主なお客様向けの修正が含まれています。 </p> <p> 
     <ul id="ul_500BCBB0899D4F77B3D2A72F121F4A1B"> 
      ...
      <li id="li_08A790CB5D4740E4B522D59A70174204"> <a href="https://helpx.adobe.com/jp/em-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM 6.1 Forms リリース </a> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col3"> <p> 2017 年 6 月 7 日にリリースされる AEM 6.2 SP1-CFP4 は重要なアップデートであり、2016 年 12 月の AEM 6.2 SP1 の一般リリース以降にリリースされた主なお客様向けの修正が含まれています。 </p> <p> 
     <ul id="ul_3968AE5D0CE04EC98CC5E212727F23DE"> 
      ...
      <li id="li_255BB17A0507445B890E52DC04DD0150"> <p> <a href="https://helpx.adobe.com/jp/em-forms/kb/aem-forms-releases.html" format="https" scope="external"> AEM 6.2 Forms リリース </a> </p> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>IMMERSE17 オンデマンドセッションのチケットを提供しています。<a href="https://vts.inxpo.com/Launch/QReg.htm?ShowKey=35334" format="https" scope="external">こちらで</a>ご購入いただけます。その際、コード  
     <userinput>
       OD#1AEM 
     </userinput> コード。 </p> <p>次のセッションを利用できます。 </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col3"> <p>メイセッション： AEMプロジェクトでのLazybonesおよび編集可能なテンプレートの使用 </p> <p> Ankur AhlaatとScott Macdonaldに参加し、AEMプロジェクトでのLazybonesとEditableテンプレートの使用に関するディスカッションを参照してください。 </p> <p>このセッションを見直すことで、プロジェクト内でLazybonesと新しい編集可能なテンプレートを利用するAEMプロジェクトの構築方法を学ぶことができます。 収録日：2017 年 5 月 30 日、午前 08:00 PDT（<a href="https://bit.ly/ATACE517" format="http" scope="external">https://bit.ly/ATACE517</a>）。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_A41D8C79DEE84AE59FE9C8D2D291FCD7"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>独自の顧客関係管理(CRM)システムの電子メールリストを使用して、Google顧客一致オーディエンスの作成と更新をテストできるようになりました。 詳しくは、Advertising Cloudアカウントマネージャーにお問い合わせください。 </p> </td> 
  </tr> 
  <tr> 
