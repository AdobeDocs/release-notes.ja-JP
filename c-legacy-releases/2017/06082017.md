...
<table id="table_A2465769155C47F0A882D934C4B78511"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>これらの設定は、タンデムで使用されます。 iFrameと親ページに実装されたIDサービスコードの異なるインスタンス間で通信を行うことができます。 これらの設定は、自社が管理しているドメインの iFrame に ID サービスコードを読み込む場合の つの具体的な使用例（親ページまたはドメインを制御できる場合とできない場合）に関わる問題の解決に役立つように設計されています。これらは、VisitorAPI.jsコードバージョン2.2以降で使用できます。 <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?=mcvid-whitelistdomain.html" format="https" scope="external">whitelistParentDomain および whitelistIframeDomains</a> を参照してください。 </p> </td> 
  </tr> 
 </tbody> 
</table>
