...
| ガードレール、堅牢性および拡張性 | Campaign Classic に一連の機能強化が加えられました。Guardrail, robustness and scalability improvements are listed in [Campaign Classic Release Notes](https://docs.campaign.adobe.com/doc/AC/en/RN.html). |
