...
# Adobe Experience cloudリリースノート — 2019年6月
...
**[Cloud Manager Skill Builderウェビナーシリーズ](https://cloudmanagerskillbuilder.experienceleague.adobeevents.com/)**
...
[この月刊シリーズでは](https://cloudmanagerskillbuilder.experienceleague.adobeevents.com/)、アドビの製品チームから直接、Cloud Managerの機能を使用してAdobe Experience Managerの管理をクラウドでシンプル化する方法を学ぶことができます。
...
| 機能 | 説明 |
| ------------- | ----------- |
| コントロールパネル | ストレージの監視、IP アドレスのホワイトリスト登録、各インスタンス用の SSH キーのインストールにより、SFTP サーバーの設定を管理して、管理者ユーザーの作業効率を向上させます。コントロールパネルは、現在、AWS でホストされているお客様のみ使用できることに注意してください。[Experience cloudを使用してログインします](https://experiencecloud.adobe.com/campaign/controlpanel/)。 <br>詳しくは、[詳細なドキュメント](https://helpx.adobe.com/campaign/kb/control-panel.html)と[ハウツービデオ](https://helpx.adobe.com/campaign/kt/acc/using/acc-control-panel-video-use.html)を参照してください。 |
...
| ガードレール、堅牢性および拡張性 | Campaign Classic に一連の機能強化が加えられました。ガードレール、堅牢性、拡張性の改善については、『 [Campaign Classicリリースノート』を参照してください](https://docs.campaign.adobe.com/doc/AC/en/RN.html)。 |
...
| 互換性マトリックスの更新 | この新しいバージョンで、Adobe Campaign は次のデータベースシステムをサポートするようになりました。互換性マトリックスを [参照してください](https://helpx.adobe.com/campaign/kb/compatibility-matrix.html) <ul><li>Oracle 18c</li><li>MySQL 5.7（FDA）</li><li>SQL Server 2017</li><li>Teradata 16（FDA）</li><li>PostgreSQL 11</li></ul> |
