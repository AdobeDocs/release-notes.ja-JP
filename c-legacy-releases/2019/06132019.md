...
| ガードレール、堅牢性および拡張性 | Campaign Classic に一連の機能強化が加えられました。ガードレール、堅牢性および拡張性の強化は、[Campaign Classic リリースノート](https://docs.campaign.adobe.com/doc/AC/ja/RN.html)に記載されています。 |
...
[Target リリースノート（最新）](https://docs.adobe.com/content/help/ja-JP/target/using/release-notes/release-notes.html)
