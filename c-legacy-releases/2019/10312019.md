...
* [[!DNL Analytics]](#analytics)（**更新日：2019 年 12 月 19 日**）
...
| **[!UICONTROL IP ログイン制限の適用]** オプションのサポート終了 | 2019 年 10 月 31 日 | 2020年1月、**[!UICONTROL 管理者/会社設定/セキュリティ]**&#x200B;メニューのIP許可リスト（**[!UICONTROL IPログイン制限の実施]**）機能の提供終了日をお知らせします。 |
