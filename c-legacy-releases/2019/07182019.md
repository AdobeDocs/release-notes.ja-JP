...
* [[!DNL Analytics]](#analytics) - **（7月15日更新）**
...
AEM 6.5 clientlibs キャッシュの無効化に関する重要な AEM パッチは、[AEM 6.5.1.0 アップデート](https://helpx.adobe.com/jp/experience-manager/6-5/release-notes/sp-release-notes.html)またはこの[ナレッジベース記事](https://helpx.adobe.com/jp/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)を通じて入手できます。
...
* Adobe Campaign Classic [19.1.2](https://docs.campaign.adobe.com/doc/AC/en/RN.html) – ビルド 9029
