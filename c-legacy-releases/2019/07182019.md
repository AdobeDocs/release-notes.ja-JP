...
AEM 6.5 clientlibs キャッシュの無効化のための重要な AEM パッチは、[AEM 6.5.1.0 アップデート](https://helpx.adobe.com/jp/experience-manager/6-5/release-notes/sp-release-notes.html)またはこの [KB 記事](https://helpx.adobe.com/jp/experience-manager/kb/avoid-crx-quickstart-deletion-in-aem-6-5.html)の方法で利用できます。
