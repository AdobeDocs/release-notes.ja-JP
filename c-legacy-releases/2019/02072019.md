...
[Tableau](https://experiencecloud.adobe.com/resources/help/ja_JP/aam/c_comproc.html) の新バージョンへのアップグレードに伴い、重複レポートのデータビジュアライゼーション方法が変更されました。特性間重複レポートのスクリーンショットを参照してください。「[特性間重複レポート](https://experiencecloud.adobe.com/resources/help/ja_JP/aam/c_overlap_reports.html)」を参照してください。

**セグメント／特性間重複レポート**

Tableau の新バージョンへのアップグレードに伴い、重複レポートのデータビジュアライゼーション方法が変更されました。セグメント／特性間重複レポートのスクリーンショットを参照してください。「[セグメント／特性間重複レポート](https://experiencecloud.adobe.com/resources/help/ja_JP/aam/c_segment_trait_overlap.html)」を参照してください。

**セグメント間重複レポート**

Tableau の新バージョンへのアップグレードに伴い、重複レポートのデータビジュアライゼーション方法が変更されました。セグメント間重複レポートのスクリーンショットを参照してください。「[セグメント間重複レポート](https://experiencecloud.adobe.com/resources/help/ja_JP/aam/c_segment_segment_overlap.html)」を参照してください
...
* [リリースノート](https://helpx.adobe.com/jp/experience-manager/release-notes--aem-6-1-cumulative-fix-pack-.html)
* [AEM Forms CFP リリース](https://helpx.adobe.com/jp/aem-forms/kb/aem-forms-releases.html)

### セルフサービス

AEM 統合の問題のトラブルシューティングのヒントについては、[統合の問題のトラブルシューティング](https://helpx.adobe.com/jp/experience-manager/6-4/sites/administering/using/troubleshooting-integration-issues.html)を参照してください。
...
[Adverising Cloud コミュニティ](https://forums.adobe.com/jp/community/experience-cloud/advertising-cloud)
