...
| **Ad Hoc Analysis：** Java 11 との互換性 | Ad Hoc Analysis は、Java 11 をサポートするようになりました。Java 11で [Ad Hoc Analysisを実行する方法を説明します](https://marketing.adobe.com/resources/help/en_US/dsc/adhoc-java.html)。 |
