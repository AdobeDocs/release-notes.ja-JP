...
| **Ad Hoc Analysis：** Java 11 との互換性 | Ad Hoc Analysis は、Java 11 をサポートするようになりました。Learn how to run [Ad Hoc Analysis on Java 11](https://marketing.adobe.com/resources/help/en_US/dsc/adhoc-java.html). |
| **データ収集：** 新しい s_ecid cookie | Added a new [first-party server cookie](https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-analytics.html), s_ecid, in which data collection stores the visitor's ECID. |
...
* [!DNL Campaign Classic] 18.10.4-ビルド8983
* [!DNL Campaign Classic] 18.10.5-ビルド8984
