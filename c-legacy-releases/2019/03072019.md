...
製品ドキュメントについては、[Experience Cloud ID サービス](https://docs.adobe.com/content/help/en/id-service/using/home.html)を参照してください。
...
* Analytics の（移行後の）ユーザーの氏名が Experience Cloud 内でユーザーの Adobe ID にリンクされた名前と一致しないことがある問題を修正しました。Analytics名をExperience Cloudー内の名前に更新するには、**[!UICONTROL 管理者]**/**[!UICONTROL ユーザー管理（レガシー）]**/**[!UICONTROL ユーザーを編集]**&#x200B;に移動し、ユーザーIDをクリックします。 次に、「**[!UICONTROL Experience Cloud]**&#x200B;から更新」をクリックします。 （AN-172825）
...
| 機能 | 説明 |
| -----------| ---------- |  
| [特性レコメンデーション](https://experiencecloud.adobe.com/resources/help/en_US/aam/trait-recommendations.html) | [Adobe Sensei](https://www.adobe.com/jp/sensei.html)を動力とする特徴Recommendationsは、日々のAudience Managerワークフローにデータ科学を導入します。 <br/>Trait Recommendationsを使用すると、[セグメントビルダー](https://experiencecloud.adobe.com/resources/help/ja_JP/aam/t_create_segment.html)でセグメントをビルドまたは編集するときに、セグメントルールの Trait と類似した、追加が可能な Trait に関する推奨を受け取ることが可能になります。対象者を増やすために、推奨された Trait をセグメントに追加します。 |
...
* [特性の概要ページ](https://experiencecloud.adobe.com/resources/help/ja_JP/aam/c_tb_trait_summary.html)に特性タイプが表示されるようになりました。 （AAM-25784）
...
詳しくは、[Adobe Experience PlatformSDKの使用](https://helpx.adobe.com/jp/campaign/standard/administration/using/configuring-a-mobile-application.html#main-pars_header_49)を参照してください。
...
* **ファイル**&#x200B;の読み込みアクティビティを使用する場合、拒否されたレコードを含むファイルの名前にタイムスタンプを追加できるようになりました。 詳しくは、[詳細ドキュメント](https://helpx.adobe.com/jp/campaign/standard/automating/using/load-file.html#configuration)を参照してください。
* **アクティビティがデータを取得しない場合、** Queryと **** Segmentationactivitiesでアウトバウンドトランジションを有効にできるようになりました。
...
詳しくは、[AEM Assetsブランドポータルの新機能](https://helpx.adobe.com/jp/experience-manager/brand-portal/using/whats-new.html)および[リリースノート](https://helpx.adobe.com/jp/experience-manager/brand-portal/release-notes/brand-portal-release-notes.html)を参照してください。
...
コンテンツは同じですが、表示方法が改善されました。ドキュメントの提案を投稿する新しい機能が、よりエキサイティングになります。 プル要求を利用するか、またはすべてのページに設置された **[!UICONTROL Edit this page]** リンクおよび **[!UICONTROL Log an issue]** リンクをクリックして GitHub 上の Issue を登録できるようになりました。
...
最新の情報については、[Livefyreリリースノート](https://docs.adobe.com/content/help/en/livefyre/using/release-notes/c-rn.html)を参照してください。
