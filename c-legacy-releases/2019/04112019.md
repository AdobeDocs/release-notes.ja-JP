...
| Advertising Analyticsの更新 | Advertising Analyticsでの最新情報を2、3回リリースします。 <ul><li>Yahoo Geminiは3月31日にMicrosoft Bingによって吸収されました。 その結果、Yahoo Gemini 広告アカウントオプションは使用できなくなりました。 </li><li>Googleでは、新しい追跡パターンが実装され、 _追跡テンプレートを使用する代わりに_、 _最終URLサフィックスを使用するようになりました_。</li></ul> |
...
| 管理者/一般的なアカウント設定 | 2019 年 2 月 8 日 | <ul><li>The setting _Replace the last octet of IP addresses with 0_ is enabled by default for any new report suites created in the London Data Center after January 2019, but only if the settings for those report suites are copied from a template listed in the Admin Console. 他のレポートスイートから設定をコピーしたレポートスイートでは、すべての設定が、選択したレポートスイートから継承されます。</li> <li>The setting _IP Obfuscation_ is no longer enabled by default for all customers with a report suite set in EMEA. </li></ul> |
...
| 機能 | 説明 |
| -----------| ---------- |  
| [特性レコメンデーション](https://docs.adobe.com/content/help/ja-JP/audience-manager/user-guide/features/segments/trait-recommendations.html) | Trait Recommendations, powered by [Adobe Sensei](https://www.adobe.com/jp/sensei.html), brings data science into your Audience Manager day-to-day workflows. <br>Trait Recommendationsを使用すると、[セグメントビルダー](https://docs.adobe.com/content/help/ja-JP/audience-manager/user-guide/features/segments/segment-builder.html)でセグメントをビルドまたは編集するときに、セグメントルールの Trait と類似した、追加が可能な Trait に関する推奨を受け取ることが可能になります。対象者を増やすために、推奨された Trait をセグメントに追加します。 |
