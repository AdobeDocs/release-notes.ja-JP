...
| 管理者/一般的なアカウント設定 | 2019 年 2 月 8 日 | <ul><li>_IPアドレスの最後のオクテットを0_&#x200B;に置き換える設定は、2019年1月以降にロンドンデータセンターで作成された新しいレポートスイートに対してデフォルトで有効になりますが、Admin Consoleに一覧表示されたテンプレートからコピーされた場合にのみ有効です。 他のレポートスイートから設定をコピーしたレポートスイートでは、すべての設定が、選択したレポートスイートから継承されます。</li> <li>EMEAでレポートスイートを設定しているすべての顧客に対して、設定&#x200B;_IPの不明化_&#x200B;がデフォルトで有効にならなくなりました。 </li></ul> |
...
| 機能 | 説明 |
| -----------| ---------- |  
| [特性レコメンデーション](https://docs.adobe.com/content/help/ja-JP/audience-manager/user-guide/features/segments/trait-recommendations.html) | [Adobe Sensei](https://www.adobe.com/jp/sensei.html)を動力とする特徴Recommendationsは、日々のAudience Managerワークフローにデータ科学を導入します。 <br>Trait Recommendationsを使用すると、[セグメントビルダー](https://docs.adobe.com/content/help/ja-JP/audience-manager/user-guide/features/segments/segment-builder.html)でセグメントをビルドまたは編集するときに、セグメントルールの Trait と類似した、追加が可能な Trait に関する推奨を受け取ることが可能になります。対象者を増やすために、推奨された Trait をセグメントに追加します。 |
