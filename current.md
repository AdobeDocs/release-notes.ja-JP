...
## ![アイコン ](/assets/experience_platform_appicon_24.png){#platform}
...
## ![アイコン ](/assets/experience_platform_appicon_24.png){#journey-orch}
...
### [!UICONTROL Media Analytics ]{#media-aa}
...
## ![アイコン ](/assets/audience-manager.png){#aam}
...
「[パイプライン変数](https://docs.adobe.com/content/help/ja-JP/experience-manager-cloud-service/onboarding/getting-access/creating-aem-application-project.html#pipeline-variables)」を参照してください。
   ...
   * Javaコードでプログラムされたアウトバウンドトラフィック用の[静的な、専用の出力 IP アドレス](https://docs.adobe.com/content/help/en/experience-manager-cloud-service/implementing/developing/development-guidelines.html#dedicated-egress-ip-address)を割り当てることができます。これは、一部の統合で役立つ場合があります。
...
* **AEM Forms**
   ...
   * JEE環境でのAEM Formsの堅牢化中に、[信頼できる証明書を JVM に読み込みます](https://docs.adobe.com/content/help/ja-JP/experience-manager-65/forms/manage-administer-aem-forms/hardening-aem-forms-environment/hardening-aem-forms-jee-environment.html#configuring-ssl)。
...
## ![アイコン ](/assets/advertising-cloud.png){#adcloud}
...
### [!UICONTROL Advertising Cloud Search ]{#adcloud-search}
