...
| Campaign [!UICONTROL Audiences] | （3 月 13 日リリース）のベータ版機能 [!DNL Microsoft® Advertising] 対して適格なアカウント [!UICONTROL 顧客一致]) 電子メールアドレスを含む CSV ファイルをアップロードすることで、顧客一致オーディエンスを作成および管理できるようになりました。 データは、SHA-256 アルゴリズムを使用してハッシュ化する必要があります。 |
