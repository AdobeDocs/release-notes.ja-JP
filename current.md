...
* [!DNL Analytics](#analytics)（更新日 **2019 年 8 月 13 日**）
...
* [AppMeasurement](#appm)（**更新日 2019 年 8 月 13 日**）
...
[!UICONTROL AppMeasurement] 2.16.0 は、（以前お知らせした 8 月 8 日ではなく）2019 年 8 月 15 日にリリースされます。

| 機能 | 説明 |
| -----------| ---------- |
| `sendBeacon` が離脱リンクをサポート | [!UICONTROL AppMeasurement] による離脱リンク計測における `sendBeacon` サポートが実装されました。これにより、離脱リンクトラッキングの精度が向上し、トラフィックが増加することがあります。 |
