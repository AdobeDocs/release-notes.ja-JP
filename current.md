...
Experience Cloud中央インターフェイスコンポーネントには、セルフヘルプ、検索、およびユーザーアカウントの環境設定の更新が含まれています。 また、統合インターフェイスヘッダーからアクセスする、顧客属性やオーディエンスライブラリなどのクロスアプリケーション機能およびサービスに対する更新も含まれます。
