...
* **[コアコンポーネントベースのアダプティブフォームに関するレコードのドキュメントの生成](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/generate-document-of-record-core-components.html?lang=ja)** - コアコンポーネントを使用して作成されたアダプティブフォームの送信済みデータを含んだレコードのドキュメントを、アーカイブ用またはエンドユーザーの参照用に、印刷形式またはドキュメント形式で作成します。<!-- OLD. UPDATE FOR JUNE 7 -->
...
* 製品、機能およびユーザーインターフェイステストのサポートを、[実稼動以外のパイプラインテスト](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/cicd-pipelines/configuring-non-production-pipelines.html?lang=ja)に拡張しました。<!-- NEW. LEAVE IN FOR JUNE 7 -->
* アップストリームでのテストを有効にするだけでなく、[ユーザーインターフェイステストのサポートを Cypress テストにまで拡張しました](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/test-results/functional-testing/ui-testing.html?lang=ja)。<!-- NEW. LEAVE IN FOR JUNE 7 -->
* [セルフサービスのコンテンツコピー](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/content-copy.html?lang=ja)が、Cloud Manager ユーザーインターフェイスを介して上位環境から下位環境に至るまで利用できるようになりました。<!-- NEW. LEAVE IN FOR JUNE 7 -->
...
| 公開日 | 名前 | タイプ | 説明 | アプリケーション |
| -----------| ---------- | ---------- | ---------- |---------- |
| 2023年6月 | [墨消し：正しい方法](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/redaction.html?lang=ja) | ビデオ | この 60 秒のビデオチュートリアルでは、PDF から機密情報を削除する正しい方法を説明します。 | Acrobat Pro |
| 2023年6月 | [PDF のコメント用の共有](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/share-comment.html?lang=ja) | ビデオ | この 60 秒のビデオチュートリアルでは、PDF を共有して、複数のユーザーからのフィードバックを 1 つのファイルにすばやく収集する方法を説明します。 | Acrobat |
| 2023年6月 | [Teams での PDF ファイルの共有とコメント](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/share-comment-teams.html?lang=ja) | ビデオ | この 60 秒のビデオチュートリアルでは、Microsoft Teams で PDF ファイルの共同作業をリアルタイムで行う方法を説明します。 | Acrobat |
| 2023年6月 | [PDF 比較を使用した違いの検出](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/compare.html?lang=ja) | ビデオ | この 60 秒のビデオチュートリアルでは、Acrobat のファイル比較ツールを使用して 2 つの PDF ファイルの違いを見つける方法を説明します。 | Acrobat Pro |
| 2023年6月 | [概要を使用した PDF コメントのラングリング](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/summarize-comments.html?lang=ja) | ビデオ | この 60 秒のビデオチュートリアルでは、PDF ファイル内のすべてのコメントとマークアップの概要を作成する方法を説明します。 | Acrobat |
...
| 2023年6月 | [Microsoft Word からの PDF の作成](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/word-to-pdf.html?lang=ja) | ビデオ | この 60 秒のビデオチュートリアルでは、Microsoft Word から PDF を作成する方法を説明します。 | Acrobat |
...
| 2023年6月 | [Acrobat での PDF ファイルの作成](https://experienceleague.adobe.com/docs/document-cloud-learn/acrobat-learning/60-second/create-from-acrobat.html?lang=ja) | ビデオ | この 60 秒のビデオチュートリアルでは、Acrobat デスクトップアプリ内で [!DNL Microsoft 365] ファイルから PDF を作成する方法を説明します。 | Acrobat |
...
| 2023年6月 | [Acrobat Sign の認証方法](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/advanced-tasks/advanced-tasks-sending/authentication-methods.html?lang=ja) | ビデオ | ドキュメントに署名するユーザーの ID を認証するために Acrobat Sign で使用できる様々な方法について説明します。ID 認証を使用すると、不正の軽減に役立ち、署名されたドキュメントにさらにセキュリティレイヤーを追加することができます。 | |
| 2023年6月 | [ユーザーの追加](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/add-users-to-your-account.html?lang=ja) | ビデオ | Acrobat Sign のユーザーを追加および管理する方法を説明します。ユーザー管理は、Admin Console 内で行われます。 | Acrobat Sign |
| 2023年6月 | [ユーザー向けレポートオプション](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/report-options.html?lang=ja) | ビデオ | Acrobat Sign 管理者としてユーザー向けのレポートオプションをセットアップする方法を説明します。 | Acrobat Sign |
...
| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2023年6月 | [マルチサンドボックスイベント転送のデータ収集](https://experienceleague.adobe.com/docs/blueprints-learn/architecture/data-ingestion/multi-sandbox-event-forwarding.html?lang=ja) | ブループリントのチュートリアル | Experience Platform web SDK および Mobile SDK で収集されるデータを、1 つのイベントを収集するように設定し、複数の AEP サンドボックスに転送する方法を説明します。 |
