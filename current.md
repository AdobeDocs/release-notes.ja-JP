...
新しい [&#x200B; コース &#x200B;](https://experienceleague.adobe.com/en/courses) はExperience Leagueで利用できます。 構造化されたエキスパートが作成したラーニングが提供されるので、Adobeのソリューション全体で迅速にスキルを構築し、専門知識を検証し、自信を持って進めることができます。
