...
* [!DNL Campaign Standard] - **2月9日 | 午前 9:30 IST** - コミュニティコーヒーブレーク - _アドビ[!DNL Campaign]コミュニティ Q&amp;A コーヒーブレーク - APAC_ - [詳細と登録](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-standard/adobe-campaign-community-q-amp-a-coffee-break-february-9th-9/td-p/568425?profile.language=ja)

* [!DNL Workfront] - **2月9日 | 午前10:00 MT** - _顧客パネル - 時間の記録_ - [詳細と登録](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,PiX3iDTmREqs2eOICcUIoA,5KJVGb6S_Uiiki7ErNALgw,ApJEa7JdN0is2sG3HRpLDA,9brRsWkVcEahJAdD813wug,Xm1T4YtdIEGZaxxbANkVRg?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* [!DNL Workfront] - **2月13日 | 午前 8:00 CT** - _交流 - 戦略管理チャット_ - [詳細と登録](https://teams.microsoft.com/registration/Wht7-jR7h0OUrtLBeN7O4Q,mjTFCSLTbkuVKavNdopApA,dndSyq-qPkqd5A929WkXkw,pUN-580of0eD0xoEiD_42w,j4riN-CWZ0m8YXYgIFhwOA,uEEKLxmNL0KpzsOBUdFf1A?mode=read&amp;tenantId=fa7b1b5a-7b34-4387-94ae-d2c178decee1)

その他詳細なスケジュールについては、[Experience League イベント](https://experienceleague.adobe.com/events/?lang=ja)を参照してください。
...
>[!IMPORTANT]
>
>アドビでは、[!DNL Workfront] for Experience Manager 拡張コネクタの[最新バージョン 1.9.6 にアップグレード](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/integrations/update-workfront-enhanced-connector.html?lang=ja)することをお勧めします。
...
| 2023年2月 | [SvelteKit アプリのフィルタリング](https://experienceleague.adobe.com/landing/experience-manager/headless/developer/code/simple-sveltekit-app.html?lang=ja) | AEM ヘッドレス開発者ポータル | SvelteKit アプリを使用してデータをリストする AEM ヘッドレス GraphQL API 機能を調べます。 この SvelteKit アプリは、WKND アドベンチャーのリストを作成し、アドベンチャーの詳細を表示するために選択できます。 | AEM CS |
| 2023年2月 | [Express アプリのフィルタリング](https://experienceleague.adobe.com/landing/experience-manager/headless/developer/code/fitlering-express-pug-app.html?lang=ja) | AEM ヘッドレス開発者ポータル | Express および Pug アプリを使用してデータをフィルタリングする AEM ヘッドレス GraphQL API 機能を調べます。 このアプリでは、アクティビティタイプでフィルタリング可能な WKND アドベンチャーのリストを作成します。 | AEM CS |
