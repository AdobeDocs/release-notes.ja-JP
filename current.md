...
* **[!DNL Content Analytics]** | _Adobe Experience League ライブ：Content Analytics:AI インサイトを使用してパフォーマンスを最適化_ |Adobeの最先端 AI テクノロジーを活用した、Content Analyticsの変革の世界を掘り下げる、インサイトに満ちた 1 時間のライブストリームイベントにご参加ください。 このセッションでは、Content Analyticsでコンテンツのパフォーマンスを測定、理解、最適化する方法に革命を起こす方法を探索します。  | **5 月 28 日に再スケジュール済み** | [ 登録 ](https://engage.adobe.com/ExpLeagueLive-250522.html?sdid=NGWGR6CF&amp;mv=other)

* **[!DNL Workfront]** | _迅速に開始、スマートに拡張：Workfront プランニングでチームレベルの成功を実現_ | 企業全体に新しいプランニングソリューションをロールアウトするのは、実現できない大規模な作業のように感じる場合があります。これにはコストや時間がかかり、すぐに作業を完了したいチームのニーズを満たすのは困難です。このセッションでは、連邦型（一元型）と州型（分散型）の実装モデルを展開し、早期導入企業がどのように Workfront プランニングを活用し、社内全体の合意を待たずに迅速に価値を引き出しているかについて説明します。| **5月28日 水曜日（PT）** | [登録](https://events.teams.microsoft.com/event/2fa2a2f4-ada5-4810-9014-aa7fe34d0354@fa7b1b5a-7b34-4387-94ae-d2c178decee1)

* **[!DNL Workfront]** | _Workfront Data Connect の機能を活用_ | Workfront レポートを次のレベルに引き上げたいですか？本ウェビナーは Ultimate パッケージに含まれていますが、Select または Prime のお客様もアドオン（有料）としてご利用いただけます。この 1 時間のウェビナーでは、Workfront 製品管理チームと連携し、Data Connect とその機能のすべてをご紹介します。| **5月29日 木曜日（PT）** | [登録](https://events.teams.microsoft.com/event/5adb7454-e13d-408d-a430-eb3a69a08510@fa7b1b5a-7b34-4387-94ae-d2c178decee1)
...
* **新登場。** [Experience Cloud アプリケーションにおけるジェネレーティブ AI](https://experienceleague.adobe.com/en/docs/core-services/interface/features/generative-ai)
