...
| ----------- | ----------- | ---------- | ---------- | ---------- |
| Acrobat Sign | 2026年4月 | [契約書を設定して管理](https://experienceleague.adobe.com/ja/docs/document-cloud-learn/sign-learning-hub/admin-set-up/getting-started-admin/configure-modify-agreement){target="_blank"} | ビデオ | Acrobat Signで契約書を変更を設定および管理する方法について説明します。 送信後の変更を管理および監査可能なように、ポリシーを設定できます。 |
| Acrobat Sign | 2026年4月 | [&#x200B; チェックボックスグループで必要な選択をガイド &#x200B;](https://experienceleague.adobe.com/ja/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/checkbox-groups){target="_blank"} | ビデオ | Acrobat Sign フォームでチェックボックスグループを使用する方法について説明します。 署名者が必要なオプションルールを満たすように、選択の最小値と最大値を制御します。 |
| Acrobat Sign | 2026年4月 | [送信後にドキュメントを変更](https://experienceleague.adobe.com/ja/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-sending/modify-in-flight){target="_blank"} | ビデオ | トランザクションをキャンセルせずにAcrobat Signで送信された契約書を修正する方法を説明します。 ミスを修正し、署名と監査証跡を維持できます。 |
...
| AEM Sites Optimizer | 2026年4月 | [Sites Optimizer体験版](https://experienceleague.adobe.com/ja/docs/experience-manager-sites-optimizer/content/documentation/trial){target="_blank"} | ビデオ | 既存のAEM Sitesのお客様に対するAEM Sites Optimizer体験版について説明します。 体験版を有効にして、サイト最適化の機会を確認する方法を参照してください。 |
| AEM Sites Optimizer | 2026年4月 | [代替テキスト機会がありません](https://experienceleague.adobe.com/ja/docs/experience-manager-sites-optimizer/content/documentation/opportunities/missing-alt-text){target="_blank"} | ビデオ | ページエディターベースのAEM Sitesで欠落している画像alt テキストを検索する方法について説明します。 Sites Optimizerのレコメンデーションと修正機能を使用して、アクセシビリティとエンゲージメントを向上させます。 |
| AEM Sites Optimizer | 2026年4月 | [Core Web Vitalsの商談](https://experienceleague.adobe.com/ja/docs/experience-manager-sites-optimizer/content/documentation/opportunities/core-web-vitals){target="_blank"} | ビデオ | ページエディターベースのAEM SitesでCore Web Vitalsの問題を特定する方法について説明します。 Sites Optimizerのガイダンスを適用して、パフォーマンスを調整し、UX スコアを保護します。 |
| AEM Sites Optimizer | 2026年4月 | [&#x200B; バックリンクが壊れています](https://experienceleague.adobe.com/ja/docs/experience-manager-sites-optimizer/content/documentation/opportunities/broken-backlinks){target="_blank"} | ビデオ | ページエディターベースのAEM Sitesでバックリンクの破損を検出する方法について説明します。 インバウンドリンクの問題を解決して、SEO、トラフィック、訪問者のナビゲーションパスを保護します。 |
...
| Adobe Experience Manager | 2026年5月 | [AEM Agent Skillsの設定](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/ai/ai-assisted-development/setup/agent-skills){target="_blank"} | ビデオ | Experience ManagerでAIを活用した開発にAEM Agent Skillsを設定する方法を説明します。 前提条件、設定、およびチェックに従って、ワークフローを有効にします。 |
...
| Adobe Experience Manager | 2026年4月 | [AEM Agent Skillsの設定](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/ai/ai-assisted-development/setup/agent-skills){target="_blank"} | チュートリアル | AIを活用したローカル開発にAEM Agent Skillsを設定する方法を説明します。 コンポーネントを構築する前に、前提条件を完了し、スキルファイルを読み込み、エージェントを検証します。 |
| Adobe Experience Manager | 2026年4月 | [AIを活用した開発の概要](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/cloud-service/ai/ai-assisted-development/overview){target="_blank"} | 記事 | AI IDE、agents、AGENTS.md、Agent Skills、およびMCPを使用したAI支援AEM開発について説明します。 本番環境での利用に対応したコードをAEM as a Cloud Serviceに配信します。 |
...
| Adobe Journey Optimizer | 2026年4月 | Adobe Journey Optimizerでの[Web プッシュ &#x200B;](https://experienceleague.adobe.com/ja/docs/journey-optimizer-learn/ajo-web-push/introduction){target="_blank"} | チュートリアル | Adobe Journey Optimizerでweb プッシュを実装する方法について説明します。 通知が適切なオーディエンスに届くように、権限、サーフェス、ジャーニー、テストを設定します。 |
| Adobe Journey Optimizer | 2026年5月 | [&#x200B; オーケストレーションされたキャンペーンを作成](https://experienceleague.adobe.com/ja/docs/journey-optimizer-learn/tutorials/create-campaigns/orchestrated-campaigns/build-an-orchestrated-campaign){target="_blank"} | ビデオ | Adobe Journey Optimizerでオーケストレーションされたキャンペーンを構築する方法を説明します。 オーディエンス、データ準備、マルチチャネル配信を、単一のガイド付きワークフローに統合しましょう。 |
...
| Adobe Real-Time CDP Collaboration | 2026年5月 | [Real-Time CDP Collaboration製品内の招待状](https://experienceleague.adobe.com/ja/docs/platform-learn/tutorials/collaboration/rtcdp-collaboration-in-product-invitations){target="_blank"} | ビデオ | Real-Time CDP Collaborationでの製品内招待状の仕組みについて説明します。 製品内のパートナーを招待し、コンテキストを安全に共有し、オンボーディングにかかる時間を短縮できます。 |
...
| Adobe Workfront | 2026年4月 | [&#x200B; ベースライン、スナップショット、自動レポートを使用したマスタープロジェクトのトラッキング &#x200B;](https://experienceleague.adobe.com/ja/docs/workfront-learn/tutorials-workfront/manage-work/intermediate-projects/baselines-snapshots-and-automated-reports){target="_blank"} | ビデオ | リアルタイムビューに留まらない、Workfrontの過去のトラッキングについて説明します。 ベースライン、スナップショット、自動化されたタスクレポートメールを使用して、時間の経過に伴う作業を比較します。 |
| Adobe Workfront | 2026年5月 | [担当業務とレートカードの作成](https://experienceleague.adobe.com/ja/docs/workfront-learn/tutorials-workfront/administration-and-setup/project-finances/create-job-roles-and-rate-cards){target="_blank"} | ビデオ | Workfrontで担当業務とレートカードを作成する方法について説明します。 プロジェクトのレートカードを添付、更新、削除することで、適切な請求ルールを反映できます。 |
