...
>[!TIP]
>
>このページの更新に関するメール通知を受け取るには、[優先製品更新](https://www.adobe.com/jp/subscription/priority-product-update.html)を購読します。
...
* _Experience Cloud_&#x200B;は&#x200B;_CX Enterprise_&#x200B;です。 今後数週間にわたってこの更新をおこなう際に、_Experience Cloud_&#x200B;に関する言及がドキュメントに表示される場合があります。

新機能：

* [リリースノートのリンク – すべてのアプリケーション](#application-release-notes)
...
## リリースノート – すべてのアプリケーション {#application-release-notes}

この表を使用して、CX Enterprise アプリケーションのリリースノートを1か所で検索します。 各行には、アプリケーション、最新のリリース日、その製品の公式リリースノートへのリンク（Experience Leagueまたは製品独自のドキュメント）、および現在のリリースのハイライトが一覧表示されます。
