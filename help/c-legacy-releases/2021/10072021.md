...
| Experience Cloud [!UICONTROL Triggers]によるナビゲーション | [Experience Cloud Triggers](https://experienceleague.adobe.com/docs/core-services/interface/triggers.html?lang=ja)は、プロビジョニングされたユーザーのヘッダーにあるアプリケーション切り替えボタンから直接ナビゲーションできます。 |
...
| 2021年10月 | [[!UICONTROL コンテンツトランスファーツール]](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/migration/moving-to-aem-as-a-cloud-service/content-migration/content-transfer-tool.html?lang=ja) | ビデオ | [!UICONTROL コンテンツトランスファーツール]を使用して、AEM 6.3 以降から AEM as a Cloud Service へコンテンツを移行する方法を説明します。 |
...
| 2021年10月 | [&#x200B; デジタル署名とは](https://experienceleague.adobe.com/docs/document-cloud-learn/sign-learning-hub/getting-started/getting-started-signing/sign-with-a-digital-signature.html?lang=ja) | ビデオ | 世界中の最も厳格な法的規制に準拠し、署名者のIDに対する最高レベルの保証を提供する、証明書ベースの電子署名について説明します。 |
...
| 2021年10月 | [イベントの作成](https://experienceleague.adobe.com/docs/journey-optimizer-learn/tutorials/journey-configuration/create-events.html?lang=ja) | チュートリアル | イベントの設定方法と、ストリーミングエンドポイントとイベントのペイロードの指定方法について説明します。 |
