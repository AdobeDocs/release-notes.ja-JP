...
* **[!UICONTROL すべての節を展開]**：任意の Experience League ガイドの目次全体を表示します。 （この切替スイッチは、ページの読み込み後にオフになります。 この問題は、今後の更新で修正される予定です）。 **[!UICONTROL さらに表示]** および **[!UICONTROL さらに表示]** オプションが削除されました。
...
| リリース日 | 機能 | 説明 |
| -----------| -----------| ---------- |
| 2年10月 | カスタマイズ可能なホーム | Experience Cloudのランディングページで、「**[!UICONTROL 編集]** をクリックします。[!UICONTROL 編集 &#x200B;] モードを使用すると、ウィジェットライブラリとカスタム背景にアクセスして、Experience Cloudのホームページをパーソナライズできます。[!UICONTROL 編集モードでは &#x200B;] ウィジェットの移動、サイズ変更および管理をシームレスで直感的に行えます。 この機能には、一括アクションとレイアウト調整が含まれ、より美しくカスタマイズされたエクスペリエンスを提供します。 ウィジェットライブラリとカスタム背景にアクセスして、Experience Cloud ホームページをカスタマイズします。 |
