...
* [2024年1月30日](https://experienceleague.adobe.com/ja/docs/release-notes/experience-cloud/previous/2024/02142024#status)
...
| 2024年6月 | [[!DNL AEMaaCS]：管理者権限を使用してプレビュー層のリポジトリブラウザーにアクセスする方法](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-24457) | 新しい記事 | デフォルトではプレビュー層のリポジトリブラウザーは表示されないため、カスタムワークフローを使用してすべてのノードを表示する方法を説明します（例えば、`/conf`、`/home`、`/var`の下のノードは表示されません）。 すべてのノード。 |
