...
| 2024年9月 | AEM Assets | [Dynamic Media でのビデオのクローズドキャプション](https://experienceleague.adobe.com/ja/docs/experience-manager-learn/assets/advanced/video-closed-captions) | ビデオ | Dynamic Media でのクローズドキャプションについて説明します。 クローズドキャプションは、Dynamic Media でビデオファイルを AEM Assets にアップロードすると自動生成されます。 |
...
| 公開日 | 名前 | タイプ | 説明 |
|---------|--------|---------|---------|
| 2024年8月 | [[!UICONTROL &#x200B; コンテンツフラグメント]の CF 参照が、言語コピーに基づいて調整されない](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-24819) | 新しい記事 | [!UICONTROL コンテンツフラグメント]の参照が、[!DNL AEM] の[!UICONTROL 言語コピー]に基づいて更新されない場合の問題を解決する方法を説明します。 |
| 2024年8月 | [[!DNL Akamai]  [!DNL API] 経由でのキャッシュのクリア](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-24795) | 新しい記事 | [!DNL Akamai] の親アセットのすべての子キャッシュをクリアしながら、[!DNL Dynamic Media Classic] で [!DNL CDN] の無効化をプログラムで同期する方法を説明します。 |
| 2024年8月 | [[!DNL PDF] ファイルが自動的に公開されない](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-24689) | 新しい記事 | [!DNL Adobe Experience Manager as a Cloud Service (AEMaaCS)] で、[!DNL PDFs] がサムネール付きで自動的に公開されない問題を解決する方法について説明します。 |
| 2024年8月 | [&#x200B; [!DNL Apache Jackrabbit Oak] のバージョンの確認方法](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-24785) | 新しい記事 | [!DNL AEM] で使用される [!DNL Apache Jackrabbit Oak] のバージョンを識別する方法について説明します。 |
...
| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2024年9月 | [New Relic のアラート通知設定](https://experienceleague.adobe.com/ja/docs/commerce-learn/tutorials/tools/new-relic/new-relic-alert-notification-setup) | ビデオ | New Relic でアラート、ポリシー、ワークフロー、宛先を検索する方法について説明します。 既存のポリシーにメールを追加する作業がいかに簡単かをご覧ください。 |
...
| 2024年8月 | [[!DNL Live Search] ファセットがアルファベット順に並べ替えられない](https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/live-search-facets-not-sorted) | 新しい記事 | [!DNL Live Search] ファセットがアルファベット順に並べ替えられない場合の回避策について説明します。 |
...
| 2024年8月 | [&#x200B; [!DNL Commerce Data Exporter]  フィードでデータが更新されず、変更ログテーブルが存在しない  [!DNL cron]  ログエラーを修正しました](https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mdee-table-does-not-exist) | 新しい記事 | [!DNL Data Exporter] [[!DNL Mview]](https://developer.adobe.com/commerce/php/development/components/indexing/#mview) サブスクリプションで間違ったビュー ID を使用することで発生する、データ同期の問題を修正するための解決策について説明します。 |
...
| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2024年9月 | [アトリビューション AI の概要](https://experienceleague.adobe.com/ja/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/attribution-ai-overview) | ビデオ | アドビのアトリビューション AI が、高度な AI/ML モデリングを使用して B2B マーケティング測定を強化し、正確なアトリビューションに関するインサイトを提供し、正確な分析のためにバイアスを排除する方法を説明します。 |
| 2024年9月 | [Marketo Measure Ultimate 概要](https://experienceleague.adobe.com/ja/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview) | ビデオ | Marketo Measure Ultimate を使用し、B2B マーケターが同じ種類の複数のソースを含むほぼすべてのソースからデータを収集して、徹底したアトリビューションを行う方法について説明します。 |
