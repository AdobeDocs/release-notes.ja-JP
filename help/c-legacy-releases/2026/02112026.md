...
| 公開日 | 名前 | タイプ | 説明 |
|---------|----|----|-----------|
| 2026年1月 | [ 有効期限のない資格情報に関するCustomer Journey Analytics BI 拡張機能の接続の問題 ](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-29891) | 新しい記事 | BI ツールを操作するために、Adobe Experience Platform の有効期限が切れていない資格情報に適切な Customer Journey Analytics へのアクセス権およびデータビュー権限を付与する必要がある場合の問題の解決策について説明します。 |
...
| 2026年1月 | [Adobe Experience Manager：エクスペリエンスフラグメント（XF）のコピー＆ペースト操作が失敗し、エラーポップアップが表示される](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-29837) | 新しい記事 | エクスペリエンスフラグメント（XF）をコピー＆ペーストした際にエラーポップアップが表示され、XF がペーストされない場合の問題の解決策について説明します。 |
...
| 2026年1月 | [Adobe Commerce の高度なレポートのトラブルシューティング](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-29603) | 新しい記事 | Adobe Commerce での高度なレポートの問題の診断と解決について説明します。 |
...
| 2026年1月 | [Adobe Commerce で画像の最適化を有効にする際にエラーが発生する](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-29890) | 新しい記事 | [!DNL Fastly] の画像の最適化（[!DNL Fastly] IO）がデフォルトで無効になっており、画像の最適化を有効にするには [!DNL Fastly] に問い合わせるよう通知される場合の問題の解決策について説明します。 |
| 2026年1月 | [ クラウドインフラストラクチャー上のAdobe Commerceにおける `var/export` フォルダー権限の問題 ](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-29895) | 新しい記事 | `var/export/email` フォルダー内のサーバー上のファイル権限の問題により製品データを書き出せない場合の問題の解決策について説明します。 |
