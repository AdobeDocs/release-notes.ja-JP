...
| 2026年1月 | AEP[&#128279;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29745)でソースフロー実行のFalse遅延アラート | 新しい記事 | データフローの実行が正常に終了しても、ソースフローの実行の遅延に関するアラートが表示される問題の解決策について説明します。これは、アラートシステムの監視信号がAdobe Experience Platformの実際の実行指標と必ずしも一致しないためです。 |
...
| 2026年1月 | AEP[&#128279;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-29774)で [!DNL LiveRamp] にセグメントを書き出すと認証エラーが発生する | 新しい記事 | 実稼動用サンドボックスから[!DNL LiveRamp] オンボーディング先へのセグメントの書き出し中に認証エラーが発生した場合の問題の解決策について説明します。Adobe Experience Platformで。 |
