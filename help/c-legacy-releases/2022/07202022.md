...
| 2022年7月 | [Adobe Campaign Standard の効果的なヒントとテクニック](https://experienceleague.adobe.com/docs/skill-builder-events/skill-builder/customer-journeys/2022/tips-and-tricks.html?lang=ja) | ビデオ | Adobe Campaign Standard インスタンスに接続し、ターゲティング、パーソナライゼーション、マーケティング疲労に関するベストプラクティスを見つけて、ACS をより良く活用します。 | Campaign Standard |
