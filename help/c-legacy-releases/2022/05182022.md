...
| 機能 | 説明 |
| ------- | ----------- |
| [!UICONTROL キャンペーン] | すべての広告主は、以下の Beta 機能を使用できます。<ul><li>（[!DNL Microsoft® Advertising] アカウント）[!DNL Microsoft® Audience Network]（[!DNL Microsoft® Audience Ads] を含む）上の既存のネイティブ広告キャンペーンの同期、読み取り専用表示およびレポート（ビュースルーデータを含む）のサポート。</li><li>（[!DNL Google Ads] および [!DNL Microsoft® Advertising] アカウント） [!DNL Google Ads] キャンペーンとキャンペーン構造を [!UICONTROL  検索 ]/[!UICONTROL  ツール ]/[!UICONTROL  キャンペーンをインポート Beta] から [!DNL Microsoft® Advertising] にインポートする機能 <br><br> キャンペーンをインポートすると、インポートジョブのステータスの確認、エラーログの確認、インポートスケジュールの編集、一時停止、削除ができます。</li></ul> |
