...
* **Adobe Experience Manager as a Cloud Service**
  ...
  2022.5.0（2022年5月）リリースで追加された機能の概要については、[2022年5月リリースの概要ビデオ](https://video.tv.adobe.com/v/3453434/?captions=jpn&quality=12)をご覧ください。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* **Experience Manager Assets as a Cloud Service**
  ...
  * Experience Manager Assetsでは、Adobe AI機能を使用して、画像内のカラーを[識別し、取り込み時にタグとして差分を自動的に適用するようになりました](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/color-tag-images.html?lang=ja)。 このタグを使用すると、画像の色構成に基づいて、検索エクスペリエンスを強化できます。 画像にタグ付けされる色の数を 1 ～ 40 の範囲で設定し、後でそれらの色に基づいて画像を検索できます。
