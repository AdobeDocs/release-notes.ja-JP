...
* **Experience Manager Assets as a Cloud Service**
  ...
  * Experience Manager Assetsでは、Adobe AI機能を使用して、画像内のカラーを[識別し、取り込み時にタグとして差分を自動的に適用するようになりました](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/color-tag-images.html)。 このタグを使用すると、画像の色構成に基づいて、検索エクスペリエンスを強化できます。 画像にタグ付けされる色の数を 1 ～ 40 の範囲で設定し、後でそれらの色に基づいて画像を検索できます。
...
* GEM ウェビナー - _検証：Cloud Manager 2022_
  * 2022年6月15日（水）
  * 08:00太平洋標準時；17:00中央ヨーロッパ時間；20:30 インド標準時
