...
| 2022年1月 | [Adobe Analytics でのセグメント管理と共有](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/components/segmentation/segment-management-and-sharing.html?lang=ja) | 更新されたビデオ | アップデートされたこのビデオでは、セグメントの共有と管理に関するヒントをいくつか紹介します。 |
