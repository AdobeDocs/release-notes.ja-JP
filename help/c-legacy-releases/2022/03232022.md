...
| 2022年3月 | [Analysis Workspace でのプロジェクトへの直接リンク](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/analysis-workspace/curate-and-share-projects/direct-link-to-a-project.html) | ビデオ | 同僚を Analysis Workspace プロジェクトに直接誘導する短縮リンクを作成して、分析をより適切に民主化する方法を説明します。 |
...
* **Experience Manager 6.5、サービスパック 12 （6.5.12.0）**
  ...
  Adobe Experience Manager 6.5.12.0には、2019年4月に6.5 リリースがリリースされて以降にリリースされた新機能、お客様が要求した主な機能強化、パフォーマンス、安定性、セキュリティの機能強化が含まれています。 サービスパックは Adobe Experience Manager 6.5 にインストールされています。
...
* **Adobe Experience Manager as a Cloud Service**
   ...
   * **Cloud Manager**
     ...
     Experience Manager as a Cloud Service 2022.01.0 の Cloud Manager のリリース日は 2022年1月20日（PT）です。
次回のリリースは 2022年3月31日（PT）の予定です。
...
* **Experience Manager GEMS ウェビナー：_Experience Manager ヘッドレスと App Builder を使用して、より迅速にサイトを作成_**
   ...
   * Experience Manager GEM | ウェビナー | 2022年3月23日水曜日（PT）
      ...
      * [登録](https://adobe.ly/3oCkEsh)
      * [Q&amp;A用](https://adobe.ly/3LkSWdm)
...
| [!UICONTROL ポートフォリオ] <br> [!UICONTROL キャンペーン] | （3月12日リリース、[!DNL Microsoft® Advertising] キャンペーン用ベータ版機能）- [!UICONTROL コンバージョンを最大化]入札戦略を使用するように検索キャンペーンを設定し、オプションでクリック単価の最大値を設定できるようになりました。<br> 他の自動入札戦略用のハイブリッド最適化（ベータ）に既に参加している場合は、[!UICONTROL コンバージョンを最大化]戦略に自動的にアクセスでき、[!UICONTROL コンバージョンを最大化]戦略を使用したキャンペーンをハイブリッドポートフォリオに含めることができます。 この戦略をハイブリッドポートフォリオで使用するには、Advertising Cloud Search の目標を [!DNL Microsoft® Ads] にアップロードできるようにする必要があります。 ベータ版にまだ参加しておらず、参加を希望する場合は、[!DNL Adobe] アカウントマネージャーにお問い合わせください。 |
| Campaign [!UICONTROL オーディエンス]<br><br>Campaign [!UICONTROL バルクシート] | （3月12日リリース、[!DNL Microsoft® Advertising] キャンペーン）- マーケット内のオーディエンスを除くすべての [!DNL Microsoft® Advertising] オーディエンスを、キャンペーンレベルのターゲットまたは[!UICONTROL 広告グループ]レベルのターゲットとして使用できるようになりました。 以前は、[!UICONTROL 広告グループ]レベルのターゲットとしてのみ使用できました。 |
| Campaign [!UICONTROL オーディエンス] | （3月12日リリース、[!UICONTROL カスタマーマッチ]の対象となる [!DNL Microsoft® Advertising] アカウント用ベータ版機能）メールアドレスを含む CSV ファイルをアップロードすることで、カスタマーマッチオーディエンスを作成および管理できるようになりました。 データは、SHA-256 アルゴリズムを使用してハッシュ化する必要があります。 |
