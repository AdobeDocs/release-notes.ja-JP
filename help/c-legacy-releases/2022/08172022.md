...
2022.7.0（2022年7月）リリースで追加された機能の概要については、[2022年7月リリースの概要ビデオ](https://video.tv.adobe.com/v/3454197/?captions=jpn&quality=12)をご覧ください。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
* `mod_macro` がExperience Manager as a Cloud Serviceで使用できるようになりました。[サポートされている Apache モジュ &#x200B;](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/content-delivery/disp-overview.html?lang=ja) ルのリストについては、この表を参照してください。
...
| 2022年8月 | [AEM ヘッドレスチュートリアル](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html?lang=ja) | 更新された記事 | AEM ヘッドレス SDKのチュートリアルが更新されて、永続クエリと WKND 2.0 を使用するようになりました。 実践チュートリアルを使用して、様々なオプションの使用方法を検討し、適切なオプションを選択してください。 | AEM as a Cloud Service |
...
* [Campaign コントロールパネル 7 月リリース](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=ja)
