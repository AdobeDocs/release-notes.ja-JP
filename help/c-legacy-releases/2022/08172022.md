...
2022.7.0（2022年7月）リリースで追加された機能の概要については、[2022年7月リリースの概要ビデオ](https://video.tv.adobe.com/v/3452350/?captions=jpn&quality=12)をご覧ください。<!-- Beginning with the video this month, Adobe has enabled localized closed captioning in French (FR), German (DE) and Japanese (JP). -->
...
| 2022年8月 | [AEM ヘッドレスチュートリアル](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/overview.html?lang=ja) | 更新された記事 | AEM ヘッドレス SDK チュートリアルが更新され、永続クエリとWKND 2.0を使用できるようになりました。 実践チュートリアルを使用して、様々なオプションの使用方法を調べ、自分に適したものを選択してください。 | AEM as a Cloud Service |
...
* [Campaign コントロールパネル7月リリース](https://experienceleague.adobe.com/docs/control-panel/using/release-notes/release-notes.html?lang=ja)
