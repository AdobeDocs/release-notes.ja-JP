...
サポートが必要な場合は、 [[!DNL Experience League]](https://experienceleague.adobe.com/?lang=ja#home) にアクセスして、アドビ監修のコース、技術ドキュメント、クイックアンサー、コミュニティインサイト、講師によるトレーニングなどをお探しください。
...
| [!UICONTROL ワークスペース]の[!UICONTROL クイックインサイト]パネル | 2020 年 6 月 26 日 | [!UICONTROL &#x200B; クイックインサイト &#x200B;] は、[!UICONTROL Analysis Workspace] のアナリスト以外のユーザーや新規ユーザーに対して、ビジネス上の質問にすばやく簡単に回答する方法を学ぶためのガイダンスを提供します。[詳細情報 &#x200B;](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/quickinsight.html) |
...
| アクセシビリティの強化 | 2020年5月21日（PT） | Adobe Analytics チームは、Analysis Workspaceのアクセシビリティにいくつかの改善を加えました。例えば、キーボードナビゲーション、カラーコントラスト、スクリーンリーダーのサポートの向上です。[詳細情報…](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/workspace-faq/aw-accessibility.html) |
...
| **[!UICONTROL コンバージョンレベル]**&#x200B;設定のサポート終了 | 2020 年 3 月 4 日 | **[!UICONTROL 管理ツール]**／**[!UICONTROL レポートスイート]**／**[!UICONTROL 一般的なアカウント設定]**&#x200B;で、機能しない[コンバージョンレベル](https://experienceleague.adobe.com/docs/analytics/admin/admin-tools/general-acct-settings-admin.html)設定は、2020 年 3 月 13 日にユーザーインターフェイスから削除されます。 |
...
| [AEM Assets 使用の手引き](https://video.tv.adobe.com/v/33624) | ビジネスユーザー向けに AEM Assets の概要を紹介するビデオです。 |
