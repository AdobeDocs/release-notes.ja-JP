...
| -----------| ------------ | ---------- |
| [!UICONTROL ワークスペース] の [!UICONTROL Analytics for Target] パネル | 2020 年 6 月 26 日 | [!UICONTROL Analytics for Target] （A4T） パネルを使用すると、[!UICONTROL Analysis WorkspaceでAdobe Target アクティビティとエクスペリエンスを分析できます。] [詳細情報...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/a4t-panel.html?lang=ja) |
| [!UICONTROL ワークスペース]の[!UICONTROL クイックインサイト]パネル | 2020 年 6 月 26 日 | [!UICONTROL クイックインサイト]は、[!UICONTROL Analysis Workspace] のアナリスト以外のユーザーと新規ユーザーに対して、ビジネスの質問にすばやく簡単に答える方法を学ぶためのガイダンスを提供します。 [詳細情報](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/panels/quickinsight.html) |
...
| アクセシビリティの強化 | 2020年5月21日（PT） | Adobe Analytics チームでは、キーボードナビゲーション、カラーコントラスト、スクリーンリーダーのサポートの強化など、Analysis Workspace に関していくつかのアクセシビリティの改善をおこないました。 [詳細情報...](https://experienceleague.adobe.com/docs/analytics/analyze/analysis-workspace/workspace-faq/aw-accessibility.html) |
...
| 通知 | 追加日または更新日 | 説明 |
| -----------| ---------- | ---------- |
| 統合製品ドメインへの移行 | 発効日：2020 年 5 月 29 日 | Adobe Analytics の統合製品ドメインへの移行は 2020 年 1 月に開始され、2020 年 5 月 29 日に完了しました。 Adobe Analyticsは、アーキテクチャからすべての`omniture.com` ドメイン参照を削除するために動作しますが、`omniture.com`をサードパーティ Cookieとして許可することが重要です。 アーキテクチャの完全な移行が（間もなく）完了したら、リリースノートでお知らせいたします。以後、この許可リストの手順は不要になります。 [ここでは](https://helpx.adobe.com/jp/analytics/kb/adobe-ip-addresses.html)は、許可する必要がある推奨IP アドレスとドメインの完全なリストです。<br>組織がサードパーティ Cookie をブロックしている場合は、カスタマーケアに連絡して、Adobe Analytics へのアクセスを再取得してください。 |
...
| TLS 1.1 のサポート終了 | 2019年10月3日（PT） | 2020年3月31日までに、Adobe AnalyticsはTLS 1.1のサポートを終了します。 この変更は、最高のセキュリティ基準を維持し、顧客データの安全性を促進するための継続的な取り組みの一部です。 |
