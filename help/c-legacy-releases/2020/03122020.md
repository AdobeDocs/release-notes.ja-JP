...
第 1 四半期のリリースが公開されました。 [詳細情報](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=ja)
...
* Adobe Analyticsに送信された内部[!UICONTROL Analytics-for-Target] ヒットで、[!DNL Target] - [!DNL Target] Session IDがコンテキストデータパラメーター「a.target.sessionId」として追加されるようになりました。
...
* 新しいシェルのロールアウトにより、Experience Cloud組織の切り替えに関するいくつかのユーザーの問題が修正されました。（AN-200844、AN-186920）
...
* 分類ディメンション レポートで「未指定」に適用すると、エントリまたは終了の指標が正しくカウントされないことがある問題を修正しました。
...
| **[!UICONTROL ダッシュボードアーカイブ]**&#x200B;のサービス終了 | 2020 年 3 月 28 日 | [!UICONTROL Reports &amp; Analytics]の&#x200B;**[!UICONTROL ダッシュボードを管理]**&#x200B;の下にある&#x200B;**[!UICONTROL アーカイブを表示]**&#x200B;設定は、2020年10月をもって使用できなくなります。 |
...
JavaScriptのリリースノート [&#128279;](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ja)については、AppMeasurementを参照してください。 バージョン 2.20.0 は 2020年3月5日（PT）にリリースされました。
...
* **AEM6.5.4.0**
AEM 6.5 サービスパック 4.0 （2020年3月5日にリリースされた6.5.4.0）は、2019年4月にAEM 6.5が一般公開されて以降にリリースされた新機能、主なお客様の機能強化、パフォーマンスの向上、安定性、およびセキュリティを含む重要なアップデートです。
   * [Adobe Experience Manager 6.5 Service Pack 4の新機能](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html)
...
* **AEM6.4.8.0**
  ...
  AEM 6.4 サービスパック 8.0 （2020年3月5日にリリースされた6.4.8.0）は、2018年4月のAEM 6.4の一般提供開始以降にリリースされた主要なお客様の修正を含む重要なアップデートです。
...
* **AEM6.3.3.8**
  ...
  AEM 6.3、サービスパック 3、累積修正パック 8 （2019年3月5日にリリースされた6.3.3.8）は、2017年4月のAEM 6.3の一般提供開始以降にリリースされた主要なユーザー修正を含む重要なアップデートです。
...
* **AEM Assets Brand Portal**
  ...
  AEM Assets Brand Portal 6.4 サービスパック 6 （2020年3月5日（PT）リリース 6.4.6）は、[!UICONTROL Brand PortalでAEM Assetsを設定する方法を変更します。] また、このリリースには、その他の機能強化とバグ修正が含まれています。
...
[Brand Portalを使用したAEM Assetsの設定](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/publish/configure-aem-assets-with-brand-portal.html)を参照してください。
...
| [!DNL Adobe Campaign] - オーディエンスの宛先 | ビデオ - [オーディエンスの作成...](https://experienceleague.adobe.com/docs/campaign-standard-learn/tutorials/profiles-and-audiences/audience-destinations/creating-audiences-using-segment-builder.html) | Adobe [!UICONTROL Experience Platform セグメントビルダー]を使用して、Campaign Standard にオーディエンスを作成します。 この機能には、Adobe Campaign Standard 内で[!UICONTROL オーディエンス]モジュールをから直接アクセスできます。 |
...
| Adobe Analytics | ビデオ - [Adobe AIおよびAdobe Analytics – 拡張バージョン &#x200B;](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/intro-to-analytics/what-can-aa-do-for-me/adobe-sensei-and-adobe-analytics.html) | Adobe [!DNL AI,] を活用した Adobe Analytics の主な機能（[!UICONTROL 異常値検出]、[!UICONTROL 貢献度分析]、[!UICONTROL インテリジェントアラート]、[!UICONTROL クラスタリング]、[!UICONTROL Segment IQ] [!UICONTROL および傾向モデル]）について視聴します。 |
