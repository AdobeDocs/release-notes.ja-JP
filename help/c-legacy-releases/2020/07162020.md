...
* **AEM 6.5.5 Forms ドキュメントの更新**
   ...
   * 以下は、6.5.5 リリースの新機能と改善点です。
      ...
      * [インタラクティブ通信をドラフトとして保存します。](https://experienceleague.adobe.com/docs/experience-manager-65/forms/interactive-communications/prepare-send-interactive-communication.html?lang=ja#save-as-draft)
      ...
      * [アクセシビリティの向上：](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=ja#accessibility-improvements)
      * [フォームデータモデルでのSOAP ベースのweb サービスのX-509証明書ベースの認証。](https://experienceleague.adobe.com/docs/experience-manager-65/forms/form-data-model/configure-data-sources.html?lang=ja#configure-soap-web-services)
      * [Oracle RAC サポート。](https://experienceleague.adobe.com/docs/experience-manager-65/release-notes/service-pack/new-features-latest-service-pack.html?lang=ja#other-improvements)
      * [トランザクションレポートへのログインエラーを改善しました。](https://experienceleague.adobe.com/docs/experience-manager-65/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=ja#view-transaction-reporting-logs)
   * 6.4.8.1 リリースの新機能と機能強化：
      * [フォームデータモデルでのSOAP ベースのweb サービスのX-509証明書ベースの認証。](https://experienceleague.adobe.com/docs/experience-manager-64/forms/form-data-model/configure-data-sources.html?lang=ja#configure-soap-web-services)
      * [トランザクションレポートへのログインエラーを改善しました。](https://experienceleague.adobe.com/docs/experience-manager-64/forms/transaction-reports/viewing-and-understanding-transaction-reports.html?lang=ja#view-transaction-reporting-logs)
...
* 新しい Gold Standard の安定したビルド。 [詳細情報](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html?lang=ja#release-19-1-4-build-9032)
