...
[詳細…](https://medium.com/adobetech/adobe-experience-cloud-cookie-updates-for-google-chrome-19ad67cf1598)
...
ジャーニーオーケストレーションは現在 GA です。 [詳細情報](https://experienceleague.adobe.com/docs/journeys/using/release-notes/release-notes.html?lang=ja)
...
| 機能 | 説明 |
| -----------| ---------- |
| Analysis Workspace - フリーフォームテーブルビルダー | Table Builder を有効にすれば、多くのディメンション、分類、指標およびセグメントをドラッグ＆ドロップして、より複雑なビジネスの質問に回答するテーブルを作成できます。 データはすぐには更新されません。 代わりに、**[!UICONTROL ビルド]**&#x200B;を選択した後に更新が行われ、構築するテーブルが決まると時間が節約されます。 さらに、この機能では次のことが可能です。<ul><li>**プレビュー**：時間をかけて実際のデータをレンダリングする前に表形式でプレビューできます。</li><li>**柔軟な行と分類の設定**：各ディメンション行に対して行と分類レベルを設定できます。 以前は、Workspace で適用されたデフォルトは、データが返されるまで変更できませんでした。</li><li>**位置で分類**：ディメンション行を、_特定の項目_&#x200B;ではなく常に&#x200B;_位置で分類_（デフォルト）するように設定できます。</li><li>**手動の静的行の並べ替え**：静的な行を手動で並べ替え、必要に応じて表示できます。 以前は、静的な行は指標の列またはアルファベット順でのみ並べ替えることができました。</li></ul>関連ドキュメントは、1 月後半にこの機能がリリースされるタイミングで公開される予定です。 |
...
| プライバシーサービス API：CCPA | カリフォルニア州消費者プライバシー法（CCPA）は、米国カリフォルニア州の居住者のプライバシー権と消費者保護を厳格化します。 この法律は2020年1月1日に施行されました。<br><br/>CCPAは、カリフォルニア在住の方に対し、個人データにアクセスして削除する権利、個人データが販売または開示されているかどうかを知る権利（および誰に対して）、個人データの販売を拒否する権利など、新しいデータプライバシー権を提供します。<br><br/>プライバシーサービスは個人データの販売のオプトアウトに対するリクエストをサポートします。<br><br/>Privacy Serviceは以前はGDPR サービスであり、以前のすべての機能を保持します。現在は、Analytics](https://experienceleague.adobe.com/docs/analytics/admin/data-governance/an-ccpa-overview.html)<br><br/>[Privacy Serviceの概要](https://experienceleague.adobe.com/docs/experience-platform/privacy/home.html?lang=ja)でCCPAをサポートするように拡張されています。<br/><br/>[CCPA |
...
| **[!UICONTROL IP ログイン制限の適用]** オプションのサポート終了 | 2019 年 10 月 31 日 | 2020年1月、IP 許可リスト（**[!UICONTROL IP ログイン制限を適用]**）機能の提供終了日が&#x200B;**[!UICONTROL 管理者/会社設定/セキュリティ]** メニューで発表されました。 |
...
| サンノゼ FTP 連携機能の終了 | 2020年7月 | ロンドンとシンガポールのお客様については、ロンドンまたはシンガポールとサンノゼのデータセンター[ftp.omniture.com](ftp://ftp.omniture.com/)との間のデータの仲介をサポートしなくなります。<br/><ul><li>ロンドンのお客様：[ftp3.omniture.com](ftp://ftp3.omniture.com/)</li><li>シンガポールのお客様：[ftp4.omniture.com](ftp://ftp4.omniture.com/)</li></ul> |
| Analytics ユーザーの `createDate` フィールドに関する変更予定 | 2019 年 8 月 31 日 | 2019年10月または11月に、Analytics ユーザーの`createDate` フィールドが米国太平洋標準時から、タイムゾーン情報を含む正しい形式の日付と時刻の値に更新されました。（AN-183468） |
...
| 機能 | 説明 |
| -----------| ---------- |
| [カリフォルニア消費者プライバシー法（CCPA）のサポートとプライバシーに関するドキュメントの見直し](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html) | 2020年1月1日に施行された[ カリフォルニア州消費者プライバシー法（CCPA） ](https://www.caprivacy.org/about)は、カリフォルニア在住の方に個人情報に関する新たな権利を提供し、カリフォルニア州で事業を行う特定の企業にデータ保護の責任を課します。<br><br> Audience Managerは、[Adobe Experience Platform Privacy Service](https://experienceleague.adobe.com/docs/experience-platform/privacy/home.html?lang=ja)などのプライバシーツールを通じて、データへのアクセス要求とデータ削除要求に対するプライバシー規制に基づく義務の遵守を支援します。<br><br> 現在の[ オプトアウト管理](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html) プロセスを更新して、宣言されたID （CRM IDなど）のオプトアウトを含めました。 宣言済み ID によるオプトアウトの場合、宣言済み ID と最後にリンクされたデバイスは、Audience Manager のデータ収集から除外されます。 オプトアウトリクエストは、この機能をサポートする[宛先パートナー](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html)にもセグメント解除リクエストを一括およびリアルタイムで送信できるようになりました。<br><br> また、前述の規制に準拠するために必要な情報を簡単に見つけられるように、[ データセキュリティ ](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-security.html)、[ データプライバシー](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html)、[ データガバナンス ](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-governance.html)のドキュメントを再設計しました。 |
...
* **AEM6.5.3.0**
AEM 6.5 サービスパック 3.0 （6.5.3.0 2019年12月12日（PT）リリース）は、2019年4月のAEM 6.5の一般提供開始以降にリリースされた主要なお客様修正を含む重要なアップデートです。
...
* **AEM6.4.7.0**
  ...
  AEM 6.4 サービスパック 7.0 （2019年12月12日にリリースされた6.4.7.0）は、2018年4月のAEM 6.4の一般提供開始以降にリリースされた主要なお客様修正を含む重要なアップデートです。
   * [リリースノート](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/sp-release-notes.html)
   * [AEM Forms CFP リリース](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=ja)

* **AEM6.3.3.7**

  AEM 6.3、サービスパック 3、累積修正パック 7 （2019年12月12日にリリースされた6.3.3.7）は、2017年4月のAEM 6.3の一般提供開始以降にリリースされた主な顧客修正を含む重要なアップデートです。
...
* **AEM デスクトップアプリ2.0.1.1**

  AEM デスクトップアプリ 2.0.1.1は、Oktaを使用したシングルサインオンのアップデートと、環境設定で一時ファイルの場所を指定する機能を提供します。 このリリースでは、Desktop App 2.x に対する AEM 6.3.x のサポートが廃止されました。
...
* **新登場：AEM as a Cloud Service**
   ...
   * [概要](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/overview/introduction.html)
...
* **自動フォーム変換サービス**
   ...
   * [概要](https://docs.adobe.com/content/help/ja-JP/experience-cloud/user-guides/home.translate.html)
   * [サービスの設定](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html)
   * [PDF formsのアダプティブフォームへの変換](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html)

### セルフサービス

* **3D アセットのプレビュー**

  AEM 6.5 は、オーサリングプロセスの一環として、3D アセットのアップロード、配信、およびインタラクティブプレビューをサポートします。 インタラクティブ 3D ビューアは、AEM のアセットの詳細ページから利用できます。 このビューアには、3D アセットをオービット、ズームおよびパンできるインタラクティブなカメラコントロールのコレクションが含まれます。
詳しくは、[3D アセットのプレビュー](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html)を参照してください。
...
管理者ユーザーがサブドメインをデリゲートし、Campaign コントロールパネルからSSL証明書を更新するための新しい機能が追加されました。
...
* サブドメインのSSL証明書の更新 – [詳細情報](https://experienceleague.adobe.com/docs/control-panel/using/subdomains-and-certificates/renewing-subdomain-certificate.html?lang=ja)
...
| Search／Campaigns、Reports | Google Adsの目立つ指標「Impr. (Abs. Top） %」および「Impr. （トップ） %」は、ショッピング製品グループを除くすべての基本レポートおよびエンティティ レベルのキャンペーン管理ビュー、Campaign Daily Impression Shareおよびキーワード Daily Impression Share レポート、およびラベルと制約ビューで使用できるようになりました。 |
