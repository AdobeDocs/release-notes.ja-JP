...
* Adobe ID を使用し、製品、地域およびイベントの環境設定に基づいてイベント通知を購読できます。 購読の環境設定を行うユーザーは、関連する製品のインシデントおよびメンテナンスイベントについてのみ、それらのイベントの発生、更新および終了時に通知を受け取ります。 はじめに [status.adobe.com/subscriptions](https://status.adobe.com/ja-jp/proactive-notifications/subscriptions/edit) をご覧ください。
...
| 機能 | 説明 |
| -----------| ---------- |
| [カリフォルニア消費者プライバシー法（CCPA）のサポートとプライバシーに関するドキュメントの見直し](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html?lang=ja) | 2020年1月1日に施行された[&#x200B; カリフォルニア州消費者プライバシー法（CCPA） &#x200B;](https://www.caprivacy.org/about)は、カリフォルニア在住の方に個人情報に関する新たな権利を提供し、カリフォルニア州で事業を行う特定の企業にデータ保護の責任を課します。<br><br> Audience Managerは、[Adobe Experience Platform Privacy Service](https://experienceleague.adobe.com/docs/experience-platform/privacy/home.html?lang=ja)などのプライバシーツールを通じて、データへのアクセス要求とデータ削除要求に対するプライバシー規制に基づく義務の遵守を支援します。<br><br> 現在の[&#x200B; オプトアウト管理](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html?lang=ja) プロセスを更新して、宣言されたID （CRM IDなど）のオプトアウトを含めました。 宣言済み ID によるオプトアウトの場合、宣言済み ID と最後にリンクされたデバイスは、Audience Manager のデータ収集から除外されます。 オプトアウトリクエストは、この機能をサポートする[宛先パートナー](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy-requests.html?lang=ja)にもセグメント解除リクエストを一括およびリアルタイムで送信できるようになりました。<br><br> また、前述の規制に準拠するために必要な情報を簡単に見つけられるように、[&#x200B; データセキュリティ &#x200B;](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-security.html?lang=ja)、[&#x200B; データプライバシー](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-privacy/data-privacy.html?lang=ja)、[&#x200B; データガバナンス &#x200B;](https://experienceleague.adobe.com/docs/audience-manager/user-guide/overview/data-governance.html?lang=ja)のドキュメントを再設計しました。 |
...
* **新登場：AEM as a Cloud Service**
   ...
   * [概要](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/overview/introduction.html?lang=ja)
...
* **自動フォーム変換サービス**
   ...
   * [PDF formsのアダプティブフォームへの変換](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=ja)
...
詳しくは、[3D アセットのプレビュー](https://experienceleague.adobe.com/docs/experience-manager-65/assets/using/previewing-3d-assets.html?lang=ja)を参照してください。
...
* [Campaign Classic 19.1.4 アップデート](https://experienceleague.adobe.com/docs/campaign-classic/using/release-notes/previous-releases/release--19-1.html?lang=ja)
