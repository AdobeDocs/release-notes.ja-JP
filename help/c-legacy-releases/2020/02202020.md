...
* **ラボ（テクノロジープレビュー）:** この新しい Analytics 機能を使用すると、実稼動環境で新機能のプロトタイプをテストし、Adobeに貴重なフィードバックを提供できます。[詳細情報…](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html?lang=ja)
