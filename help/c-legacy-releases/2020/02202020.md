...
* **ラボ（テクノロジープレビュー）:** この新しい Analytics 機能を使用すると、実稼動環境で新機能のプロトタイプをテストし、Adobeに貴重なフィードバックを提供できます。[詳細情報…](https://experienceleague.adobe.com/docs/analytics/analyze/tech-previews/overview.html)
...
* **Workspace デバッガー** がヘルプメニューに追加され、よりシームレスに有効化してWorkspace リクエストをデバッグできるようになりました。[詳細情報…](https://www.adobe.io/apis/experiencecloud/analytics/docs.html#!AdobeDocs/analytics-2.0-apis/master/reporting-tricks.md)
...
| Analytics ユーザーの `createDate` フィールドに関する変更予定 | 2019 年 8 月 31 日 | 2019 年 10 月または 11 月に、Analytics ユーザーの `createDate` フィールドが米国太平洋時間から、タイムゾーン情報を含む正しい形式の日時値に更新されました。（AN-183468） |

### [!DNL AppMeasurement] {#appm}

[AppMeasurement for JavaScript リリースノート &#x200B;](https://experienceleague.adobe.com/docs/analytics/implementation/appmeasurement-updates.html?lang=ja) を参照してください。 バージョン 2.19.0 は 2020年2月21日（PT）にリリースされました。
