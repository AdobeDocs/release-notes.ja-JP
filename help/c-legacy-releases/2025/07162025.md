...
| [!DNL Experience Cloud] | [エージェント型 AI](https://experienceleague.adobe.com/ja/docs/core-services/interface/features/agentic-ai) | 製品サポートエージェントと Data Insights Agent （エージェント型 AI）について説明します。 |
...
* [Experience Cloud アプリケーションのジェネレーティブ AI](https://experienceleague.adobe.com/ja/docs/core-services/interface/features/generative-ai)
...
| 2025年6月 | [Adobe Experience Platform にアクセスできない](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26778) | 新しい記事 | 管理者権限を持つ正しい製品プロファイルに追加されているにもかかわらず、Adobe Experience Platform で&#x200B;*このユーザーにはサンドボックスが有効になっていません。 組織の管理者に問い合わせて、1 つ以上のサンドボックスへのアクセスをリクエストしてください。* Adobe Experience Platformでは、管理者権限を持つ正しい製品プロファイルに追加された場合でも同様です。 |
...
| 2025年6月 | [AEP - クエリサービスの同時セッションの最大数が 10 に達した場合の対処方法](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26872) | 新しい記事 | 本番環境または開発環境でクエリサービスの同時セッションの最大数が 10 に達した場合の問題の解決策について説明します。 |
...
* [AppMeasurement for JavaScript リリースノート](https://github.com/adobe/appmeasurement/releases)
...
| 公開日 | 名前 | タイプ | 説明 |
| -----------| ---------- | ---------- | ---------- |
| 2025年6月 | [Data Insights Agent の概要](https://experienceleague.adobe.com/ja/docs/customer-journey-analytics-learn/tutorials/data-insights-agent/introduction-to-the-data-insights-agent) | 新しいビデオ | Customer Journey Analytics の Data Insights Agent について説明します。 この AI 駆動のソリューションは、マーケターに透明性の高いインサイトを瞬時に提供し、企業が抱えるボトルネックを解消します。 |
| 2025年6月 | [Data Insights Agent の使用](https://experienceleague.adobe.com/ja/docs/customer-journey-analytics-learn/tutorials/data-insights-agent/use-the-data-insights-agent) | 新しいビデオ | 自然言語プロンプトを使用してデータを分析し、フリーフォームテーブル、ビジュアライゼーションおよびデータ比較を生成することで、データアナリストへの依存を軽減します。 |
| 2025年6月 | [Data Insights Agent のユースケース](https://experienceleague.adobe.com/ja/docs/customer-journey-analytics-learn/tutorials/data-insights-agent/data-insights-agent-use-cases) | 新しいビデオ | 自然言語クエリ、リアルタイムビジュアライゼーション、フリーフォームテーブルを使用して、分析を効率化します。 マーケティング戦略開発、キャンペーン管理、ビジネスパフォーマンスレポート全体で効率性を高めます。 |
...
| 2025年6月 | [AEM Cloud のプレビュー表示 *機能！* サイトのホームページの代わりに &#x200B;](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26745) | 新しい記事 | Adobe Experience Manager（AEM） _公開_ または _プレビュー_ 環境に *動作* と表示される場合の問題の解決策について説明します。 サイトのホームページの代わりにメッセージを表示します。 |
...
| 2025年6月 | [Adobe Commerce クラウド版インフラストラクチャーでのバージョンの不一致の解決](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26788) | 新しい記事 | [!UICONTROL ステージング]環境の Adobe Commerce クラウド版インフラストラクチャのバージョンが本番環境よりも古い場合に、[!UICONTROL ステージング]環境から本番環境へのデプロイメントが失敗する場合の問題の解決策について説明します。 |
...
| 2025年6月 | [接触チャネルクロークにより、サイトにアクセスできない](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26856) | 新しい記事 | Adobe Commerce クラウド版インフラストラクチャーの[!UICONTROL ステージング]サイトまたは本番稼働サイトのストアフロントや管理者にアクセスできない場合の問題の解決策について説明します。 |
...
| 2025年6月 | [*「E：`routes.yaml`* の検証中にエラーが発生しました」というエラーが[!UICONTROL ステージング]環境または本番環境のデプロイ中に発生する](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26880) | 新しい記事 | プロジェクトを[!UICONTROL ステージング]環境または本番環境にデプロイしようとした際に、*「E：`routes.yaml`* の検証中にエラーが発生しました」というエラーメッセージが表示される場合の問題の解決策について説明します。 |
...
* [2025 年第 2 四半期リリースの概要](https://experienceleague.adobe.com/ja/docs/workfront/using/product-announcements/product-releases/release-25-q2/25-q2-release-overview)
