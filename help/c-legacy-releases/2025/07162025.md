...
* [Experience Cloudアプリケーションで利用できる生成AI](https://experienceleague.adobe.com/ja/docs/core-services/interface/features/generative-ai)
...
| 2025年6月 | [Adobe Experience Platform にアクセスできない](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26778) | 新しい記事 | 管理者権限を持つ正しい製品プロファイルに追加されているにもかかわらず、Adobe Experience Platform で&#x200B;*このユーザーにはサンドボックスが有効になっていません。 組織の管理者に連絡し、少なくとも1つのサンドボックスへのアクセスをリクエストしてください。* Adobe Experience Platformでは、管理者権限を持つ正しい製品プロファイルに追加されていても、 |
...
| 2025年6月 | [AEM Cloudのプレビューに&#x200B;*動作します！* サイトのホームページの代わりに](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-26745) | 新しい記事 | Adobe Experience Manager（AEM）の&#x200B;_publish_&#x200B;または&#x200B;_preview_&#x200B;環境に&#x200B;*動作する問題が表示された場合の解決策について説明します。* メッセージを配置します。 |
...
* [2025年第2四半期リリースの概要](https://experienceleague.adobe.com/ja/docs/workfront/using/product-announcements/product-releases/release-25-q2/25-q2-release-overview)
