...
[Experience League](https://experienceleague.adobe.com/ja?lang=ja#home) は、Experience Cloud とアドビのエンタープライズアプリケーションについて学ぶのに役立ちます。 最高のエクスペリエンスを得るには、ログインし、無料のリソースライブラリ全体で検索をカスタマイズします。
...
| 2025年1月 | [&#x200B; [!DNL Experience Platform Solutions] のモニタリングオプションについて](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-25523) | 新しい記事 | [!DNL Adobe Experience Platform (AEP)] 環境でシステムステータスを監視し、パフォーマンスの問題をプログラムで特定する方法について説明します。 |
...
|September 2024|[Marketo Measure Ultimate overview](https://experienceleague.adobe.com/ja/docs/marketo-measure-learn/tutorials/marketo-measure-ultimate/overview)|New video |Learn how Marketo Measure Ultimate allows B2B marketers to gather data from almost any source, including multiple sources of the same type, for thorough attribution. |
|September 2024|[API Help - How to set the Access token in a variable](https://experienceleague.adobe.com/ja/docs/marketo-learn/tutorials/integrations/api-set-access-token-variable)|New video |Learn how to set up the Postman application and leverage variables to save data into the variable for reusability purposes. You will also learn how to make your first Marketo Engage REST API call to get the access token.|
|September 2024|[Go live with Dynamic Chat in just 15 minutes](https://experienceleague.adobe.com/ja/docs/marketo-learn/tutorials/dynamic-chat/go-live-in-15-minutes)|New video |Watch a step by step guide to help you go live with your first dialogue using Dynamic Chat in just 15 minutes.| 
-->
