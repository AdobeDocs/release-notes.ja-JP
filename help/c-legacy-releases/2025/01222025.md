...
[Experience League](https://experienceleague.adobe.com/ja?lang=ja#home) は、Experience Cloud とアドビのエンタープライズアプリケーションについて学ぶのに役立ちます。 最高のエクスペリエンスを得るには、ログインし、次の無料のリソースライブラリ全体で検索をカスタマイズします。

* [製品ドキュメント](https://experienceleague.adobe.com/ja/docs)
* [ビデオプレイリスト](https://experienceleague.adobe.com/ja/playlists)
* [イベント](https://experienceleague.adobe.com/events/?lang=ja)
* [コミュニティフォーラム](https://experienceleaguecommunities.adobe.com/?profile.language=ja)
* [サポート](https://experienceleague.adobe.com/ja?support-tab=home&lang=ja#support)

**フィードバックを残す：** **_このコンテンツは役に立ちましたか？_** 各記事または動画の下部にポップアップ表示されます。 フィードバックがキュレートされ、コンテンツ作成者に配信されます。
...
### Experience League に対するアップデート（2025年2月）
...
| 2024年12月 | [&#x200B; [!DNL Adobe Experience Platform] の本番環境以外での計算済み属性へのアクセス](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-25432) | 新しい記事 | [!DNL Adobe Experience Platform (AEP)] の本番環境以外で計算済み属性にアクセスできないことに関連する問題を解決する方法について説明します。 |
...
* [現在の [!DNL Experience Manager] as a Cloud Service リリースノート](https://experienceleague.adobe.com/ja/docs/experience-manager-cloud-service/content/release-notes/release-notes/release-notes-current)
...
| 2024年12月 | [「*[!DNL Oops. Something went wrong. Check your [!DNL URI] and try again]*」](https://experienceleague.adobe.com/ja/docs/experience-cloud-kcs/kbarticles/ka-25415) | 新しい記事 | 本番環境で [!DNL Adobe Campaign Standard] への [!DNL API] 呼び出しを行う際に `Oops. Something went wrong. Check your URI and try again` というエラーが発生した場合の問題を解決する方法について説明します。 |
...
|Published|Name|Type|Description |
| -----------| ---------- | ---------- | ---------- |
|October 2024|[Configure business rules - Frequency capping](https://experienceleague.adobe.com/ja/docs/journey-optimizer-learn/tutorials/configuration/business-rules/configure-frequency-capping-rules)|Video |Learn how to configure frequency capping rules.| 
-->
...
詳しくは、Adobe [!DNL Journey Optimizer B2b Edition] のリリースノートと新しいドキュメントを参照してください。
