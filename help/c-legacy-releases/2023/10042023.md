...
| 2023年9月 | [登録トークンが_nms :appSubscriptionRcp_テーブル &#x200B;](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-22844.html?lang=ja)に保存されていません | 新しい記事 | 登録トークンが `nms:appSubscriptionRcp` テーブルに保存されない場合の解決策について説明します。 |
