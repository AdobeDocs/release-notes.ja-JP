...
| 機能 | 説明 |
| ------- | ----------- |
| [!UICONTROL キャンペーン] | （[!DNL Microsoft Advertising] オーディエンスキャンペーン、オープンベータ版機能、3月18日（PT）リリース）オーディエンスキャンペーンで拡張 CPC（eCPC）入札戦略を使用できるようになりました。 入札は子広告グループの設定内で設定できます。<br><br>eCPC を使用したオーディエンスキャンペーンは、最適化のためにポートフォリオに含めることができます。 |
