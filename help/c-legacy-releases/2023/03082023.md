...
| 2023年2月 | [RTCDP ライセンスに付属している環境（開発、ステージング、本番）の数はいくつですか？](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21590.html?lang=ja) | 新しい記事 | RTCDP ライセンスに付属している環境とサンドボックスの数の詳細を説明します。 |
...
| -----------| ---------- | ---------- | ---------- | ------|
| 2023年3月 | [高速開発環境](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/developing/rde/overview.html?lang=ja) | ビデオ | 高速開発環境（RDE）、その設定方法と使用方法および RDE を使用した開発ライフサイクルについて説明します。 | AEM CS |
...
| 2023年2月 | [ビルドステップでパイプラインのデプロイメントが失敗する](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-21419.html?lang=ja) | 新しい記事 | `ui.frontend` コードのエラーによりビルドステップでパイプライン実行が失敗する問題の解決策について説明します。 |
...
**Note:** Translation on Experience League for all [[!DNL Workfront]](https://experienceleague.adobe.com/docs/workfront.html?lang=ja) tutorials and product documentation is coming soon!

|Published|Name|Type|Description |
| -----------| ---------- | ---------- | ---------- |
|February 2023|[Take charge of an existing Adobe Workfront instance](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/administration-and-setup/system-perfomance-and-maintenance/take-charge-of-an-existing-workfront-instance.html?lang=ja)|Video |Learn the key phases to evaluate, understand, and optimize your instance of [!DNL Workfront] as a new system or group administrator.|
|February 2023|[Customize project headers with layout templates](https://experienceleague.adobe.com/docs/workfront-learn/tutorials-workfront/administration-and-setup/layout-templates/customize-project-headers-with-layout-templates.html?lang=ja)|Video |Learn how to add and remove fields from project headers through layout templates.|
...
| 機能 | 説明 |
| ------- | ----------- |
| [!UICONTROL キャンペーン] | （[!DNL Microsoft Advertising] オーディエンスキャンペーン、オープンベータ版機能、3月18日（PT）リリース）オーディエンスキャンペーンで拡張 CPC（eCPC）入札戦略を使用できるようになりました。 入札は、子の広告グループ設定内で設定できます。<br><br>eCPC を使用したオーディエンスキャンペーンは、最適化のためにポートフォリオに含めることができます。 |
| [!UICONTROL キャンペーン]、[!UICONTROL ポートフォリオ] | （[!DNL Google Ads] アカウント、オープンベータ版機能）[!DNL Google Ads] のパフォーマンス最大化キャンペーンで最適化のサポートが利用できるようになり、ハイブリッドポートフォリオに追加できるようになりました。 入札戦略のターゲットキャンペーンの予算は、キャンペーンレベルで設定します。 |
| [!UICONTROL キャンペーン]、[!UICONTROL レポート] | （[!DNL Google Ads] および [!DNL Microsoft Advertising] アカウント、3月18日（PT）リリース）次の新しい知名度の指標が、キャンペーン管理のビューとレポートで利用できます。<ul><li><p>[!UICONTROL コンテンツ IS]：ディスプレイ／オーディエンスネットワークの広告で獲得したインプレッション数を、ディスプレイ広告の推定インプレッション数で割った値です。</p><p>これと他の「[!UICONTROL コンテンツ]*」指標は、コンテンツ広告に関連するエンティティのすべてのキャンペーン管理ビューと、関連する基本レポート（[!UICONTROL 検索エンジン]、[!UICONTROL 検索エンジンアカウント]、[!UICONTROL キャンペーン]、[!UICONTROL 広告グループ]、[!UICONTROL ポートフォリオ]）で利用できます。</p></li><li><p>[!UICONTROL 失われたコンテンツ IS（予算）]：1 日または 1 か月の予算が低すぎたので、ディスプレイ／オーディエンスネットワークの広告で獲得できなかった推定インプレッション数の割合です。<p></li><li><p>[!UICONTROL 失われたコンテンツ IS（ランク）]：広告ランクが低いので、ディスプレイ／オーディエンスネットワークの広告で獲得できなかった推定インプレッション数の割合です。</p></li><li><p>[!UICONTROL 完全一致の検索 IS]：キーワードと完全に一致する検索に対して獲得したインプレッション数を、獲得資格のある完全一致の推定インプレッション数で割った値です。</p><p>この指標は、検索広告に関連するエンティティのすべてのキャンペーン管理ビューと、関連する基本レポート（[!UICONTROL 検索エンジン]、[!UICONTROL 検索エンジンアカウント]、[!UICONTROL キャンペーン]、[!UICONTROL 広告グループ]、[!UICONTROL キーワード]、[!UICONTROL 製品グループ]、[!UICONTROL ポートフォリオ]）で利用できます。 また、[!UICONTROL 制約]、[!UICONTROL ラベル分類]、[!UICONTROL ラベル値]の各レポートでも利用できます。</p></li></ul> |
