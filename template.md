...
[!UICONTROL Platform] コアサービス、製品管理、セキュリティ速報など、Experience Cloudインターフェイスのリリースノートです。
...
### [!DNL Media Analytics] iOSおよびAndroid用SDK（以前のVHL SDK） {#aa-va}
